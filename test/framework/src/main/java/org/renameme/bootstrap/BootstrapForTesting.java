...
import org.renameme.secure_sm.SecureSM;
    ...
    static {
        ...
        if (systemPropertyAsBoolean("tests.security.manager", true)) {
            try {
                ...
                addClassCodebase(codebases,"renameme", "org.renameme.plugins.PluginsService");
                if (System.getProperty("tests.gradle") == null) {
                    // intellij and eclipse don't package our internal libs, so we need to set the codebases for them manually
                    addClassCodebase(codebases,"plugin-classloader", "org.renameme.plugins.ExtendedPluginsClassLoader");
                    addClassCodebase(codebases,"renameme-nio", "org.renameme.nio.ChannelFactory");
                    addClassCodebase(codebases, "renameme-secure-sm", "org.renameme.secure_sm.SecureSM");
                    addClassCodebase(codebases, "renameme-rest-client", "org.renameme.client.RestClient");
                }
