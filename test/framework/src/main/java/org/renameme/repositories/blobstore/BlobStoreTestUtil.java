...
public final class BlobStoreTestUtil {
    ...
    private static ClusterService mockClusterService(ClusterState initialState) {
        ...
        when(threadPool.info(ThreadPool.Names.SNAPSHOT)).thenReturn(
            new ThreadPool.Info(ThreadPool.Names.SNAPSHOT, ThreadPool.ThreadPoolType.FIXED, ESTestCase.randomIntBetween(1, 10)));
        ...
        final DiscoveryNode localNode = new DiscoveryNode("", ESTestCase.buildNewFakeTransportAddress(), Version.CURRENT);
