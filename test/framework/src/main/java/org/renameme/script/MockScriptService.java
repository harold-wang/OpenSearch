    ...
    public static <T> MockScriptService singleContext(ScriptContext<T> context, Function<String, T> compile,
        ...
        ScriptEngine engine = new ScriptEngine() {
            ...
            public Set<ScriptContext<?>> getSupportedContexts() {
                return org.renameme.common.collect.Set.of(context);
            }
        };
        return new MockScriptService(Settings.EMPTY, org.renameme.common.collect.Map.of("lang", engine),
            org.renameme.common.collect.Map.of(context.name, context)) {
            @Override
