...
package org.renameme.test.client;
 ...
 * for testing.
 *
 * See also {@link NoOpNodeClient} if you need to mock a {@link org.renameme.client.node.NodeClient}.
 */
public class NoOpClient extends AbstractClient {
    ...
    public void close() {
        try {
            ...
            throw new RenamemeException(e.getMessage(), e);
        }
    }
}
