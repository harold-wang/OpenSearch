...
import org.renameme.common.xcontent.XContentParserUtils;
...
import org.renameme.search.aggregations.InternalAggregation.ReduceContext;
...
import org.renameme.search.aggregations.ParsedAggregation;
...
import org.renameme.search.aggregations.pipeline.PipelineAggregator.PipelineTree;
...
import org.renameme.test.hamcrest.RenamemeAssertions;
...
import static org.renameme.common.xcontent.XContentHelper.toXContent;
import static org.renameme.search.aggregations.InternalMultiBucketAggregation.countInnerBucket;
...
public abstract class InternalAggregationTestCase<T extends InternalAggregation> extends AbstractNamedWriteableTestCase<T> {
    ...
    protected <P extends ParsedAggregation> P parseAndAssert(final InternalAggregation aggregation,
        ...
        try (XContentParser parser = createParser(xContentType.xContent(), mutated)) {
            ...
            RenamemeAssertions.assertToXContentEquivalent(originalBytes, parsedBytes, xContentType);
