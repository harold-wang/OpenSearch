...
package org.renameme.test.store;
...
public class MockFSDirectoryFactory implements IndexStorePlugin.DirectoryFactory {
    ...
    private Directory wrap(Directory dir, Random random, Settings indexSettings, ShardId shardId) {
        ...
        final RenamemeMockDirectoryWrapper w = new RenamemeMockDirectoryWrapper(random, dir, crashIndex);
    ...
    public static final class RenamemeMockDirectoryWrapper extends MockDirectoryWrapper {

        private final boolean crash;

        public RenamemeMockDirectoryWrapper(Random random, Directory delegate, boolean crash) {
