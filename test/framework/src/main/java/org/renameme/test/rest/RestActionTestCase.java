...
import org.renameme.tasks.TaskListener;
...
public abstract class RestActionTestCase extends ESTestCase {
    ...
    /**
     * A mocked {@link org.renameme.client.node.NodeClient} which can be easily reconfigured to verify arbitrary verification
