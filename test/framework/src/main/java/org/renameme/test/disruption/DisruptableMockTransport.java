 ...
 * under the License.
 */
package org.renameme.test.disruption;
...
import org.renameme.transport.RequestHandlerRegistry;
...
import static org.renameme.test.ESTestCase.copyWriteable;
...
public abstract class DisruptableMockTransport extends MockTransport {
    ...
    protected void onConnectedDuringSend(long requestId, String action, TransportRequest request,
        ...
        try {
            copiedRequest = ESTestCase.copyWriteable(request, writeableRegistry(), requestHandler::newRequest);
        } catch (IOException e) {
