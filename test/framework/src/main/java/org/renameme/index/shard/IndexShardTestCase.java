...
import org.renameme.index.shard.*;
import org.renameme.cluster.routing.ShardRoutingHelper;
import org.renameme.cluster.routing.TestShardRouting;
...
import org.renameme.indices.recovery.RecoveryResponse;
import org.renameme.indices.recovery.RecoverySettings;
import org.renameme.indices.recovery.RecoverySourceHandler;
import org.renameme.indices.recovery.RecoveryState;
import org.renameme.indices.recovery.RecoveryTarget;
import org.renameme.indices.recovery.StartRecoveryRequest;
...
public abstract class IndexShardTestCase extends ESTestCase {
    ...
    protected void promoteReplica(IndexShard replica, Set<String> inSyncIds, IndexShardRoutingTable routingTable) throws IOException {
        ...
        final ShardRouting routingEntry = TestShardRouting.newShardRouting(
