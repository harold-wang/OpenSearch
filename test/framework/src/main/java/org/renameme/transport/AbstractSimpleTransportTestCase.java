...
import org.renameme.common.network.CloseableChannel;
...
public abstract class AbstractSimpleTransportTestCase extends ESTestCase {
        ...
        final TransportRequestHandler<TransportRequest.Empty> requestHandler = (request, channel, task) -> {
            try {
                if (randomBoolean()) {
                    ...
                    channel.sendResponse(new RenamemeException("simulated"));
                }
            } catch (IOException e) {
                logger.error("Unexpected failure", e);
                fail(e.getMessage());
    ...
    @TestLogging(
        value = "org.renameme.transport.TransportService.tracer:trace",
    ...
    public void testTracerLog() throws Exception {
        ...
        try {
            appender.start();
            Loggers.addAppender(LogManager.getLogger("org.renameme.transport.TransportService.tracer"), appender);
            ...
            final MockLogAppender.LoggingExpectation requestSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent request", "org.renameme.transport.TransportService.tracer", Level.TRACE, requestSent);
            ...
            final MockLogAppender.LoggingExpectation requestReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received request", "org.renameme.transport.TransportService.tracer", Level.TRACE, requestReceived);
            final String responseSent = ".*\\[internal:test].*sent response.*";
            final MockLogAppender.LoggingExpectation responseSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent response", "org.renameme.transport.TransportService.tracer", Level.TRACE, responseSent);
            ...
            final MockLogAppender.LoggingExpectation responseReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received response", "org.renameme.transport.TransportService.tracer", Level.TRACE, responseReceived);
            ...
            final MockLogAppender.LoggingExpectation errorResponseSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent error response", "org.renameme.transport.TransportService.tracer", Level.TRACE, errorResponseSent);
            ...
            final MockLogAppender.LoggingExpectation errorResponseReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received error response", "org.renameme.transport.TransportService.tracer", Level.TRACE, errorResponseReceived);
            ...
            final MockLogAppender.LoggingExpectation notSeenSentExpectation =
                new MockLogAppender.UnseenEventExpectation(
                    "not seen request sent", "org.renameme.transport.TransportService.tracer", Level.TRACE, notSeenSent);
            ...
            final MockLogAppender.LoggingExpectation notSeenReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "not seen request received", "org.renameme.transport.TransportService.tracer", Level.TRACE, notSeenReceived);
            ...
            Loggers.removeAppender(LogManager.getLogger("org.renameme.transport.TransportService.tracer"), appender);
            appender.stop();
        }
    }
