...
package org.renameme.snapshots.mockstore;
...
import org.renameme.common.blobstore.support.FilterBlobContainer;
...
public class MockRepository extends FsRepository {
    ...
    public static class Plugin extends org.renameme.plugins.Plugin implements RepositoryPlugin {
        ...
        private class MockBlobContainer extends FilterBlobContainer {
            ...
            private int hashCode(String path) {
                try {
                    ...
                    throw new RenamemeException("cannot calculate hashcode", ex);
                }
            }
