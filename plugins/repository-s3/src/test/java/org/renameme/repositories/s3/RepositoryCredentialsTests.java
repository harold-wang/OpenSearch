...
import static org.renameme.repositories.s3.S3ClientSettings.ACCESS_KEY_SETTING;
import static org.renameme.repositories.s3.S3ClientSettings.SECRET_KEY_SETTING;
...
public class RepositoryCredentialsTests extends ESSingleNodeTestCase {
    ...
    public void testRepositoryCredentialsOverrideSecureCredentials() {
        ...
        assertWarnings(
            "[secret_key] setting was deprecated in Renameme and will be removed in a future release!"
                + " See the breaking changes documentation for the next major version.",
            "Using s3 access/secret key from repository settings. Instead store these in named clients and"
                + " the renameme keystore for secure settings.",
            "[access_key] setting was deprecated in Renameme and will be removed in a future release!"
                + " See the breaking changes documentation for the next major version.");
    }
