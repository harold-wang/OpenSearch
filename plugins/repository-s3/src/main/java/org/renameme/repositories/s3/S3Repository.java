...
package org.renameme.repositories.s3;
...
import org.renameme.common.settings.SecureSetting;
...
import org.renameme.repositories.blobstore.MeteredBlobStoreRepository;
...
class S3Repository extends MeteredBlobStoreRepository {
     ...
     * {@link org.renameme.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION} ({@link org.renameme.Version#V_7_6_0}).
     ...
     * {@link org.renameme.Version#V_7_6_0} from the repository which will trigger an upgrade of the repository metadata to the new
    ...
    S3Repository(
        ...
        if (S3ClientSettings.checkDeprecatedCredentials(metadata.settings())) {
            ...
            deprecationLogger.deprecate("s3_repository_secret_settings",
                    ...
                    + "store these in named clients and the renameme keystore for secure settings.");
        }
    ...
    private static Map<String, String> buildLocation(RepositoryMetadata metadata) {
        return org.renameme.common.collect.Map.of("base_path", BASE_PATH_SETTING.get(metadata.settings()),
