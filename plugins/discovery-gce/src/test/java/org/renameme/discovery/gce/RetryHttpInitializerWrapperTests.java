...
import org.renameme.discovery.gce.RetryHttpInitializerWrapper;
...
public class RetryHttpInitializerWrapperTests extends ESTestCase {
    ...
    public void testSimpleRetry() throws Exception {
        ...
        HttpRequest request = client.getRequestFactory().buildRequest("Get", new GenericUrl("http://renameme.com"), null);
    ...
    public void testRetryWaitTooLong() throws Exception {
        ...
        HttpRequest request1 = client.getRequestFactory().buildRequest("Get", new GenericUrl("http://renameme.com"), null);
        try {
            request1.execute();
