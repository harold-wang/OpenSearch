...
package org.renameme.cloud.azure.classic.management;
...
public class AzureComputeServiceImpl extends AbstractLifecycleComponent
    ...
    public AzureComputeServiceImpl(Settings settings) {
        ...
        try {
            ...
            throw new RenamemeException("Unable to configure Azure compute service", e);
        }
    }
    ...
    @Override
    protected void doStart() throws RenamemeException {
    }

    @Override
    protected void doStop() throws RenamemeException {
    }

    @Override
    protected void doClose() throws RenamemeException {
        if (client != null) {
            try {
                client.close();
            } catch (IOException e) {
