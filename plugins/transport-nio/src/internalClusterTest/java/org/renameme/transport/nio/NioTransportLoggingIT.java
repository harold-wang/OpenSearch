...
import org.renameme.NioIntegTestCase;
...
public class NioTransportLoggingIT extends NioIntegTestCase {
    ...
    @TestLogging(value = "org.renameme.transport.TransportLogger:trace", reason = "to ensure we log network events on TRACE level")
