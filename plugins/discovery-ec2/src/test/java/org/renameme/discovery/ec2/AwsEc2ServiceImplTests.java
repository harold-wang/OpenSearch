...
import org.renameme.discovery.ec2.AwsEc2ServiceImpl;
import org.renameme.discovery.ec2.Ec2ClientSettings;
...
public class AwsEc2ServiceImplTests extends ESTestCase {
    ...
    public void testAWSCredentialsWithRenamemeAwsSettings() {
    ...
    public void testAWSSessionCredentialsWithRenamemeAwsSettings() {
        final MockSecureSettings secureSettings = new MockSecureSettings();
        secureSettings.setString("discovery.ec2.access_key", "aws_key");
        secureSettings.setString("discovery.ec2.secret_key", "aws_secret");
