...
import org.renameme.test.ESIntegTestCase.ThirdParty;
        ...
        try {
            if (Strings.hasText(System.getProperty("tests.config"))) {
                ...
                throw new IllegalStateException(
                        "to run integration tests, you need to set -Dtests.thirdparty=true and -Dtests.config=/path/to/renameme.yml");
            }
