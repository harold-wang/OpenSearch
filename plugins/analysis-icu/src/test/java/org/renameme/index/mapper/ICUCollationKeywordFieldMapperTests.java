...
import org.renameme.index.mapper.FieldMapperTestCase2;
...
public class ICUCollationKeywordFieldMapperTests extends FieldMapperTestCase2<ICUCollationKeywordFieldMapper.Builder> {
    ...
    protected Set<String> unsupportedProperties() {
        return org.renameme.common.collect.Set.of("analyzer", "similarity");
    }
    ...
    public void testUpdateIgnoreAbove() throws IOException {
        ...
        ParsedDocument doc = mapperService.documentMapper().parse(source(b -> b.field("field", "renameme")));
        IndexableField[] fields = doc.rootDoc().getFields("field");
        assertEquals(0, fields.length);
    }
