...
import static org.renameme.repositories.azure.AzureStorageService.MAX_CHUNK_SIZE;
import static org.renameme.repositories.azure.AzureStorageService.MIN_CHUNK_SIZE;
 ...
 * <dl>
 * <dt>{@code container}</dt><dd>Azure container name. Defaults to renameme-snapshots</dd>
...
public class AzureRepository extends MeteredBlobStoreRepository {
    ...
    public static final class Repository {
        ...
        public static final Setting<String> CONTAINER_SETTING =
            new Setting<>("container", "renameme-snapshots", Function.identity(), Property.NodeScope);
    ...
    private static Map<String, String> buildLocation(RepositoryMetadata metadata) {
        return org.renameme.common.collect.Map.of("base_path", Repository.BASE_PATH_SETTING.get(metadata.settings()),
