...
import static org.renameme.common.settings.Setting.Property;
import static org.renameme.common.settings.Setting.boolSetting;
import static org.renameme.common.settings.Setting.byteSizeSetting;
...
class GoogleCloudStorageRepository extends MeteredBlobStoreRepository {
    ...
    private static Map<String, String> buildLocation(RepositoryMetadata metadata) {
        return org.renameme.common.collect.Map.of("base_path", BASE_PATH.get(metadata.settings()),
