...
package org.renameme.index.mapper.annotatedtext;
...
import org.renameme.index.mapper.TextParams;
import org.renameme.index.mapper.TextSearchInfo;
import org.renameme.index.similarity.SimilarityProvider;
        ...
        public static AnnotatedText parse (String textPlusMarkup) {
            ...
            while(m.find()){
                ...
                for (String pair : pairs) {
                    ...
                    try {
                        if (kv.length == 2) {
                            throw new RenamemeParseException("key=value pairs are not supported in annotations");
                        }
                        if (kv.length == 1) {
                        ...
                        throw new RenamemeParseException("Unsupported encoding parsing annotated text", e);
                    }
                }
            }
