...
import org.renameme.index.mapper.annotatedtext.AnnotatedTextFieldMapper.AnnotatedHighlighterAnalyzer;
import org.renameme.index.mapper.annotatedtext.AnnotatedTextFieldMapper.AnnotatedText;
import org.renameme.search.fetch.FetchSubPhase.HitContext;
import org.renameme.search.fetch.subphase.highlight.SearchHighlightContext.Field;
...
public class AnnotatedTextHighlighter extends UnifiedHighlighter {
    ...
    @Override
    protected PassageFormatter getPassageFormatter(HitContext hitContext, Field field, Encoder encoder) {
