 ...
 * under the License.
 */
package org.renameme.gradle.testfixtures;
...
import org.renameme.gradle.precommit.TestingConventionsTasks;
...
public class TestFixturesPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("org.renameme.gradle.test.RestIntegTestTask"));
        maybeSkipTasks(tasks, dockerSupport, TestingConventionsTasks.class);
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("org.renameme.gradle.test.AntFixture"));
