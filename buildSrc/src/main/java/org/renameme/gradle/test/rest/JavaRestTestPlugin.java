...
package org.renameme.gradle.test.rest;

import org.renameme.gradle.RenamemeJavaPlugin;
import org.renameme.gradle.test.RestIntegTestTask;
...
import static org.renameme.gradle.test.rest.RestTestUtil.createTestCluster;
import static org.renameme.gradle.test.rest.RestTestUtil.registerTask;
import static org.renameme.gradle.test.rest.RestTestUtil.setupDependencies;
...
public class JavaRestTestPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        project.getPluginManager().apply(RenamemeJavaPlugin.class);
