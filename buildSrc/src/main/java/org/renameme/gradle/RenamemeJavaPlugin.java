...
import org.renameme.gradle.precommit.PrecommitTaskPlugin;
...
import static org.renameme.gradle.util.Util.toStringable;

/**
 * A wrapper around Gradle's Java plugin that applies our common configuration.
 */
public class RenamemeJavaPlugin implements Plugin<Project> {
    @Override
        ...
        Consumer<String> disableTransitiveDeps = configName -> {
            ...
            config.getDependencies().all(dep -> {
                if (dep instanceof ModuleDependency
                    ...
                    && dep.getGroup().startsWith("org.renameme") == false) {
