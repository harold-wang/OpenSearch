...
/**
 * Accessor for shared dependency versions used by renameme, namely the renameme and lucene versions.
 */
public class VersionProperties {

    public static String getRenameme() {
        return renameme;
    }

    public static Version getRenamemeVersion() {
        return Version.fromString(renameme);
    }
    ...
    private static final String renameme;
    ...
    static {
        ...
        renameme = props.getProperty("renameme");
    ...
    public static boolean isRenamemeSnapshot() {
        return renameme.endsWith("-SNAPSHOT");
    }
}
