...
public class ReaperService {
    ...
    private static final String REAPER_CLASS = "org/renameme/gradle/reaper/Reaper.class";
    ...
    private Path locateReaperJar() {
        if (isInternal) {
            // when running inside the Renameme build just pull find the jar in the runtime classpath
