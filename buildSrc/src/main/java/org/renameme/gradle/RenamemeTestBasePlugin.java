...
import static org.renameme.gradle.util.FileUtils.mkdirs;
import static org.renameme.gradle.util.GradleUtils.maybeConfigure;

/**
 * Applies commonly used settings to all Test tasks in the project
 */
public class RenamemeTestBasePlugin implements Plugin<Project> {
