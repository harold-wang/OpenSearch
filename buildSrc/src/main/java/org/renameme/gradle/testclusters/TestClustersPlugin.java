...
import org.renameme.gradle.ReaperPlugin;
...
import static org.renameme.gradle.util.GradleUtils.noop;
...
public class TestClustersPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        NamedDomainObjectContainer<RenamemeCluster> container = createTestClustersContainerExtension(project, reaper, bwcJdk);
    ...
    private NamedDomainObjectContainer<RenamemeCluster> createTestClustersContainerExtension(
        Project project,
        ReaperService reaper,
        Jdk bwcJdk
    ) {
        // Create an extensions that allows describing clusters
        NamedDomainObjectContainer<RenamemeCluster> container = project.container(
            RenamemeCluster.class,
            name -> new RenamemeCluster(
                name,
                project,
                reaper,
    ...
    private void createListClustersTask(Project project, NamedDomainObjectContainer<RenamemeCluster> container) {
