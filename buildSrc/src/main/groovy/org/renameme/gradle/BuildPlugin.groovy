...
import org.renameme.gradle.test.ErrorReportingTestListener
import org.renameme.gradle.testclusters.RenamemeCluster
import org.renameme.gradle.testclusters.TestClustersPlugin
import org.renameme.gradle.testclusters.TestDistribution
...
/**
 * Encapsulates build configuration for renameme projects.
 */
@CompileStatic
class BuildPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (project.pluginManager.hasPlugin('renameme.standalone-rest-test')) {
            throw new InvalidUserDataException('renameme.standalone-test, '
                    + 'renameme.standalone-rest-test, and renameme.build '
                    + 'are mutually exclusive')
        }
        project.pluginManager.apply('renameme.java')
        configureLicenseAndNotice(project)
        project.pluginManager.apply('renameme.publish')
