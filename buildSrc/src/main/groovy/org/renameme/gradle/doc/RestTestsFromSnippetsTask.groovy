...
import org.renameme.gradle.doc.SnippetsTask.Snippet
...
class RestTestsFromSnippetsTask extends SnippetsTask {
    ...
    static isConsoleCandidate(Snippet snippet) {
         ...
         * not communicating with Renameme, like the examples in the ec2
    ...
    private class TestBuilder {
        ...
        private void test(Snippet test) {
            ...
            if (test.continued) {
                ...
                /* The Renameme test runner doesn't support quite a few
