 ...
 * under the License.
 */
package org.renameme.gradle.doc
...
class DocsTestPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        project.pluginManager.apply('renameme.testclusters')
        project.pluginManager.apply('renameme.standalone-rest-test')
        project.pluginManager.apply('renameme.rest-test')
        ...
        Map<String, String> commonDefaultSubstitutions = [
            ...
            '\\{version\\}': Version.fromString(VersionProperties.renameme).toString(),
            '\\{version_qualified\\}': VersionProperties.renameme,
