 ...
 * under the License.
 */
package org.renameme.gradle.plugin

import com.github.jengelman.gradle.plugins.shadow.ShadowPlugin
import org.renameme.gradle.BuildPlugin
import org.renameme.gradle.NoticeTask
import org.renameme.gradle.Version
import org.renameme.gradle.VersionProperties
import org.renameme.gradle.dependencies.CompileOnlyResolvePlugin
import org.renameme.gradle.info.BuildParams
import org.renameme.gradle.test.RestTestBasePlugin
import org.renameme.gradle.testclusters.RunTask
...
/**
 * Encapsulates build configuration for an Renameme plugin.
 */
    ...
    void apply(Project project) {
        ...
        project.afterEvaluate {
            ...
            Map<String, String> properties = [
                    ...
                    'renamemeVersion': Version.fromString(VersionProperties.renameme).toString(),
        ...
        project.tasks.named('testingConventions').configure {
            ...
            naming {
                ...
                IT {
                    baseClass 'org.renameme.test.ESIntegTestCase'
                    baseClass 'org.renameme.test.rest.ESRestTestCase'
                    baseClass 'org.renameme.test.ESSingleNodeTestCase'
                }
            }
        }
    ...
    private void configurePublishing(Project project, PluginPropertiesExtension extension) {
        ...
        if (extension.hasClientJar) {
            ...
            project.tasks.withType(GenerateMavenPom.class).configureEach { GenerateMavenPom generatePOMTask ->
                generatePOMTask.destination = "${project.buildDir}/distributions/${project.archivesBaseName}-client-${project.versions.renameme}.pom"
            }
        } else {
    ...
    private static void configureDependencies(Project project) {
        project.dependencies {
            if (BuildParams.internal) {
                ...
                compileOnly "org.renameme:renameme:${project.versions.renameme}"
                testImplementation "org.renameme.test:framework:${project.versions.renameme}"
            }
            // we "upgrade" these optional deps to provided for plugins, since they will run
            // with a full renameme server that includes optional deps
