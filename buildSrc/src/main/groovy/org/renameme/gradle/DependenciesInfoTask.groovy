...
import org.renameme.gradle.precommit.DependencyLicensesTask
import org.renameme.gradle.precommit.LicenseAnalyzer
...
class DependenciesInfoTask extends ConventionTask {
     ...
     *          URL is the Github URL to the LICENSE file in renameme repository.</li>
     * </ul>
     *
