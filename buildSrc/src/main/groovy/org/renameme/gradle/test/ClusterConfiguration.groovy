...
/** Configuration for an renameme cluster, used for integration tests. */
class ClusterConfiguration {
    ...
    void extraConfigFile(String path, Object sourceFile) {
        if (path == 'renameme.yml') {
            throw new GradleException('Overwriting renameme.yml is not allowed, add additional settings using cluster { setting "foo", "bar" }')
        }
