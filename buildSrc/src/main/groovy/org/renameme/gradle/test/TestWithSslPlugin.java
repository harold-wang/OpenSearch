...
import org.renameme.gradle.precommit.ForbiddenPatternsTask;
import org.renameme.gradle.testclusters.RenamemeCluster;
import org.renameme.gradle.testclusters.TestClustersAware;
...
public class TestWithSslPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        TaskProvider<ExportRenamemeBuildResourcesTask> exportKeyStore = project.getTasks()
            .register("copyTestCertificates", ExportRenamemeBuildResourcesTask.class, (t) -> {
        ...
        project.getPlugins().withType(TestClustersPlugin.class).configureEach(clustersPlugin -> {
            ...
            NamedDomainObjectContainer<RenamemeCluster> clusters = (NamedDomainObjectContainer<RenamemeCluster>) project.getExtensions()
