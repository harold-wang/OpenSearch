...
import org.renameme.gradle.fixtures.WiremockFixture
...
import static org.renameme.gradle.JdkDownloadPlugin.VENDOR_ADOPTOPENJDK
import static org.renameme.gradle.JdkDownloadPlugin.VENDOR_OPENJDK
...
class JdkDownloadPluginFuncTest extends AbstractGradleFuncTest {
    ...
    def "transforms are reused across projects"() {
        ...
        buildFile.text = """
            plugins {
             id 'renameme.jdk-download' apply false
            }
