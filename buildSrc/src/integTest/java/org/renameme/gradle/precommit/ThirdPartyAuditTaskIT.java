...
public class ThirdPartyAuditTaskIT extends GradleIntegrationTestCase {
    ...
    public void testRenamemeIgnored() {
        BuildResult result = getGradleRunner("thirdPartyAudit").withArguments(
            ":clean",
            ":empty",
            "-s",
            "-PcompileOnlyGroup=renameme.gradle:broken-log4j",
            "-PcompileOnlyVersion=0.0.1",
            "-PcompileGroup=renameme.gradle:dummy-io",
    ...
    public void testRenamemeIgnoredWithViolations() {
        BuildResult result = getGradleRunner("thirdPartyAudit").withArguments(
            ":clean",
            ":absurd",
            "-s",
