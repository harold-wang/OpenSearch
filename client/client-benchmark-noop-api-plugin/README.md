...
Build the plugin with `gradle :client:client-benchmark-noop-api-plugin:assemble` from the renameme root project directory.

### Installation Instructions

After, the binary has been built, install it with `bin/renameme-plugin install file:///full/path/to/noop-plugin.zip`.
...
* `org.renameme.plugin.noop.action.bulk.TransportNoopBulkAction`
* `org.renameme.plugin.noop.action.search.TransportNoopSearchAction`
