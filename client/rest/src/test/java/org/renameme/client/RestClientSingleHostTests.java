...
import static org.renameme.client.RestClientTestUtil.getAllErrorStatusCodes;
import static org.renameme.client.RestClientTestUtil.getHttpMethods;
import static org.renameme.client.RestClientTestUtil.getOkStatusCodes;
import static org.renameme.client.RestClientTestUtil.randomStatusCode;
...
public class RestClientSingleHostTests extends RestClientTestCase {
    ...
    /**
     * Emulates Renameme's HeaderWarningLogger.formatWarning in simple
    ...
    private static String formatWarningWithoutDate(String warningBody) {
        ...
        return "299 Renameme-1.2.2-SNAPSHOT-" + hash + " \"" + warningBody + "\"";
    }
