...
/**
 * Metadata about an {@link HttpHost} running Renameme.
 */
public class Node {
    /**
    ...
    /**
     * Version of Renameme that the node is running or {@code null}
     * if we don't know the version.
     */
    private final String version;
    /**
     * Roles that the Renameme process on the host has or {@code null}
    ...
    /**
     * Role information about an Renameme process.
     */
