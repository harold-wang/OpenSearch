...
import static org.renameme.client.ResponseException.buildMessage;
...
// if the exception is not of type RenamemeException or RuntimeException it will be wrapped in a UncategorizedExecutionException
