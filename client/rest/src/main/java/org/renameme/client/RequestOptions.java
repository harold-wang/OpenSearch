...
import org.renameme.client.HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory;
...
/**
 * The portion of an HTTP request to Renameme that can be
 * manipulated without changing Renameme's behavior.
 */
