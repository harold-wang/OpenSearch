...
package org.renameme.transport.client;
...
import org.renameme.script.mustache.MustachePlugin;
 ...
 * plugins for the client. These plugins are all the required modules for Renameme.
 *
 * @deprecated {@link TransportClient} is deprecated in favour of the High Level REST client and will
 * be removed in Renameme 8.0.
 */
