...
package org.renameme.client.documentation;
...
import org.renameme.action.admin.indices.validate.query.QueryExplanation;
...
import org.renameme.client.ESRestHighLevelClientTestCase;
import org.renameme.client.GetAliasesResponse;
import org.renameme.client.RequestOptions;
import org.renameme.client.RestHighLevelClient;
import org.renameme.client.SyncedFlushResponse;
...
import org.renameme.client.indices.DetailAnalyzeResponse;
...
import org.renameme.client.indices.PutComponentTemplateRequest;
...
import org.renameme.cluster.metadata.ComponentTemplate;
...
public class IndicesClientDocumentationIT extends ESRestHighLevelClientTestCase {
    ...
    public void testDeleteIndex() throws IOException {
...

        {
            ...
            } catch (RenamemeException exception) {
    ...
    public void testGetAlias() throws Exception {
...

        {
            ...
            RenamemeException exception = response.getException(); // <2>
    ...
    public void testDeleteAlias() throws Exception {
        ...
        }
        {
            ...
            org.renameme.client.core.AcknowledgedResponse deleteAliasResponse =
...

        {
            ...
            ActionListener<org.renameme.client.core.AcknowledgedResponse> listener =
                new ActionListener<org.renameme.client.core.AcknowledgedResponse>() {
                    @Override
                    public void onResponse(org.renameme.client.core.AcknowledgedResponse deleteAliasResponse) {
                        // <1>
                    }
