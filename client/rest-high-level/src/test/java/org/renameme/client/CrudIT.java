...
import org.renameme.action.bulk.BulkItemResponse;
import org.renameme.action.bulk.BulkProcessor;
...
public class CrudIT extends ESRestHighLevelClientTestCase {
    ...
    public void testDelete() throws IOException {
        ...
        }
        {
            ...
            assertEquals("Renameme exception [type=version_conflict_engine_exception, reason=[" + docId + "]: " +
        ...
        }
        {
            ...
            assertEquals(RestStatus.CONFLICT, exception.status());
            assertEquals("Renameme exception [type=version_conflict_engine_exception, reason=[" +
    ...
    public void testGet() throws IOException {
        {
            ...
            assertEquals("Renameme exception [type=index_not_found_exception, reason=no such index [index]]", exception.getMessage());
            assertEquals("index", exception.getMetadata("es.index").get(0));
        }
        IndexRequest index = new IndexRequest("index").id("id");
        ...
        highLevelClient().index(index, RequestOptions.DEFAULT);
        {
            ...
            RenamemeException exception = expectThrows(RenamemeException.class,
                    () -> execute(getRequest, highLevelClient()::get, highLevelClient()::getAsync));
            assertEquals(RestStatus.CONFLICT, exception.status());
            assertEquals("Renameme exception [type=version_conflict_engine_exception, " + "reason=[id]: " +
    ...
    public void testMultiGet() throws IOException {
        {
            ...
            assertEquals("Renameme exception [type=index_not_found_exception, reason=no such index [index]]",
    ...
    public void testGetSource() throws IOException {
        ...
        }
        {
            ...
            RenamemeException exception = expectThrows(RenamemeException.class,
                () -> execute(getRequest, highLevelClient()::getSource, highLevelClient()::getSourceAsync));
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertEquals("Renameme exception [type=resource_not_found_exception, " +
        ...
        }
        {
            ...
            RenamemeException exception = expectThrows(RenamemeException.class,
                () -> execute(getRequest, highLevelClient()::getSource, highLevelClient()::getSourceAsync));
            assertEquals("Renameme exception [type=action_request_validation_exception, " +
    ...
    public void testIndex() throws IOException {
        ...
        }
        {
            ...
            assertEquals("Renameme exception [type=illegal_argument_exception, " +
        ...
        }
        {
            ...
            assertEquals(RestStatus.CONFLICT, exception.status());
            assertEquals("Renameme exception [type=version_conflict_engine_exception, reason=[with_create_op_type]: " +
    ...
    public void testUpdate() throws IOException {
        {
            ...
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertEquals("Renameme exception [type=document_missing_exception, reason=[_doc][does_not_exist]: document missing]",
                    exception.getMessage());
        }
        {
            IndexRequest indexRequest = new IndexRequest("index").id( "id");
...

            {
                ...
                assertThat(exception.getMessage(), containsString("Renameme exception [type=version_conflict_engine_exception"));
            }
            {
                final UpdateRequest updateRequest = new UpdateRequest("index", "id");
