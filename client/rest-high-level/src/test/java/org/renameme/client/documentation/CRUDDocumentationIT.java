...
import org.renameme.action.bulk.BackoffPolicy;
...
import org.renameme.action.get.MultiGetItemResponse;
...
import org.renameme.client.RethrottleRequest;
...
import org.renameme.index.reindex.ScrollableHitSource;
...
public class CRUDDocumentationIT extends ESRestHighLevelClientTestCase {
    ...
    public void testIndex() throws Exception {
...

        {
            ...
            jsonMap.put("message", "trying out Renameme");
        ...
        }
        {
            ...
            builder.startObject();
            {
                ...
                builder.field("message", "trying out Renameme");
            }
            builder.endObject();
            IndexRequest indexRequest = new IndexRequest("posts")
    ...
    public void testGet() throws Exception {
        ...
        }
        {
            ...
            assertEquals(2, sourceAsMap.size());
            assertEquals("trying out Renameme", sourceAsMap.get("message"));
        ...
        }
        {
            ...
            assertEquals("trying out Renameme", message);
    ...
    public void testGetSource() throws Exception {
...

        {
            ...
            expectSource.put("message", "trying out Renameme");
        ...
        RestHighLevelClient client = highLevelClient();
        {
            ...
            IndexRequest one = new IndexRequest("posts").id("1")
                    .source(XContentType.JSON, "title",
                            "In which order are my Renameme queries executed?");
            IndexRequest two = new IndexRequest("posts").id("2")
                    .source(XContentType.JSON, "title",
                            "Current status and upcoming changes in Renameme");
            IndexRequest three = new IndexRequest("posts").id("3")
                    .source(XContentType.JSON, "title",
                            "The Future of Federated Search in Renameme");
    ...
    public void testMultiGet() throws Exception {
...

        {
            ...
            RenamemeException ee = (RenamemeException) e;    // <3>
