...
import org.renameme.action.admin.cluster.settings.ClusterGetSettingsRequest;
...
import org.renameme.client.cluster.RemoteConnectionInfo;
import org.renameme.client.cluster.RemoteInfoRequest;
import org.renameme.client.cluster.RemoteInfoResponse;
import org.renameme.client.cluster.SniffModeInfo;
import org.renameme.client.indices.ComponentTemplatesExistRequest;
import org.renameme.client.indices.DeleteComponentTemplateRequest;
import org.renameme.client.indices.GetComponentTemplatesRequest;
import org.renameme.client.indices.GetComponentTemplatesResponse;
import org.renameme.client.indices.PutComponentTemplateRequest;
import org.renameme.cluster.health.ClusterHealthStatus;
import org.renameme.cluster.health.ClusterIndexHealth;
import org.renameme.cluster.health.ClusterShardHealth;
...
public class ClusterClientIT extends ESRestHighLevelClientTestCase {
    ...
    public void testClusterUpdateSettingNonExistent() {
        ...
        RenamemeException exception = expectThrows(RenamemeException.class, () -> execute(clusterUpdateSettingsRequest,
                highLevelClient().cluster()::putSettings, highLevelClient().cluster()::putSettingsAsync));
        assertThat(exception.status(), equalTo(RestStatus.BAD_REQUEST));
        assertThat(exception.getMessage(), equalTo(
                "Renameme exception [type=illegal_argument_exception, reason=transient setting [" + setting + "], not recognized]"));
    }
