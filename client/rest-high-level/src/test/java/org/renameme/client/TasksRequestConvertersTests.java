...
public class TasksRequestConvertersTests extends ESTestCase {
    ...
    public void testCancelTasks() {
        ...
        org.renameme.client.tasks.TaskId taskId =
            new org.renameme.client.tasks.TaskId(randomAlphaOfLength(5), randomNonNegativeLong());
        org.renameme.client.tasks.TaskId parentTaskId =
            new org.renameme.client.tasks.TaskId(randomAlphaOfLength(5), randomNonNegativeLong());
