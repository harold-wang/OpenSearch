...
import org.renameme.client.AbstractRequestTestCase;
...
public class ResizeRequestTests extends AbstractRequestTestCase<ResizeRequest,
    org.renameme.action.admin.indices.shrink.ResizeRequest> {
    ...
    @Override
    protected org.renameme.action.admin.indices.shrink.ResizeRequest doParseToServerInstance(XContentParser parser)
        throws IOException {
        org.renameme.action.admin.indices.shrink.ResizeRequest req
            = new org.renameme.action.admin.indices.shrink.ResizeRequest("target", "source");
        req.fromXContent(parser);
        return req;
    }

    @Override
    protected void assertInstances(org.renameme.action.admin.indices.shrink.ResizeRequest serverInstance,
