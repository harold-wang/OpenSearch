...
public class MainResponseTests extends AbstractResponseTestCase<org.renameme.action.main.MainResponse, MainResponse> {
    @Override
    protected org.renameme.action.main.MainResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new org.renameme.action.main.MainResponse(nodeName, version, clusterName, clusterUuid , build);
    }
    ...
    @Override
    protected void assertInstances(org.renameme.action.main.MainResponse serverTestInstance, MainResponse clientInstance) {
