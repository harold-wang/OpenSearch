...
package org.renameme.client.cluster;
...
import org.renameme.transport.RemoteConnectionInfo;
...
public class RemoteInfoResponseTests extends AbstractResponseTestCase<org.renameme.action.admin.cluster.remote.RemoteInfoResponse,
        RemoteInfoResponse> {

    @Override
    protected org.renameme.action.admin.cluster.remote.RemoteInfoResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new org.renameme.action.admin.cluster.remote.RemoteInfoResponse(remoteInfos);
    }
    ...
    @Override
    protected void assertInstances(org.renameme.action.admin.cluster.remote.RemoteInfoResponse serverTestInstance,
        ...
        for (org.renameme.client.cluster.RemoteConnectionInfo clientRemoteInfo : clientInstance.getInfos()) {
