...
import static org.renameme.client.indices.GetMappingsResponse.MAPPINGS;
...
public class GetMappingsResponseTests extends ESTestCase {
    ...
    private static void toXContent(GetMappingsResponse response, XContentBuilder builder) throws IOException {
        ...
        org.renameme.action.admin.indices.mapping.get.GetMappingsResponse serverResponse =
            new org.renameme.action.admin.indices.mapping.get.GetMappingsResponse(allMappings.build());
