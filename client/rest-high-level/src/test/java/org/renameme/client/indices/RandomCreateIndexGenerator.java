...
public class RandomCreateIndexGenerator {
    ...
    public static CreateIndexRequest randomCreateIndexRequest() {
        try {
            ...
            org.renameme.action.admin.indices.create.CreateIndexRequest serverRequest =
    ...
    public static XContentBuilder randomMapping() throws IOException {
        ...
        builder.startObject();
        org.renameme.index.RandomCreateIndexGenerator.randomMappingFields(builder, true);
        builder.endObject();
        return builder;
    }
