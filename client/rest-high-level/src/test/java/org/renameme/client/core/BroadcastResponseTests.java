...
package org.renameme.client.core;
...
public class BroadcastResponseTests extends AbstractResponseTestCase<org.renameme.action.support.broadcast.BroadcastResponse,
    BroadcastResponse> {
    ...
    @Override
    protected org.renameme.action.support.broadcast.BroadcastResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new org.renameme.action.support.broadcast.BroadcastResponse(total, successful, failed, failures);
    }
    ...
    @Override
    protected void assertInstances(org.renameme.action.support.broadcast.BroadcastResponse serverTestInstance,
