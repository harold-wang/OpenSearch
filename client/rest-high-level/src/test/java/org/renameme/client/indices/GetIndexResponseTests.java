...
import org.renameme.client.GetAliasesResponseTests;
...
public class GetIndexResponseTests extends ESTestCase {
    ...
    private static void toXContent(GetIndexResponse response, XContentBuilder builder) throws IOException {
        // first we need to repackage from GetIndexResponse to org.renameme.action.admin.indices.get.GetIndexResponse
        ...
        org.renameme.action.admin.indices.get.GetIndexResponse serverResponse
            = new org.renameme.action.admin.indices.get.GetIndexResponse(
                response.getIndices(),
                allMappings.build(),
                aliases.build(),
                settings.build(),
