...
public class ResizeResponseTests extends
    AbstractResponseTestCase<org.renameme.action.admin.indices.shrink.ResizeResponse, ResizeResponse> {

    @Override
    protected org.renameme.action.admin.indices.shrink.ResizeResponse createServerTestInstance(XContentType xContentType) {
        boolean acked = randomBoolean();
        return new org.renameme.action.admin.indices.shrink.ResizeResponse(acked, acked, randomAlphaOfLength(5));
    }
    ...
    @Override
    protected void assertInstances(org.renameme.action.admin.indices.shrink.ResizeResponse serverTestInstance,
