...
import org.renameme.join.aggregations.Children;
import org.renameme.join.aggregations.ChildrenAggregationBuilder;
...
import org.renameme.search.aggregations.BucketOrder;
import org.renameme.search.aggregations.bucket.composite.CompositeAggregation;
import org.renameme.search.aggregations.bucket.composite.CompositeValuesSourceBuilder;
import org.renameme.search.aggregations.bucket.composite.TermsValuesSourceBuilder;
...
import org.renameme.search.aggregations.bucket.terms.RareTerms;
...
import org.renameme.search.aggregations.matrix.stats.MatrixStats;
import org.renameme.search.aggregations.matrix.stats.MatrixStatsAggregationBuilder;
import org.renameme.search.aggregations.metrics.WeightedAvg;
import org.renameme.search.aggregations.metrics.WeightedAvgAggregationBuilder;
import org.renameme.search.aggregations.support.MultiValuesSourceFieldConfig;
import org.renameme.search.aggregations.support.ValueType;
...
public class SearchIT extends ESRestHighLevelClientTestCase {
    ...
    public void testSearchWithRangeAgg() throws IOException {
        {
            ...
            RenamemeStatusException exception = expectThrows(RenamemeStatusException.class,
    ...
    public void testSearchScroll() throws Exception {
        ...
        try {
            ...
            RenamemeStatusException exception = expectThrows(RenamemeStatusException.class, () -> execute(scrollRequest,
                    highLevelClient()::scroll, highLevelClient()::scrollAsync));
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertThat(exception.getRootCause(), instanceOf(RenamemeException.class));
            RenamemeException rootCause = (RenamemeException) exception.getRootCause();
    ...
    public void testExplainNonExistent() throws IOException {
        {
            ...
            assertThat(exception.getDetailedMessage(),
                containsString("Renameme exception [type=index_not_found_exception, reason=no such index [non_existent_index]]"));
        }
        {
