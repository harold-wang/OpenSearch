...
import org.renameme.client.indices.RandomCreateIndexGenerator;
...
import static org.renameme.client.indices.RandomCreateIndexGenerator.randomAliases;
import static org.renameme.client.indices.RandomCreateIndexGenerator.randomMapping;
import static org.renameme.index.RandomCreateIndexGenerator.randomAlias;
import static org.renameme.index.RandomCreateIndexGenerator.randomIndexSettings;
import static org.renameme.index.alias.RandomAliasActionsGenerator.randomAliasAction;
import static org.renameme.rest.BaseRestHandler.INCLUDE_TYPE_NAME_PARAMETER;
...
public class IndicesRequestConvertersTests extends ESTestCase {
    ...
    public void testIndicesExistEmptyIndicesWithTypes() {
        LuceneTestCase.expectThrows(IllegalArgumentException.class,
                () -> IndicesRequestConverters.indicesExist(new org.renameme.action.admin.indices.get.GetIndexRequest()));
        LuceneTestCase.expectThrows(IllegalArgumentException.class, () -> IndicesRequestConverters
                .indicesExist(new org.renameme.action.admin.indices.get.GetIndexRequest().indices((String[]) null)));
    }
    ...
    public void testIndicesExistWithTypes() {
        ...
        org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest =
                new org.renameme.action.admin.indices.get.GetIndexRequest().indices(indices);
    ...
    public void testCreateIndexWithTypes() throws IOException {
        org.renameme.action.admin.indices.create.CreateIndexRequest createIndexRequest =
            org.renameme.index.RandomCreateIndexGenerator.randomCreateIndexRequest();
    ...
    public void testPutMappingWithTypes() throws IOException {
        org.renameme.action.admin.indices.mapping.put.PutMappingRequest putMappingRequest =
            new org.renameme.action.admin.indices.mapping.put.PutMappingRequest();
    ...
    public void testGetMappingWithTypes() {
        org.renameme.action.admin.indices.mapping.get.GetMappingsRequest getMappingRequest =
            new org.renameme.action.admin.indices.mapping.get.GetMappingsRequest();
    ...
    public void testGetIndexWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest =
                new org.renameme.action.admin.indices.get.GetIndexRequest().indices(indicesUnderTest);
    ...
    public void testRollover() throws IOException {
        ...
        if (ESTestCase.randomBoolean()) {
            rolloverRequest.getCreateIndexRequest().settings(
                org.renameme.index.RandomCreateIndexGenerator.randomIndexSettings());
        }
    ...
    public void testRolloverWithTypes() throws IOException {
        org.renameme.action.admin.indices.rollover.RolloverRequest rolloverRequest =
            new  org.renameme.action.admin.indices.rollover.RolloverRequest(ESTestCase.randomAlphaOfLengthBetween(3, 10),
            ESTestCase.randomBoolean() ? null : ESTestCase.randomAlphaOfLengthBetween(3, 10));
        Map<String, String> expectedParams = new HashMap<>();
        ...
        if (ESTestCase.randomBoolean()) {
            ...
            rolloverRequest.getCreateIndexRequest().mapping(type,
                org.renameme.index.RandomCreateIndexGenerator.randomMapping(type));
        }
        if (ESTestCase.randomBoolean()) {
            org.renameme.index.RandomCreateIndexGenerator.randomAliases(rolloverRequest.getCreateIndexRequest());
        }
        if (ESTestCase.randomBoolean()) {
            rolloverRequest.getCreateIndexRequest().settings(
                org.renameme.index.RandomCreateIndexGenerator.randomIndexSettings());
