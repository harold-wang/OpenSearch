...
import org.renameme.client.tasks.GetTaskRequest;
import org.renameme.client.tasks.GetTaskResponse;
...
public class TasksIT extends ESRestHighLevelClientTestCase {
    ...
    public void testListTasks() throws IOException {
        ...
        for (TaskGroup taskGroup : response.getTaskGroups()) {
            org.renameme.tasks.TaskInfo parent = taskGroup.getTaskInfo();
            if ("cluster:monitor/tasks/lists".equals(parent.getAction())) {
                ...
                org.renameme.tasks.TaskInfo child = childGroup.getTaskInfo();
    ...
    public void testGetValidTask() throws Exception {
        ...
        org.renameme.tasks.TaskInfo info = taskResponse.getTaskInfo();
    ...
    public void testCancelTasks() throws IOException {
        ...
        org.renameme.tasks.TaskInfo firstTask = listResponse.getTasks().get(0);
