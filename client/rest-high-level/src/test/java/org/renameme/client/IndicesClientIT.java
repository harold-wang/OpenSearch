...
import org.renameme.action.admin.indices.alias.IndicesAliasesRequest.AliasActions;
import org.renameme.action.admin.indices.alias.get.GetAliasesRequest;
import org.renameme.action.admin.indices.cache.clear.ClearIndicesCacheRequest;
import org.renameme.action.admin.indices.cache.clear.ClearIndicesCacheResponse;
import org.renameme.action.admin.indices.delete.DeleteIndexRequest;
import org.renameme.action.admin.indices.flush.FlushRequest;
import org.renameme.action.admin.indices.flush.FlushResponse;
import org.renameme.action.admin.indices.flush.SyncedFlushRequest;
import org.renameme.action.admin.indices.forcemerge.ForceMergeRequest;
import org.renameme.action.admin.indices.forcemerge.ForceMergeResponse;
import org.renameme.action.admin.indices.open.OpenIndexRequest;
import org.renameme.action.admin.indices.open.OpenIndexResponse;
import org.renameme.action.admin.indices.refresh.RefreshRequest;
import org.renameme.action.admin.indices.refresh.RefreshResponse;
import org.renameme.action.admin.indices.settings.get.GetSettingsRequest;
import org.renameme.action.admin.indices.settings.get.GetSettingsResponse;
import org.renameme.action.admin.indices.settings.put.UpdateSettingsRequest;
import org.renameme.action.admin.indices.shrink.ResizeRequest;
import org.renameme.action.admin.indices.shrink.ResizeResponse;
import org.renameme.action.admin.indices.shrink.ResizeType;
import org.renameme.action.admin.indices.template.delete.DeleteIndexTemplateRequest;
import org.renameme.action.admin.indices.validate.query.ValidateQueryRequest;
import org.renameme.action.admin.indices.validate.query.ValidateQueryResponse;
...
import org.renameme.action.support.broadcast.BroadcastResponse;
import org.renameme.action.support.master.AcknowledgedResponse;
import org.renameme.client.indices.AnalyzeRequest;
import org.renameme.client.indices.AnalyzeResponse;
import org.renameme.client.indices.CloseIndexRequest;
import org.renameme.client.indices.CloseIndexResponse;
import org.renameme.client.indices.ComposableIndexTemplateExistRequest;
import org.renameme.client.indices.CreateDataStreamRequest;
import org.renameme.client.indices.CreateIndexRequest;
import org.renameme.client.indices.CreateIndexResponse;
import org.renameme.client.indices.DataStream;
import org.renameme.client.indices.DataStreamsStatsRequest;
import org.renameme.client.indices.DataStreamsStatsResponse;
import org.renameme.client.indices.DataStreamsStatsResponse.DataStreamStats;
import org.renameme.client.indices.DeleteAliasRequest;
import org.renameme.client.indices.DeleteComposableIndexTemplateRequest;
import org.renameme.client.indices.DeleteDataStreamRequest;
import org.renameme.client.indices.GetComposableIndexTemplateRequest;
import org.renameme.client.indices.GetComposableIndexTemplatesResponse;
import org.renameme.client.indices.GetDataStreamRequest;
import org.renameme.client.indices.GetDataStreamResponse;
import org.renameme.client.indices.GetFieldMappingsRequest;
import org.renameme.client.indices.GetFieldMappingsResponse;
import org.renameme.client.indices.GetIndexRequest;
import org.renameme.client.indices.GetIndexResponse;
import org.renameme.client.indices.GetIndexTemplatesRequest;
import org.renameme.client.indices.GetIndexTemplatesResponse;
import org.renameme.client.indices.GetMappingsRequest;
import org.renameme.client.indices.GetMappingsResponse;
import org.renameme.client.indices.IndexTemplateMetadata;
import org.renameme.client.indices.IndexTemplatesExistRequest;
import org.renameme.client.indices.PutComposableIndexTemplateRequest;
import org.renameme.client.indices.PutIndexTemplateRequest;
import org.renameme.client.indices.PutMappingRequest;
import org.renameme.client.indices.SimulateIndexTemplateRequest;
import org.renameme.client.indices.SimulateIndexTemplateResponse;
import org.renameme.client.indices.rollover.RolloverRequest;
import org.renameme.client.indices.rollover.RolloverResponse;
import org.renameme.cluster.metadata.AliasMetadata;
import org.renameme.cluster.metadata.ComposableIndexTemplate;
import org.renameme.cluster.metadata.IndexMetadata;
import org.renameme.cluster.metadata.MappingMetadata;
import org.renameme.cluster.metadata.Template;
import org.renameme.common.Strings;
import org.renameme.common.ValidationException;
...
import org.renameme.indices.flush.SyncedFlushService;
...
import static org.renameme.common.xcontent.support.XContentMapValues.extractRawValues;
import static org.renameme.common.xcontent.support.XContentMapValues.extractValue;
...
public class IndicesClientIT extends ESRestHighLevelClientTestCase {
    ...
    public void testIndicesExistsWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.get.GetIndexRequest request
            = new org.renameme.action.admin.indices.get.GetIndexRequest();
    ...
    public void testCreateIndexWithTypes() throws IOException {
        {
            ...
            org.renameme.action.admin.indices.create.CreateIndexRequest createIndexRequest =
                new org.renameme.action.admin.indices.create.CreateIndexRequest(indexName);

            org.renameme.action.admin.indices.create.CreateIndexResponse createIndexResponse = execute(
                createIndexRequest,
    ...
    public void testGetSettingsNonExistentIndex() throws IOException {
        ...
        RenamemeException exception = expectThrows(RenamemeException.class,
    ...
    public void testGetIndexWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest =
                new org.renameme.action.admin.indices.get.GetIndexRequest().indices(indexName).includeDefaults(false);
        org.renameme.action.admin.indices.get.GetIndexResponse getIndexResponse = execute(getIndexRequest,
    ...
    public void testPutMappingWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.mapping.put.PutMappingRequest putMappingRequest =
            new org.renameme.action.admin.indices.mapping.put.PutMappingRequest(indexName);
    ...
    public void testGetMappingWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.mapping.get.GetMappingsRequest request =
            new org.renameme.action.admin.indices.mapping.get.GetMappingsRequest().indices(indexName);

        org.renameme.action.admin.indices.mapping.get.GetMappingsResponse getMappingsResponse = execute(
            request,
            highLevelClient().indices()::getMapping,
            highLevelClient().indices()::getMappingAsync,
    ...
    public void testGetFieldMappingWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequest getFieldMappingsRequest =
            new org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequest()
            .indices(indexName)
            .types("_doc")
            .fields("field");

        org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse getFieldMappingsResponse =
            execute(getFieldMappingsRequest,
                highLevelClient().indices()::getFieldMapping,
                highLevelClient().indices()::getFieldMappingAsync,
                expectWarnings(RestGetFieldMappingAction.TYPES_DEPRECATION_MESSAGE));

        final Map<String, org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse.FieldMappingMetadata>
            fieldMappingMap = getFieldMappingsResponse.mappings().get(indexName).get("_doc");

        final  org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse.FieldMappingMetadata metadata =
            new  org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse.FieldMappingMetadata("field",
                new BytesArray("{\"field\":{\"type\":\"text\"}}"));
        assertThat(fieldMappingMap, equalTo(Collections.singletonMap("field", metadata)));
    }
    ...
    public void testAliasesNonExistentIndex() throws IOException {
        ...
        RenamemeException exception = expectThrows(RenamemeException.class, () -> execute(nonExistentIndexRequest,
                highLevelClient().indices()::updateAliases, highLevelClient().indices()::updateAliasesAsync));
        assertThat(exception.status(), equalTo(RestStatus.NOT_FOUND));
        assertThat(exception.getMessage(),
            equalTo("Renameme exception [type=index_not_found_exception, reason=no such index [non_existent_index]]"));
        ...
        exception = expectThrows(RenamemeStatusException.class,
        ...
        exception = expectThrows(RenamemeException.class, () -> execute(removeIndexRequest, highLevelClient().indices()::updateAliases,
                highLevelClient().indices()::updateAliasesAsync));
        assertThat(exception.status(), equalTo(RestStatus.NOT_FOUND));
        assertThat(exception.getMessage(),
            equalTo("Renameme exception [type=index_not_found_exception, reason=no such index [non_existent_index]]"));
    ...
    public void testOpenNonExistentIndex() throws IOException {
        ...
        RenamemeException strictException = expectThrows(RenamemeException.class,
                () -> execute(openIndexRequest, highLevelClient().indices()::open, highLevelClient().indices()::openAsync));
    ...
    public void testCloseEmptyOrNullIndex() {
        ...
        CloseIndexRequest closeIndexRequest = new CloseIndexRequest(indices);
        org.renameme.client.ValidationException exception = expectThrows(org.renameme.client.ValidationException.class,
            () -> execute(closeIndexRequest, highLevelClient().indices()::close, highLevelClient().indices()::closeAsync));
    ...
    public void testSyncedFlush() throws IOException {
        ...
        }
        {
            ...
            RenamemeException exception = expectThrows(
                RenamemeException.class,
                () ->
                    execute(
                        syncedFlushRequest,
    ...
    public void testShrink() throws IOException {
        ...
        Settings targetSettings =
                Settings.builder()
                        ...
                        .build();
        resizeRequest.setTargetIndex(new org.renameme.action.admin.indices.create.CreateIndexRequest("target")
            .settings(targetSettings)
    ...
    public void testRolloverWithTypes() throws IOException {
        ...
        org.renameme.action.admin.indices.rollover.RolloverRequest rolloverRequest =
            new org.renameme.action.admin.indices.rollover.RolloverRequest("alias", "test_new");
        rolloverRequest.addMaxIndexDocsCondition(1);
        rolloverRequest.getCreateIndexRequest().mapping("_doc", "field2", "type=keyword");

        org.renameme.action.admin.indices.rollover.RolloverResponse rolloverResponse = execute(
            rolloverRequest,
    ...
    public void testGetAliasesNonExistentIndexOrAlias() throws IOException {
        ...
        String index = "index";
        {
            ...
            assertThat(getAliasesResponse.getException().getMessage(),
                    equalTo("Renameme exception [type=index_not_found_exception, reason=no such index [index]]"));
        }
        {
            GetAliasesRequest getAliasesRequest = new GetAliasesRequest(alias);
            GetAliasesResponse getAliasesResponse = execute(getAliasesRequest, highLevelClient().indices()::getAlias,
    ...
    public void testIndexPutSettings() throws IOException {
        ...
        RenamemeException exception = expectThrows(RenamemeException.class, () -> execute(staticSettingRequest,
                highLevelClient().indices()::putSettings, highLevelClient().indices()::putSettingsAsync));
        assertThat(exception.getMessage(),
                startsWith("Renameme exception [type=illegal_argument_exception, "
        ...
        exception = expectThrows(RenamemeException.class, () -> execute(unmodifiableSettingRequest,
                highLevelClient().indices()::putSettings, highLevelClient().indices()::putSettingsAsync));
        assertThat(exception.getMessage(), startsWith(
                "Renameme exception [type=illegal_argument_exception, "
    ...
    public void testIndexPutSettingNonExistent() throws IOException {
        ...
        RenamemeException exception = expectThrows(RenamemeException.class, () -> execute(indexUpdateSettingsRequest,
                highLevelClient().indices()::putSettings, highLevelClient().indices()::putSettingsAsync));
        assertEquals(RestStatus.NOT_FOUND, exception.status());
        assertThat(exception.getMessage(),
            equalTo("Renameme exception [type=index_not_found_exception, reason=no such index [index]]"));
        ...
        createIndex(index, Settings.EMPTY);
        exception = expectThrows(RenamemeException.class, () -> execute(indexUpdateSettingsRequest,
                highLevelClient().indices()::putSettings, highLevelClient().indices()::putSettingsAsync));
    ...
    public void testPutTemplateWithTypes() throws Exception {
        org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest putTemplateRequest =
            new org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest()
            .name("my-template")
    ...
    public void testPutTemplateWithTypesUsingUntypedAPI() throws Exception {
        ...
        RenamemeStatusException badMappingError = expectThrows(RenamemeStatusException.class,
    ...
    public void testPutTemplateBadRequests() throws Exception {
        ...
        RenamemeException alreadyExistsError = expectThrows(RenamemeException.class,
        ...
        RenamemeStatusException unknownSettingError = expectThrows(RenamemeStatusException.class,
    ...
    public void testCRUDIndexTemplateWithTypes() throws Exception {
        ...
        org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest putTemplate1 =
            new org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest().name("template-1")
        ...
        org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest putTemplate2 =
            new org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest().name("template-2")
        ...
        org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse getTemplate1 = execute(
        ...
        org.renameme.cluster.metadata.IndexTemplateMetadata template1 = getTemplate1.getIndexTemplates().get(0);
        ...
        org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse getTemplate2 =
            execute(new GetIndexTemplatesRequest("template-2"),
                client.indices()::getTemplate, client.indices()::getTemplateAsync,
                expectWarnings(RestGetIndexTemplateAction.TYPES_DEPRECATION_MESSAGE));
        assertThat(getTemplate2.getIndexTemplates(), hasSize(1));
        org.renameme.cluster.metadata.IndexTemplateMetadata template2 = getTemplate2.getIndexTemplates().get(0);
        ...
        org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse getBoth = execute(
                getBothRequest, client.indices()::getTemplate, client.indices()::getTemplateAsync,
                expectWarnings(RestGetIndexTemplateAction.TYPES_DEPRECATION_MESSAGE));
        assertThat(getBoth.getIndexTemplates(), hasSize(2));
        assertThat(getBoth.getIndexTemplates().stream().map(org.renameme.cluster.metadata.IndexTemplateMetadata::getName).toArray(),
            arrayContainingInAnyOrder("template-1", "template-2"));

        GetIndexTemplatesRequest getAllRequest = new GetIndexTemplatesRequest();
        org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse getAll = execute(
        ...
        assertThat(getAll.getIndexTemplates().stream().map(org.renameme.cluster.metadata.IndexTemplateMetadata::getName)
        ...
        assertThat(expectThrows(RenamemeException.class, () -> execute(new GetIndexTemplatesRequest("template-1"),
            client.indices()::getTemplate, client.indices()::getTemplateAsync)).status(), equalTo(RestStatus.NOT_FOUND));
        assertThat(expectThrows(RenamemeException.class, () -> execute(new DeleteIndexTemplateRequest("template-1"),
        ...
        assertTrue(execute(new DeleteIndexTemplateRequest("template-*"),
            client.indices()::deleteTemplate, client.indices()::deleteTemplateAsync).isAcknowledged());
        assertThat(expectThrows(RenamemeException.class, () -> execute(new GetIndexTemplatesRequest("template-*"),
            client.indices()::getTemplate, client.indices()::getTemplateAsync,
    ...
    public void testDeleteAlias() throws IOException {
        ...
        org.renameme.client.core.AcknowledgedResponse aliasDeleteResponse = execute(request,
    ...
    @AwaitsFix(bugUrl = "https://github.com/elastic/renameme/issues/60461")
    public void testDataStreams() throws Exception {
        ...
        RenamemeStatusException e = expectThrows(RenamemeStatusException.class, () -> execute(finalGetDataStreamRequest,
    ...
    public void testIndexTemplates() throws Exception {
        ...
        RenamemeStatusException statusException = expectThrows(RenamemeStatusException.class,
    ...
    public void testSimulateIndexTemplate() throws Exception {
        ...
        CompressedXContent mappings = new CompressedXContent("{\"properties\":{\"host_name\":{\"type\":\"keyword\"}}}");
        AliasMetadata alias = AliasMetadata.builder("alias").writeIndex(true).build();
        Template template = new Template(settings, mappings, org.renameme.common.collect.Map.of("alias", alias));
        List<String> pattern = org.renameme.common.collect.List.of("pattern");
        ComposableIndexTemplate indexTemplate =
            new ComposableIndexTemplate(pattern, template, Collections.emptyList(), 1L, 1L, new HashMap<>(), null);
        PutComposableIndexTemplateRequest putComposableIndexTemplateRequest =
            new PutComposableIndexTemplateRequest().name(templateName).create(true).indexTemplate(indexTemplate);
        ...
        ComposableIndexTemplate simulationTemplate = new ComposableIndexTemplate(pattern, new Template(null, null,
            org.renameme.common.collect.Map.of("simulation-alias", simulationAlias)), Collections.emptyList(), 2L, 1L,
            new HashMap<>(), null);
