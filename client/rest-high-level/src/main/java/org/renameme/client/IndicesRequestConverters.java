...
final class IndicesRequestConverters {
    ...
    static Request createIndex(org.renameme.action.admin.indices.create.CreateIndexRequest createIndexRequest)
            throws IOException {
    ...
    /**
     * converter for the legacy server-side {@link org.renameme.action.admin.indices.mapping.put.PutMappingRequest} that still supports
     * types
     */
    @Deprecated
    static Request putMapping(org.renameme.action.admin.indices.mapping.put.PutMappingRequest putMappingRequest) throws IOException {
    ...
    @Deprecated
    static Request getMappings(org.renameme.action.admin.indices.mapping.get.GetMappingsRequest getMappingsRequest) {
        String[] indices = getMappingsRequest.indices() == null ? Strings.EMPTY_ARRAY : getMappingsRequest.indices();
    ...
    @Deprecated
    static Request getFieldMapping(org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequest getFieldMappingsRequest) {
        String[] indices = getFieldMappingsRequest.indices() == null ? Strings.EMPTY_ARRAY : getFieldMappingsRequest.indices();
    ...
    @Deprecated
    static Request split(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest) throws IOException {
    ...
    @Deprecated
    static Request shrink(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest) throws IOException {
    ...
    @Deprecated
    static Request clone(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest) throws IOException {
    ...
    @Deprecated
    private static Request resize(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest) throws IOException {
        String endpoint = new RequestConverters.EndpointBuilder().addPathPart(resizeRequest.getSourceIndex())
    ...
    @Deprecated
    static Request rollover(org.renameme.action.admin.indices.rollover.RolloverRequest rolloverRequest) throws IOException {
    ...
    /**
     * converter for the legacy server-side {@link org.renameme.action.admin.indices.get.GetIndexRequest} that
     * still supports types
     */
    @Deprecated
    static Request getIndex(org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest) {
     ...
     */
    @Deprecated
    static Request indicesExist(org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest) {
     ...
     */
    @Deprecated
    static Request putTemplate(org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest putIndexTemplateRequest)
            throws IOException {
