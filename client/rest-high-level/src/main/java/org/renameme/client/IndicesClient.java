...
import org.renameme.client.indices.ResizeRequest;
import org.renameme.client.indices.ResizeResponse;
...
public final class IndicesClient {
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.create.CreateIndexResponse create(
        ...
        return restHighLevelClient.performRequestAndParseEntity(createIndexRequest,
            ...
            org.renameme.action.admin.indices.create.CreateIndexResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable createAsync(org.renameme.action.admin.indices.create.CreateIndexRequest createIndexRequest,
                                   RequestOptions options,
                                   ActionListener<org.renameme.action.admin.indices.create.CreateIndexResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(createIndexRequest,
            IndicesRequestConverters::createIndex, options,
            org.renameme.action.admin.indices.create.CreateIndexResponse::fromXContent, listener, emptySet());
    }
     ...
     */
    @Deprecated
    public AcknowledgedResponse putMapping(org.renameme.action.admin.indices.mapping.put.PutMappingRequest putMappingRequest,
                                           RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(putMappingRequest, IndicesRequestConverters::putMapping, options,
            AcknowledgedResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable putMappingAsync(org.renameme.action.admin.indices.mapping.put.PutMappingRequest putMappingRequest,
                                       RequestOptions options,
                                       ActionListener<AcknowledgedResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(putMappingRequest, IndicesRequestConverters::putMapping, options,
            AcknowledgedResponse::fromXContent, listener, emptySet());
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.mapping.get.GetMappingsResponse getMapping(
            org.renameme.action.admin.indices.mapping.get.GetMappingsRequest getMappingsRequest,
            RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(getMappingsRequest,
            IndicesRequestConverters::getMappings,
            options,
            org.renameme.action.admin.indices.mapping.get.GetMappingsResponse::fromXContent,
            emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable getMappingAsync(org.renameme.action.admin.indices.mapping.get.GetMappingsRequest getMappingsRequest,
                                       RequestOptions options,
                                       ActionListener<org.renameme.action.admin.indices.mapping.get.GetMappingsResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(getMappingsRequest,
            IndicesRequestConverters::getMappings,
            options,
            org.renameme.action.admin.indices.mapping.get.GetMappingsResponse::fromXContent,
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse getFieldMapping(
        ...
        return restHighLevelClient.performRequestAndParseEntity(getFieldMappingsRequest, IndicesRequestConverters::getFieldMapping,
            options, org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse::fromXContent, emptySet());
    }
    ...
    public Cancellable getFieldMappingAsync(
        org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequest getFieldMappingsRequest,
        RequestOptions options,
        ActionListener<org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(getFieldMappingsRequest,
            ...
            org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse::fromXContent,
            listener, emptySet());
    }
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.get.GetIndexResponse get(
            org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest, RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(getIndexRequest, IndicesRequestConverters::getIndex, options,
                org.renameme.action.admin.indices.get.GetIndexResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable getAsync(org.renameme.action.admin.indices.get.GetIndexRequest getIndexRequest, RequestOptions options,
                                ActionListener<org.renameme.action.admin.indices.get.GetIndexResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(getIndexRequest, IndicesRequestConverters::getIndex, options,
                org.renameme.action.admin.indices.get.GetIndexResponse::fromXContent, listener, emptySet());
    }
     ...
     */
    @Deprecated
    public boolean exists(org.renameme.action.admin.indices.get.GetIndexRequest request, RequestOptions options) throws IOException {
        return restHighLevelClient.performRequest(
            request,
            IndicesRequestConverters::indicesExist,
            options,
     ...
     */
    @Deprecated
    public Cancellable existsAsync(org.renameme.action.admin.indices.get.GetIndexRequest request, RequestOptions options,
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.shrink.ResizeResponse shrink(
        org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(resizeRequest, IndicesRequestConverters::shrink, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable shrinkAsync(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options,
                                   ActionListener<org.renameme.action.admin.indices.shrink.ResizeResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(resizeRequest, IndicesRequestConverters::shrink, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, listener, emptySet());
    }
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.shrink.ResizeResponse split(
        org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(resizeRequest, IndicesRequestConverters::split, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable splitAsync(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options,
                                  ActionListener<org.renameme.action.admin.indices.shrink.ResizeResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(resizeRequest, IndicesRequestConverters::split, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, listener, emptySet());
    }
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.shrink.ResizeResponse clone(
        org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(resizeRequest, IndicesRequestConverters::clone, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable cloneAsync(org.renameme.action.admin.indices.shrink.ResizeRequest resizeRequest, RequestOptions options,
                                  ActionListener<org.renameme.action.admin.indices.shrink.ResizeResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(resizeRequest, IndicesRequestConverters::clone, options,
            org.renameme.action.admin.indices.shrink.ResizeResponse::fromXContent, listener, emptySet());
    }
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.rollover.RolloverResponse rollover(
            org.renameme.action.admin.indices.rollover.RolloverRequest rolloverRequest,
            RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(rolloverRequest, IndicesRequestConverters::rollover, options,
            org.renameme.action.admin.indices.rollover.RolloverResponse::fromXContent, emptySet());
    }
     ...
     */
    @Deprecated
    public Cancellable rolloverAsync(org.renameme.action.admin.indices.rollover.RolloverRequest rolloverRequest,
            RequestOptions options,
            ActionListener<org.renameme.action.admin.indices.rollover.RolloverResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(rolloverRequest, IndicesRequestConverters::rollover, options,
            org.renameme.action.admin.indices.rollover.RolloverResponse::fromXContent, listener, emptySet());
    }
    ...
    public AcknowledgedResponse putTemplate(
            org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest putIndexTemplateRequest,
            RequestOptions options) throws IOException {
     ...
     */
    @Deprecated
    public org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse getTemplate(
        ...
        return restHighLevelClient.performRequestAndParseEntity(getIndexTemplatesRequest,
            ...
            options,
            org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse::fromXContent, emptySet());
    }
    ...
    public Cancellable getTemplateAsync(GetIndexTemplatesRequest getIndexTemplatesRequest, RequestOptions options,
            ActionListener<org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(getIndexTemplatesRequest,
            IndicesRequestConverters::getTemplatesWithDocumentTypes,
            options,
            org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse::fromXContent,
            listener, emptySet());
    }
     ...
     * @param options the request options (e.g. headers), use {@link RequestOptions#DEFAULT} if nothing needs to be customized
     */
    public org.renameme.client.core.AcknowledgedResponse deleteAlias(DeleteAliasRequest request,
                                                                          RequestOptions options) throws IOException {
        return restHighLevelClient.performRequestAndParseEntity(request, IndicesRequestConverters::deleteAlias, options,
            org.renameme.client.core.AcknowledgedResponse::fromXContent, emptySet());
    }
    ...
    public Cancellable deleteAliasAsync(DeleteAliasRequest request, RequestOptions options,
                                                ActionListener<org.renameme.client.core.AcknowledgedResponse> listener) {
        return restHighLevelClient.performRequestAsyncAndParseEntity(request, IndicesRequestConverters::deleteAlias, options,
            org.renameme.client.core.AcknowledgedResponse::fromXContent, listener, emptySet());
    }
}
