...
public final class NodesResponseHeader {
    ...
    public static final ConstructingObjectParser<NodesResponseHeader, Void> PARSER =
        new ConstructingObjectParser<>("nodes_response_header", true,
            (a) -> {
                ...
                List<RenamemeException> failures = (List<RenamemeException>) a[i++];
    ...
    static {
        ...
        PARSER.declareObjectArray(ConstructingObjectParser.optionalConstructorArg(),
            (p, c) -> RenamemeException.fromXContent(p), FAILURES);
    }

    private final int total;
    private final int successful;
    private final int failed;
    private final List<RenamemeException> failures;

    public NodesResponseHeader(int total, int successful, int failed, @Nullable List<RenamemeException> failures) {
        this.total = total;
     ...
     */
    public List<RenamemeException> getFailures() {
        return failures;
    }
