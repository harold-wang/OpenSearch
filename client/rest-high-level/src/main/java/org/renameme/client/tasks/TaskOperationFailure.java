 ...
 * {@link org.renameme.action.TaskOperationFailure}
 */
public class TaskOperationFailure {

    private final String nodeId;
    private final long taskId;
    private final RenamemeException reason;
    private final String status;

    public TaskOperationFailure(String nodeId, long taskId,String status, RenamemeException reason) {
        this.nodeId = nodeId;
        this.taskId = taskId;
        this.status = status;
        this.reason = reason;
    ...
    public RenamemeException getReason() {
        return reason;
    }
    ...
    private static final ConstructingObjectParser<TaskOperationFailure, Void> PARSER =
        new ConstructingObjectParser<>("task_info", true, constructorObjects -> {
            ...
            RenamemeException reason = (RenamemeException) constructorObjects[i];
    ...
    static {
        ...
        PARSER.declareObject(constructorArg(), (parser, c) -> RenamemeException.fromXContent(parser), new ParseField("reason"));
    }
}
