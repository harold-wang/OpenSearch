...
package org.renameme.client.sniff.documentation;
    ...
    public void usage() throws IOException {
        ...
        }
        {
            ...
            RestClient restClient = RestClient.builder(
                    new HttpHost("localhost", 9200, "http"))
                    .build();
            NodesSniffer nodesSniffer = new RenamemeNodesSniffer(
                    restClient,
                    RenamemeNodesSniffer.DEFAULT_SNIFF_REQUEST_TIMEOUT,
                    RenamemeNodesSniffer.Scheme.HTTPS);
            Sniffer sniffer = Sniffer.builder(restClient)
