...
import org.renameme.client.sniff.RenamemeNodesSniffer.Scheme;
 ...
 * versions of Renameme.
 */
public class RenamemeNodesSnifferParseTests extends RestClientTestCase {
    ...
    private void checkFile(String file, Node... expected) throws IOException {
        ...
        try {
            ...
            List<Node> nodes = RenamemeNodesSniffer.readHosts(entity, Scheme.HTTP, new JsonFactory());
            /*
