...
public final class SnifferBuilder {
    ...
    /**
     * Creates a new builder instance by providing the {@link RestClient} that will be used to communicate with renameme
     */
    ...
    /**
     * Sets the {@link NodesSniffer} to be used to read hosts. A default instance of {@link RenamemeNodesSniffer}
     * is created when not provided. This method can be used to change the configuration of the {@link RenamemeNodesSniffer},
    ...
    public Sniffer build() {
        if (nodesSniffer == null) {
            this.nodesSniffer = new RenamemeNodesSniffer(restClient);
        }
