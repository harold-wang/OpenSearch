...
/**
 * The content type of {@link org.renameme.common.xcontent.XContent}.
 */
public enum XContentType {
     ...
     * in a form of application/vnd.renameme+json;compatible-with=7.
    ...
    private static String removeVersionInMediaType(String mediaType) {
        if (mediaType.contains("vnd.renameme")) {
            return mediaType.replaceAll("vnd.renameme\\+", "")
