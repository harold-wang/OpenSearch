...
package org.renameme.common.ssl;
...
import static org.renameme.common.ssl.SslConfigurationKeys.CERTIFICATE;
import static org.renameme.common.ssl.SslConfigurationKeys.CERTIFICATE_AUTHORITIES;
import static org.renameme.common.ssl.SslConfigurationKeys.CIPHERS;
import static org.renameme.common.ssl.SslConfigurationKeys.CLIENT_AUTH;
import static org.renameme.common.ssl.SslConfigurationKeys.KEY;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_ALGORITHM;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_KEY_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_PATH;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_KEY_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.KEYSTORE_TYPE;
import static org.renameme.common.ssl.SslConfigurationKeys.KEY_LEGACY_PASSPHRASE;
import static org.renameme.common.ssl.SslConfigurationKeys.KEY_SECURE_PASSPHRASE;
import static org.renameme.common.ssl.SslConfigurationKeys.PROTOCOLS;
import static org.renameme.common.ssl.SslConfigurationKeys.TRUSTSTORE_ALGORITHM;
import static org.renameme.common.ssl.SslConfigurationKeys.TRUSTSTORE_LEGACY_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.TRUSTSTORE_PATH;
import static org.renameme.common.ssl.SslConfigurationKeys.TRUSTSTORE_SECURE_PASSWORD;
import static org.renameme.common.ssl.SslConfigurationKeys.TRUSTSTORE_TYPE;
import static org.renameme.common.ssl.SslConfigurationKeys.VERIFICATION_MODE;
...
public abstract class SslConfigurationLoader {
    ...
    static final List<String> DEFAULT_PROTOCOLS = Collections.unmodifiableList(
        SslConfiguration.ORDERED_PROTOCOL_ALGORITHM_MAP.containsKey("TLSv1.3") ?
     ...
     *
     * @param basePath The base path to use for any settings that represent file paths. Typically points to the Renameme
    ...
    private SslTrustConfig buildTrustConfig(Path basePath, SslVerificationMode verificationMode) {
        ...
        if (trustStorePath != null) {
            ...
            final String storeType = resolveSetting(TRUSTSTORE_TYPE, Function.identity(), KeyStoreUtil.inferKeyStoreType(trustStorePath));
    ...
    private SslKeyConfig buildKeyConfig(Path basePath) {
        ...
        if (keyStorePath != null) {
            ...
            final String storeType = resolveSetting(KEYSTORE_TYPE, Function.identity(), KeyStoreUtil.inferKeyStoreType(keyStorePath));
