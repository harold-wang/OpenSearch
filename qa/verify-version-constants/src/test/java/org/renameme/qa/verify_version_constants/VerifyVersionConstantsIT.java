...
package org.renameme.qa.verify_version_constants;
...
public class VerifyVersionConstantsIT extends ESRestTestCase {
    ...
    public void testLuceneVersionConstant() throws IOException, ParseException {
        ...
        final String renamemeVersionString = objectPath.evaluate("version.number").toString();
        final Version renamemeVersion = Version.fromString(renamemeVersionString.replace("-SNAPSHOT", ""));
        ...
        assertThat(renamemeVersion.luceneVersion, equalTo(luceneVersion));
    }
