...
import static org.renameme.test.rest.ESRestTestCase.entityAsMap;
...
public class SystemIndexRestIT extends HttpSmokeTestCase {
    ...
    public static class SystemIndexTestPlugin extends Plugin implements SystemIndexPlugin {
        ...
        public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
            ...
            return org.renameme.common.collect.List.of(new AddDocRestHandler());
        }
        ...
        public static class AddDocRestHandler extends BaseRestHandler {
            ...
            public List<Route> routes() {
                return org.renameme.common.collect.List.of(new Route(RestRequest.Method.POST, "/_sys_index_test/add_doc/{id}"));
            }
            ...
            protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
                ...
                indexRequest.source(org.renameme.common.collect.Map.of("some_field", "some_value"));
