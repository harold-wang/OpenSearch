...
import org.renameme.bootstrap.ESPolicy;
...
public class ESPolicyUnitTests extends ESTestCase {
    ...
    public void testDataPathPermissionIsChecked() {
        ...
        dataPathPermission.add(new FilePermission("/home/renameme/data/-", "read"));
        ...
        assertTrue(
            policy.implies(
                    ...
                    new FilePermission("/home/renameme/data/index/file.si", "read")));
    }
}
