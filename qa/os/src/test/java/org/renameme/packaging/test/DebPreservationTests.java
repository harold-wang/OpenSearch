...
import static org.renameme.packaging.util.FileUtils.assertPathsDoNotExist;
import static org.renameme.packaging.util.FileUtils.assertPathsExist;
import static org.renameme.packaging.util.Packages.SYSVINIT_SCRIPT;
import static org.renameme.packaging.util.Packages.assertInstalled;
import static org.renameme.packaging.util.Packages.assertRemoved;
import static org.renameme.packaging.util.Packages.installPackage;
import static org.renameme.packaging.util.Packages.packageStatus;
import static org.renameme.packaging.util.Packages.remove;
import static org.renameme.packaging.util.Packages.verifyPackageInstallation;
...
public class DebPreservationTests extends PackagingTestCase {
    ...
    public void test20Remove() throws Exception {
        ...
        assertPathsExist(
            installation.config,
            installation.config("renameme.yml"),
        ...
        assertPathsDoNotExist(installation.config("renameme.keystore"), installation.config(".renameme.keystore.initial_md5sum"));
        ...
        assertThat(SYSVINIT_SCRIPT, FileExistenceMatchers.fileExists());

        // defaults file was not removed
        assertThat(installation.envFile, FileExistenceMatchers.fileExists());
    }
