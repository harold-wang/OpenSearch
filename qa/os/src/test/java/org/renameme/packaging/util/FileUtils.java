...
public class FileUtils {
    ...
    public static Path getDefaultArchiveInstallPath() {
        return getRootTempDir().resolve("renameme");
    }
    ...
    public static void assertPathsExist(final Path... paths) {
        Arrays.stream(paths).forEach(path -> assertThat(path, FileExistenceMatchers.fileExists()));
    }
    ...
    public static void assertPathsDoNotExist(final Path... paths) {
        Arrays.stream(paths).forEach(path -> assertThat(path, FileExistenceMatchers.fileDoesNotExist()));
    }
