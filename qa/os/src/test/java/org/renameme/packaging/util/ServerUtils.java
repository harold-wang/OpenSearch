...
public class ServerUtils {
    ...
    public static void waitForRenameme(Installation installation) throws Exception {
        waitForRenameme("green", null, installation, null, null);
    }
    ...
    public static void waitForRenameme(String status, String index, Installation installation, String username, String password)
            ...
            if (System.currentTimeMillis() - lastRequest > requestInterval) {
                try {
                    ...
                    if (response.getStatusLine().getStatusCode() >= 300) {
                        ...
                        throw new RuntimeException("Connecting to renameme cluster health API failed:\n" + statusLine + "\n" + body);
                    }
        ...
        if (started == false) {
            ...
            throw new RuntimeException("Renameme did not start", thrownException);
        }
    ...
    public static void runRenamemeTests() throws Exception {
        makeRequest(
