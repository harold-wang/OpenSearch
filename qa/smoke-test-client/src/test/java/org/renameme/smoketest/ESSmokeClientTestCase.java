...
package org.renameme.smoketest;
...
/**
 * An abstract base class to run integration tests against an Renameme cluster running outside of the test process.
 * <p>
...
public abstract class ESSmokeClientTestCase extends LuceneTestCase {
    ...
    private static Client startClient(Path tempDir, TransportAddress... transportAddresses) {
        ...
        logger.info("--> Renameme Java TransportClient started");
