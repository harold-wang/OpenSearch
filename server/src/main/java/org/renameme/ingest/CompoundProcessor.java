...
public class CompoundProcessor implements Processor {
    ...
    void executeOnFailureAsync(int currentOnFailureProcessor, IngestDocument ingestDocument, RenamemeException exception,
    ...
    private void putFailureMetadata(IngestDocument ingestDocument, RenamemeException cause) {
