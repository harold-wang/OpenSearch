...
public final class ConfigurationUtils {
     ...
     *
     * If the property value isn't of type string a {@link RenamemeParseException} is thrown.
     */
     ...
     *
     * If the property value isn't of type string an {@link RenamemeParseException} is thrown.
     * If the property is missing an {@link RenamemeParseException} is thrown
     */
     ...
     *
     * If the property value isn't of type string a {@link RenamemeParseException} is thrown.
     * If the property is missing and no default value has been specified a {@link RenamemeParseException} is thrown
     */
    public static String readStringProperty(String processorType, String processorTag, Map<String, Object> configuration,
     ...
     * Returns and removes the specified property from the specified configuration map.
     *
     * If the property value isn't of type string or int a {@link RenamemeParseException} is thrown.
     * If the property is missing and no default value has been specified a {@link RenamemeParseException} is thrown
     */
     ...
     * Returns and removes the specified property from the specified configuration map.
     *
     * If the property value isn't of type int a {@link RenamemeParseException} is thrown.
     * If the property is missing an {@link RenamemeParseException} is thrown
     */
     ...
     *
     * If the property value isn't of type list an {@link RenamemeParseException} is thrown.
     */
     ...
     *
     * If the property value isn't of type map an {@link RenamemeParseException} is thrown.
     * If the property is missing an {@link RenamemeParseException} is thrown
     */
    ...
    public static RenamemeException newConfigurationException(String processorType, String processorTag,
        ...
        RenamemeParseException exception = new RenamemeParseException(msg);
    ...
    public static RenamemeException newConfigurationException(String processorType, String processorTag,
        ...
        RenamemeException exception = ExceptionsHelper.convertToElastic(cause);
        addMetadataToException(exception, processorType, processorTag, propertyName);
        return exception;
    }
    ...
    private static void addMetadataToException(RenamemeException exception, String processorType,
        ...
        if (factory != null) {
            ...
            try {
                ...
                if (config.isEmpty() == false) {
                    throw new RenamemeParseException("processor [{}] doesn't support one or more provided configuration parameters {}",
