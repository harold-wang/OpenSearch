...
public class Requests {
     ...
     * @see org.renameme.client.Client#index(org.renameme.action.index.IndexRequest)
     */
     ...
     * @see org.renameme.client.Client#delete(org.renameme.action.delete.DeleteRequest)
     */
     ...
     * @see org.renameme.client.Client#get(org.renameme.action.get.GetRequest)
     */
     ...
     * actual JSON search source, or the {@link org.renameme.search.builder.SearchSourceBuilder}.
     *
     * @param indices The indices to search against. Use {@code null} or {@code _all} to execute against all indices
     * @return The search request
     * @see org.renameme.client.Client#search(org.renameme.action.search.SearchRequest)
     */
     ...
     * @see org.renameme.client.Client#searchScroll(org.renameme.action.search.SearchScrollRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#shardStores(IndicesShardStoresRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#exists(org.renameme.action.admin.indices.exists.indices.IndicesExistsRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#create(org.renameme.action.admin.indices.create.CreateIndexRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#delete(org.renameme.action.admin.indices.delete.DeleteIndexRequest)
     */
     ...
     * @return The delete index request
     * @see org.renameme.client.IndicesAdminClient#close(org.renameme.action.admin.indices.close.CloseIndexRequest)
     */
     ...
     * @return The delete index request
     * @see org.renameme.client.IndicesAdminClient#open(org.renameme.action.admin.indices.open.OpenIndexRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#putMapping(org.renameme.action.admin.indices.mapping.put.PutMappingRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#refresh(org.renameme.action.admin.indices.refresh.RefreshRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#flush(org.renameme.action.admin.indices.flush.FlushRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#syncedFlush(SyncedFlushRequest)
     */
     ...
     * @see org.renameme.client.IndicesAdminClient#forceMerge(org.renameme.action.admin.indices.forcemerge.ForceMergeRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#state(org.renameme.action.admin.cluster.state.ClusterStateRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#health(org.renameme.action.admin.cluster.health.ClusterHealthRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#nodesInfo(org.renameme.action.admin.cluster.node.info.NodesInfoRequest)
     */
     ...
     * @return The nodes info request
     * @see org.renameme.client.ClusterAdminClient#nodesStats(org.renameme.action.admin.cluster.node.stats.NodesStatsRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#nodesUsage(org.renameme.action.admin.cluster.node.usage.NodesUsageRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#clusterStats(org.renameme.action.admin.cluster.stats.ClusterStatsRequest)
     */
     ...
     * @see org.renameme.client.ClusterAdminClient#listTasks(ListTasksRequest)
     */
     ...
     *
     * @return The nodes tasks request
     * @see org.renameme.client.ClusterAdminClient#getTask(GetTaskRequest)
     */
     ...
     *
     * @return The nodes tasks request
     * @see org.renameme.client.ClusterAdminClient#cancelTasks(CancelTasksRequest)
     */
