...
package org.renameme.client.support;
...
import org.renameme.action.admin.indices.alias.IndicesAliasesRequestBuilder;
import org.renameme.action.admin.indices.alias.exists.AliasesExistAction;
import org.renameme.action.admin.indices.alias.exists.AliasesExistRequestBuilder;
import org.renameme.action.admin.indices.alias.exists.AliasesExistResponse;
...
import org.renameme.action.admin.indices.alias.get.GetAliasesRequestBuilder;
import org.renameme.action.admin.indices.alias.get.GetAliasesResponse;
import org.renameme.action.admin.indices.analyze.AnalyzeAction;
import org.renameme.action.admin.indices.analyze.AnalyzeRequestBuilder;
...
import org.renameme.action.admin.indices.cache.clear.ClearIndicesCacheRequestBuilder;
...
import org.renameme.action.admin.indices.close.CloseIndexRequest;
import org.renameme.action.admin.indices.close.CloseIndexRequestBuilder;
...
import org.renameme.action.admin.indices.create.CreateIndexRequestBuilder;
...
import org.renameme.action.admin.indices.delete.DeleteIndexRequestBuilder;
import org.renameme.action.admin.indices.exists.indices.IndicesExistsAction;
import org.renameme.action.admin.indices.exists.indices.IndicesExistsRequest;
import org.renameme.action.admin.indices.exists.indices.IndicesExistsRequestBuilder;
import org.renameme.action.admin.indices.exists.indices.IndicesExistsResponse;
import org.renameme.action.admin.indices.exists.types.TypesExistsAction;
import org.renameme.action.admin.indices.exists.types.TypesExistsRequest;
import org.renameme.action.admin.indices.exists.types.TypesExistsRequestBuilder;
import org.renameme.action.admin.indices.exists.types.TypesExistsResponse;
import org.renameme.action.admin.indices.flush.FlushAction;
import org.renameme.action.admin.indices.flush.FlushRequest;
import org.renameme.action.admin.indices.flush.FlushRequestBuilder;
...
import org.renameme.action.admin.indices.flush.SyncedFlushRequestBuilder;
...
import org.renameme.action.admin.indices.forcemerge.ForceMergeRequestBuilder;
...
import org.renameme.action.admin.indices.get.GetIndexRequest;
import org.renameme.action.admin.indices.get.GetIndexRequestBuilder;
import org.renameme.action.admin.indices.get.GetIndexResponse;
import org.renameme.action.admin.indices.mapping.get.GetFieldMappingsAction;
import org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequest;
import org.renameme.action.admin.indices.mapping.get.GetFieldMappingsRequestBuilder;
import org.renameme.action.admin.indices.mapping.get.GetFieldMappingsResponse;
import org.renameme.action.admin.indices.mapping.get.GetMappingsAction;
import org.renameme.action.admin.indices.mapping.get.GetMappingsRequest;
import org.renameme.action.admin.indices.mapping.get.GetMappingsRequestBuilder;
...
import org.renameme.action.admin.indices.mapping.put.PutMappingRequestBuilder;
...
import org.renameme.action.admin.indices.open.OpenIndexRequestBuilder;
...
import org.renameme.action.admin.indices.readonly.AddIndexBlockRequestBuilder;
import org.renameme.action.admin.indices.readonly.AddIndexBlockResponse;
import org.renameme.action.admin.indices.recovery.RecoveryAction;
import org.renameme.action.admin.indices.recovery.RecoveryRequest;
import org.renameme.action.admin.indices.recovery.RecoveryRequestBuilder;
import org.renameme.action.admin.indices.recovery.RecoveryResponse;
...
import org.renameme.action.admin.indices.refresh.RefreshRequestBuilder;
...
import org.renameme.action.admin.indices.rollover.RolloverRequest;
import org.renameme.action.admin.indices.rollover.RolloverRequestBuilder;
import org.renameme.action.admin.indices.rollover.RolloverResponse;
import org.renameme.action.admin.indices.segments.IndicesSegmentResponse;
import org.renameme.action.admin.indices.segments.IndicesSegmentsAction;
import org.renameme.action.admin.indices.segments.IndicesSegmentsRequest;
import org.renameme.action.admin.indices.segments.IndicesSegmentsRequestBuilder;
...
import org.renameme.action.admin.indices.settings.get.GetSettingsRequestBuilder;
...
import org.renameme.action.admin.indices.settings.put.UpdateSettingsRequestBuilder;
import org.renameme.action.admin.indices.shards.IndicesShardStoreRequestBuilder;
import org.renameme.action.admin.indices.shards.IndicesShardStoresAction;
import org.renameme.action.admin.indices.shards.IndicesShardStoresRequest;
import org.renameme.action.admin.indices.shards.IndicesShardStoresResponse;
...
import org.renameme.action.admin.indices.shrink.ResizeRequestBuilder;
...
import org.renameme.action.admin.indices.stats.IndicesStatsRequest;
...
import org.renameme.action.admin.indices.template.delete.DeleteIndexTemplateRequestBuilder;
import org.renameme.action.admin.indices.template.get.GetIndexTemplatesAction;
import org.renameme.action.admin.indices.template.get.GetIndexTemplatesRequest;
import org.renameme.action.admin.indices.template.get.GetIndexTemplatesRequestBuilder;
import org.renameme.action.admin.indices.template.get.GetIndexTemplatesResponse;
import org.renameme.action.admin.indices.template.put.PutIndexTemplateAction;
import org.renameme.action.admin.indices.template.put.PutIndexTemplateRequest;
import org.renameme.action.admin.indices.template.put.PutIndexTemplateRequestBuilder;
import org.renameme.action.admin.indices.upgrade.get.UpgradeStatusAction;
import org.renameme.action.admin.indices.upgrade.get.UpgradeStatusRequest;
import org.renameme.action.admin.indices.upgrade.get.UpgradeStatusRequestBuilder;
import org.renameme.action.admin.indices.upgrade.get.UpgradeStatusResponse;
import org.renameme.action.admin.indices.upgrade.post.UpgradeAction;
import org.renameme.action.admin.indices.upgrade.post.UpgradeRequest;
import org.renameme.action.admin.indices.upgrade.post.UpgradeRequestBuilder;
import org.renameme.action.admin.indices.upgrade.post.UpgradeResponse;
...
import org.renameme.action.admin.indices.validate.query.ValidateQueryRequestBuilder;
...
import org.renameme.action.delete.DeleteRequestBuilder;
import org.renameme.action.delete.DeleteResponse;
import org.renameme.action.explain.ExplainAction;
import org.renameme.action.explain.ExplainRequest;
import org.renameme.action.explain.ExplainRequestBuilder;
import org.renameme.action.explain.ExplainResponse;
import org.renameme.action.fieldcaps.FieldCapabilitiesAction;
import org.renameme.action.fieldcaps.FieldCapabilitiesRequest;
import org.renameme.action.fieldcaps.FieldCapabilitiesRequestBuilder;
import org.renameme.action.fieldcaps.FieldCapabilitiesResponse;
import org.renameme.action.get.GetAction;
import org.renameme.action.get.GetRequest;
import org.renameme.action.get.GetRequestBuilder;
import org.renameme.action.get.GetResponse;
import org.renameme.action.get.MultiGetAction;
import org.renameme.action.get.MultiGetRequest;
import org.renameme.action.get.MultiGetRequestBuilder;
import org.renameme.action.get.MultiGetResponse;
...
import org.renameme.action.search.ClearScrollRequestBuilder;
import org.renameme.action.search.ClearScrollResponse;
import org.renameme.action.search.MultiSearchAction;
import org.renameme.action.search.MultiSearchRequest;
import org.renameme.action.search.MultiSearchRequestBuilder;
...
import org.renameme.action.search.SearchScrollRequest;
import org.renameme.action.search.SearchScrollRequestBuilder;
import org.renameme.action.support.PlainActionFuture;
import org.renameme.action.support.ThreadedActionListener;
...
import org.renameme.action.termvectors.MultiTermVectorsRequest;
import org.renameme.action.termvectors.MultiTermVectorsRequestBuilder;
import org.renameme.action.termvectors.MultiTermVectorsResponse;
import org.renameme.action.termvectors.TermVectorsAction;
import org.renameme.action.termvectors.TermVectorsRequest;
import org.renameme.action.termvectors.TermVectorsRequestBuilder;
import org.renameme.action.termvectors.TermVectorsResponse;
import org.renameme.action.update.UpdateAction;
import org.renameme.action.update.UpdateRequest;
import org.renameme.action.update.UpdateRequestBuilder;
import org.renameme.action.update.UpdateResponse;
import org.renameme.client.AdminClient;
import org.renameme.client.Client;
import org.renameme.client.ClusterAdminClient;
import org.renameme.client.RenamemeClient;
import org.renameme.client.FilterClient;
import org.renameme.client.IndicesAdminClient;
import org.renameme.cluster.metadata.IndexMetadata.APIBlock;
...
public abstract class AbstractClient implements Client {
    ...
    static class ClusterAdmin implements ClusterAdminClient {
        ...
        private final RenamemeClient client;

        ClusterAdmin(RenamemeClient client) {
            this.client = client;
        }
    ...
    static class IndicesAdmin implements IndicesAdminClient {
        ...
        IndicesAdmin(RenamemeClient client) {
            this.client = client;
        }
