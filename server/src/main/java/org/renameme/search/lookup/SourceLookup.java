 ...
 * under the License.
 */
package org.renameme.search.lookup;
...
public class SourceLookup implements Map {
    ...
    public Map<String, Object> loadSourceIfNeeded() {
        ...
        try {
            ...
            throw new RenamemeParseException("failed to parse / load source", e);
        }
        return this.source;
    }

    private static Tuple<XContentType, Map<String, Object>> sourceAsMapAndType(BytesReference source) throws RenamemeParseException {
        return XContentHelper.convertToMap(source, false);
    }

    public static Map<String, Object> sourceAsMap(BytesReference source) throws RenamemeParseException {
