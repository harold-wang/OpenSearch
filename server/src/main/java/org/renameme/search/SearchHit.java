...
import org.renameme.search.lookup.SourceLookup;
import org.renameme.transport.RemoteClusterAware;
...
import static org.renameme.common.lucene.Lucene.readExplanation;
import static org.renameme.common.lucene.Lucene.writeExplanation;
...
public final class SearchHit implements Writeable, ToXContentObject, Iterable<DocumentField> {
    ...
    public BytesReference getSourceRef() {
        ...
        try {
            ...
            throw new RenamemeParseException("failed to decompress source", e);
        }
    }
    ...
    public String getSourceAsString() {
        ...
        try {
            ...
            throw new RenamemeParseException("failed to convert source to a json string");
        }
    }
    ...
    * */
     ...
     * {@link org.renameme.search.suggest.completion.CompletionSuggestion.Entry.Option} which unfortunately inlines
     * the output of
     * {@link #toInnerXContent(XContentBuilder, org.renameme.common.xcontent.ToXContent.Params)}
