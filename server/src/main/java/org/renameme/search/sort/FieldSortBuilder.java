...
import org.renameme.common.time.DateUtils;
...
import org.renameme.index.fielddata.IndexNumericFieldData.NumericType;
...
import org.renameme.index.mapper.NumberFieldMapper.NumberFieldType;
...
import org.renameme.search.SearchSortValuesAndFormats;
...
import static org.renameme.index.mapper.DateFieldMapper.Resolution.MILLISECONDS;
import static org.renameme.index.mapper.DateFieldMapper.Resolution.NANOSECONDS;
...
public class FieldSortBuilder extends SortBuilder<FieldSortBuilder> {
    ...
    public boolean isBottomSortShardDisjoint(QueryShardContext context, SearchSortValuesAndFormats bottomSortValues) throws IOException {
        ...
        } catch (RenamemeParseException exc) {
