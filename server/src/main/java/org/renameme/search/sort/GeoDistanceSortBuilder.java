...
package org.renameme.search.sort;
...
import org.renameme.index.fielddata.plain.AbstractLatLonPointIndexFieldData.LatLonPointIndexFieldData;
import org.renameme.index.mapper.MappedFieldType;
import org.renameme.index.query.GeoValidationMethod;
...
import static org.renameme.search.sort.FieldSortBuilder.validateMaxChildrenExistOnlyInTopLevelNestedSort;
import static org.renameme.search.sort.NestedSortBuilder.NESTED_FIELD;
...
public class GeoDistanceSortBuilder extends SortBuilder<GeoDistanceSortBuilder> {
    ...
    /**
     * The distance unit to use. Defaults to {@link org.renameme.common.unit.DistanceUnit#METERS}
     */
    ...
    /**
     * Returns the distance unit to use. Defaults to {@link org.renameme.common.unit.DistanceUnit#METERS}
     */
   ...
   @Deprecated
     ...
     * {@link org.renameme.common.xcontent.XContent} format.
     *
