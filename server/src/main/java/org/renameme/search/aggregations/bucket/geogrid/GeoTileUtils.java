...
import org.renameme.common.util.ESSloppyMath;
...
import static org.renameme.common.geo.GeoUtils.normalizeLat;
import static org.renameme.common.geo.GeoUtils.normalizeLon;
...
public final class GeoTileUtils {
     ...
     */
    static int parsePrecision(XContentParser parser) throws IOException, RenamemeParseException {
