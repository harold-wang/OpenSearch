...
import org.renameme.search.aggregations.bucket.range.RangeAggregator.Range;
import org.renameme.search.aggregations.bucket.range.RangeAggregator.Unmapped;
import org.renameme.search.aggregations.support.CoreValuesSourceType;
import org.renameme.search.aggregations.support.ValuesSource.Numeric;
...
public class AbstractRangeAggregatorFactory<R extends Range> extends ValuesSourceAggregatorFactory {
    ...
    public static void registerAggregators(
        ...
        builder.register(
            registryKey,
            org.renameme.common.collect.List.of(CoreValuesSourceType.NUMERIC, CoreValuesSourceType.DATE, CoreValuesSourceType.BOOLEAN),
            RangeAggregator::new,
                true);
    }
