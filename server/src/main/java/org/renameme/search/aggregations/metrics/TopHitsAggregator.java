...
import org.renameme.common.util.LongObjectPagedHashMap;
...
import org.renameme.search.internal.SubSearchContext;
        ...
        if (subSearchContext.sort() == null) {
            for (RescoreContext ctx : context().rescore()) {
                try {
                    ...
                    throw new RenamemeException("Rescore TopHits Failed", e);
                }
            }
