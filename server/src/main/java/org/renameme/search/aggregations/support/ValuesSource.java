...
import org.renameme.common.Rounding.Prepared;
import org.renameme.common.lucene.ScorerAware;
import org.renameme.common.util.CollectionUtils;
import org.renameme.index.fielddata.AbstractSortingNumericDocValues;
import org.renameme.index.fielddata.DocValueBits;
import org.renameme.index.fielddata.IndexFieldData;
import org.renameme.index.fielddata.IndexGeoPointFieldData;
import org.renameme.index.fielddata.IndexNumericFieldData;
import org.renameme.index.fielddata.IndexOrdinalsFieldData;
import org.renameme.index.fielddata.LeafOrdinalsFieldData;
...
import org.renameme.index.fielddata.SortingBinaryDocValues;
import org.renameme.index.fielddata.SortingNumericDoubleValues;
import org.renameme.index.mapper.RangeType;
import org.renameme.script.AggregationScript;
import org.renameme.search.aggregations.AggregationExecutionException;
import org.renameme.search.aggregations.support.ValuesSource.Bytes.WithScript.BytesValues;
import org.renameme.search.aggregations.support.values.ScriptBytesValues;
import org.renameme.search.aggregations.support.values.ScriptDoubleValues;
import org.renameme.search.aggregations.support.values.ScriptLongValues;
...
public abstract class ValuesSource {
    ...
    public static class Range extends ValuesSource {
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return org.renameme.index.fielddata.FieldData.docsWithValue(bytes);
        }
        ...
        public abstract static class WithOrdinals extends Bytes {
            ...
            public static final WithOrdinals EMPTY = new WithOrdinals() {
                ...
                public SortedBinaryDocValues bytesValues(LeafReaderContext context) throws IOException {
                    return org.renameme.index.fielddata.FieldData.emptySortedBinary();
                }
            ...
            public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
                ...
                return org.renameme.index.fielddata.FieldData.docsWithValue(ordinals);
            }
    ...
    public abstract static class Numeric extends ValuesSource {
        ...
        public static final Numeric EMPTY = new Numeric() {
            ...
            public SortedNumericDoubleValues doubleValues(LeafReaderContext context) throws IOException {
                return org.renameme.index.fielddata.FieldData.emptySortedNumericDoubles();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            if (isFloatingPoint()) {
                ...
                return org.renameme.index.fielddata.FieldData.docsWithValue(values);
            } else {
    ...
    public abstract static class GeoPoint extends ValuesSource {
        ...
        public static final GeoPoint EMPTY = new GeoPoint() {
            ...
            public MultiGeoPointValues geoPointValues(LeafReaderContext context) {
                return org.renameme.index.fielddata.FieldData.emptyMultiGeoPoints();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return org.renameme.index.fielddata.FieldData.docsWithValue(geoPoints);
        }
        ...
        public static class Fielddata extends GeoPoint {
            ...
            public org.renameme.index.fielddata.MultiGeoPointValues geoPointValues(LeafReaderContext context) {
