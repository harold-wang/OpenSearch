 ...
 * under the License.
 */
package org.renameme.search.aggregations.bucket.sampler;
...
public class BestDocsDeferringCollector extends DeferringBucketCollector implements Releasable {
    ...
    private void runDeferredAggs() throws IOException {
        ...
        try {
            ...
            try {
                ...
                throw new RenamemeException("IOException collecting best scoring results", e);
            }
        } finally {
    ...
    class PerParentBucketSamples {
        ...
        PerParentBucketSamples(long parentBucket, Scorable scorer, LeafReaderContext readerContext) {
            try {
                ...
                throw new RenamemeException("IO error creating collector", e);
            }
        }
    ...
    @Override
    public void close() throws RenamemeException {
