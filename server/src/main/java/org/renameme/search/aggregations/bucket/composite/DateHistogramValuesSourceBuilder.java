...
import org.renameme.search.aggregations.bucket.histogram.DateIntervalConsumer;
import org.renameme.search.aggregations.bucket.histogram.DateIntervalWrapper;
...
public class DateHistogramValuesSourceBuilder
    ...
    public static void register(ValuesSourceRegistry.Builder builder) {
        builder.register(
            REGISTRY_KEY,
            org.renameme.common.collect.List.of(CoreValuesSourceType.DATE, CoreValuesSourceType.NUMERIC),
