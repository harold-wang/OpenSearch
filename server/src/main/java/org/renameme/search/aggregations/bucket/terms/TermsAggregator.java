...
import org.renameme.search.aggregations.InternalOrder.Aggregation;
...
import org.renameme.search.aggregations.bucket.nested.NestedAggregator;
    ...
    public static class BucketCountThresholds implements Writeable, ToXContentFragment {
        ...
        public void ensureValidity() {
            ...
            if (requiredSize <= 0 || shardSize <= 0) {
                throw new RenamemeException("parameters [required_size] and [shard_size] must be >0 in terms aggregation.");
            }

            if (minDocCount < 0 || shardMinDocCount < 0) {
                throw new RenamemeException("parameter [min_doc_count] and [shardMinDocCount] must be >=0 in terms aggregation.");
            }
        }
