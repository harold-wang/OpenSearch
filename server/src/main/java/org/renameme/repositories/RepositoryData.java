...
public final class RepositoryData {
     ...
     * {@link org.renameme.cluster.metadata.IndexMetadata} blob name in it that can be removed after removing the given snapshot from
     * the repository.
     ...
     *                         {@link org.renameme.cluster.metadata.IndexMetadata} in them
     */
                    ...
                    case SNAPSHOTS:
                        ...
                        while ((currToken = parser.nextToken()) != XContentParser.Token.END_ARRAY) {
                            ...
                            if (snapshotId == null) {
                                ...
                                throw new RenamemeParseException("Detected a corrupted repository, index " + indexId
