 ...
 */
public class RenamemeStatusException extends RenamemeException {
    private final RestStatus status;

    /**
     * Build the exception with a specific status and cause.
     */
    public RenamemeStatusException(String msg, RestStatus status, Throwable cause, Object... args) {
     ...
     */
    public RenamemeStatusException(String msg, RestStatus status, Object... args) {
     ...
     * Read from a stream.
     */
    public RenamemeStatusException(StreamInput in) throws IOException {
        super(in);
