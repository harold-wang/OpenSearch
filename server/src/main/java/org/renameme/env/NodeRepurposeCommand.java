...
import static org.renameme.env.NodeEnvironment.INDICES_FOLDER;

public class NodeRepurposeCommand extends RenamemeNodeCommand {

    static final String ABORTED_BY_USER_MSG = RenamemeNodeCommand.ABORTED_BY_USER_MSG;
    static final String FAILED_TO_OBTAIN_NODE_LOCK_MSG = RenamemeNodeCommand.FAILED_TO_OBTAIN_NODE_LOCK_MSG;
    ...
    private void removePath(Path path) {
        try {
            ...
            throw new RenamemeException("Unable to clean up path: " + path + ": " + e.getMessage());
        }
    }
