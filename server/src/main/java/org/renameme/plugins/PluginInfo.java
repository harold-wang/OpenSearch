...
public class PluginInfo implements Writeable, ToXContentObject {
    ...
    private final Version renamemeVersion;
     ...
     * @param renamemeVersion  the version of Elasticsearch the plugin was built for
     * @param javaVersion           the version of Java the plugin was built with
     * @param classname             the entry point to the plugin
     * @param extendedPlugins       other plugins this plugin extends through SPI
     * @param hasNativeController   whether or not the plugin has a native controller
     */
    public PluginInfo(String name, String description, String version, Version renamemeVersion, String javaVersion,
                      String classname, List<String> extendedPlugins, boolean hasNativeController) {
        this.name = name;
        this.description = description;
        this.version = version;
        this.renamemeVersion = renamemeVersion;
    ...
    public PluginInfo(final StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(LegacyESVersion.V_6_3_0)) {
            renamemeVersion = Version.readVersion(in);
    ...
    public void writeTo(final StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(LegacyESVersion.V_6_3_0)) {
            Version.writeVersion(renamemeVersion, out);
     ...
     */
    public Version getRenamemeVersion() {
        return renamemeVersion;
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        builder.startObject();
        {
            ...
            builder.field("renameme_version", renamemeVersion);
    ...
    public String toString(String prefix) {
        final StringBuilder information = new StringBuilder()
            ...
            .append(prefix).append("Elasticsearch Version: ").append(renamemeVersion).append("\n")
