...
import org.renameme.index.mapper.MapperException;
...
import org.renameme.indices.recovery.RecoveriesCollection.RecoveryRef;
            ...
            final Consumer<Exception> retryOnMappingException = exception -> {
                ...
                observer.waitForNextChange(new ClusterStateObserver.Listener() {
                    ...
                    public void onClusterServiceClose() {
                        listener.onFailure(new RenamemeException(
                    ...
                    public void onTimeout(TimeValue timeout) {
                        ...
                        listener.onFailure(new RenamemeTimeoutException("timed out waiting for mapping updates " +
                            "(timeout [" + timeout + "])"));
                    }
                });
            };
