...
import org.renameme.gateway.AsyncShardFetch;
...
public class TransportNodesListShardStoreMetadata extends TransportNodesAction<TransportNodesListShardStoreMetadata.Request,
    ...
    protected NodeStoreFilesMetadata nodeOperation(NodeRequest request) {
        try {
            ...
            throw new RenamemeException("Failed to list store metadata for shard [" + request.shardId + "]", e);
        }
    }
            ...
            if (request.getCustomDataPath() != null) {
                ...
                if (indexService != null) {
                    ...
                    if (metadata != null) {
                        ...
                        throw new RenamemeException("node doesn't have meta data for index " + shardId.getIndex());
                    }
                }
            }
