...
import org.renameme.index.analysis.HunspellTokenFilterFactory;
import org.renameme.index.analysis.KeywordAnalyzerProvider;
import org.renameme.index.analysis.LowercaseNormalizerProvider;
...
import org.renameme.index.analysis.ShingleTokenFilterFactory;
import org.renameme.index.analysis.SimpleAnalyzerProvider;
import org.renameme.index.analysis.StandardAnalyzerProvider;
import org.renameme.index.analysis.StandardTokenizerFactory;
import org.renameme.index.analysis.StopAnalyzerProvider;
...
import org.renameme.index.analysis.WhitespaceAnalyzerProvider;
...
public final class AnalysisModule {
    ...
    static Map<String, PreConfiguredTokenFilter> setupPreConfiguredTokenFilters(List<AnalysisPlugin> plugins) {
        ...
        preConfiguredTokenFilters.register( "standard",
            PreConfiguredTokenFilter.renamemeVersion("standard", true, (reader, version) -> {
