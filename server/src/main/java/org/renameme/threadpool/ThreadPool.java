...
package org.renameme.threadpool;
...
import org.renameme.common.unit.SizeValue;
...
import org.renameme.common.util.concurrent.XRejectedExecutionHandler;
...
public class ThreadPool implements ReportingService<ThreadPoolInfo>, Scheduler {
     ...
     * @throws org.renameme.common.util.concurrent.EsRejectedExecutionException if the task cannot be scheduled for execution
     */
    @Override
