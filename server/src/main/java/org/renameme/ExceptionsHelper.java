...
public final class ExceptionsHelper {
    ...
    public static RuntimeException convertToRuntime(Exception e) {
        ...
        return new RenamemeException(e);
    }

    public static RenamemeException convertToElastic(Exception e) {
        if (e instanceof RenamemeException) {
            return (RenamemeException) e;
        }
        return new RenamemeException(e);
    }
    ...
    public static RestStatus status(Throwable t) {
        if (t != null) {
            if (t instanceof RenamemeException) {
                return ((RenamemeException) t).status();
    ...
    public static Throwable unwrapCause(Throwable t) {
        int counter = 0;
        Throwable result = t;
        while (result instanceof RenamemeWrapperException) {
    ...
    public static <T extends Throwable> void maybeThrowRuntimeAndSuppress(List<T> exceptions) {
        ...
        if (main != null) {
            throw new RenamemeException(main);
        }
    }
        ...
        GroupBy(ShardOperationFailedException failure) {
            ...
            if (indexName == null) {
                if (cause instanceof RenamemeException) {
                    final Index index = ((RenamemeException) cause).getIndex();
                    if (index != null) {
