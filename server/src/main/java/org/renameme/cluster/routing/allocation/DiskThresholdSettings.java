...
import org.renameme.common.unit.RatioValue;
...
public class DiskThresholdSettings {
    ...
    private static void doValidate(String low, String high, String flood) {
        ...
        } catch (final RenamemeParseException e) {
     ...
     * true, otherwise throwing an {@link RenamemeParseException}.
     *
     ...
     * parameter is true, otherwise throwing an {@link RenamemeParseException}.
     *
