...
package org.renameme.cluster.action.shard;
...
import org.renameme.cluster.MasterNodeChangePredicate;
...
import org.renameme.cluster.routing.allocation.StaleShard;
...
import org.renameme.transport.TransportRequestDeduplicator;
...
public class ShardStateAction {
                        ...
                        if (isMasterChannelException(exp)) {
                            ...
                            listener.onFailure(exp instanceof RemoteTransportException ?
                                (Exception) (exp.getCause() instanceof Exception ? exp.getCause() :
                                    new RenamemeException(exp.getCause())) : exp);
                        }
                    }
                });
        }
    ...
    public static class NoLongerPrimaryShardException extends RenamemeException {
