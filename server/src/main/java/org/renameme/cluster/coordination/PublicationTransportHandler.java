...
import org.renameme.discovery.zen.PublishClusterStateAction;
        ...
        void buildDiffAndSerializeStates() {
            ...
            for (DiscoveryNode node : discoveryNodes) {
                try {
                    ...
                    throw new RenamemeException("failed to serialize cluster state for publishing to node {}", e, node);
                }
            }
        }
