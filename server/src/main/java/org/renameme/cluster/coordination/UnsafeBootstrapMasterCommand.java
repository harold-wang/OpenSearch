...
public class UnsafeBootstrapMasterCommand extends RenamemeNodeCommand {
    ...
    protected boolean validateBeforeLock(Terminal terminal, Environment env) {
        ...
        if (master == false) {
            throw new RenamemeException(NOT_MASTER_NODE_MSG);
        }
    ...
    protected void processNodePaths(Terminal terminal, Path[] dataPaths, int nodeLockId, OptionSet options, Environment env)
        ...
        if (coordinationMetadata == null ||
            ...
            throw new RenamemeException(EMPTY_LAST_COMMITTED_VOTING_CONFIG_MSG);
        }
