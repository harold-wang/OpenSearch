...
import static org.renameme.cluster.metadata.DataStream.getDefaultBackingIndexName;
import static org.renameme.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
import static org.renameme.common.collect.List.copyOf;
...
public interface IndexAbstraction {
    ...
    class DataStream implements IndexAbstraction {
        ...
        private final org.renameme.cluster.metadata.DataStream dataStream;
        private final List<IndexMetadata> dataStreamIndices;
        private final IndexMetadata writeIndex;

        public DataStream(org.renameme.cluster.metadata.DataStream dataStream, List<IndexMetadata> dataStreamIndices) {
            this.dataStream = dataStream;
        ...
        public org.renameme.cluster.metadata.DataStream getDataStream() {
            return dataStream;
        }
    }
}
