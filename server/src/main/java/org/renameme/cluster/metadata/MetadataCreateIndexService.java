...
import org.renameme.cluster.ack.CreateIndexClusterStateUpdateResponse;
...
import org.renameme.index.shard.IndexSettingProvider;
import org.renameme.indices.IndexCreationException;
...
import static org.renameme.cluster.metadata.IndexMetadata.INDEX_NUMBER_OF_REPLICAS_SETTING;
...
import static org.renameme.cluster.metadata.MetadataCreateDataStreamService.validateTimestampFieldMapping;
...
public class MetadataCreateIndexService {
    ...
    public static void validateIndexOrAliasName(String index, BiFunction<String, String, ? extends RuntimeException> exceptionCtor) {
        ...
        try {
            ...
            throw new RenamemeException("Unable to determine length of index name", e);
        }
    ...
    private ClusterState applyCreateIndexRequestWithExistingMetadata(final ClusterState currentState,
        ...
        return applyCreateIndexWithTemporaryService(currentState, request, silent, sourceMetadata, tmpImd, Collections.emptyList(),
            ...
            org.renameme.common.collect.List.of(), metadataTransformer);
    }
