...
import org.renameme.cluster.ack.ClusterStateUpdateRequest;
...
import org.renameme.common.xcontent.ObjectPath;
...
public class MetadataCreateDataStreamService {
    ...
    static ClusterState createDataStream(MetadataCreateIndexService metadataCreateIndexService,
        ...
        try {
            ...
            // Rethrow as RenamemeStatusException, so that bulk transport action doesn't ignore it during
            // auto index/data stream creation.
            // (otherwise bulk execution fails later, because data stream will also not have been created)
            throw new RenamemeStatusException("data stream could not be created because backing index [{}] already exists",
