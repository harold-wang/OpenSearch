...
import org.renameme.common.xcontent.InstantiatingObjectParser;
import org.renameme.common.xcontent.ObjectParserHelper;
...
import static org.renameme.common.xcontent.XContentHelper.convertToMap;
...
public final class TaskResult implements Writeable, ToXContentObject {
    ...
    private static BytesReference toXContent(Exception error) throws IOException {
        try (XContentBuilder builder = XContentFactory.contentBuilder(Requests.INDEX_CONTENT_TYPE)) {
            builder.startObject();
            RenamemeException.generateThrowableXContent(builder, ToXContent.EMPTY_PARAMS, error);
            builder.endObject();
