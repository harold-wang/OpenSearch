...
package org.renameme.bootstrap;
...
import org.renameme.cli.KeyStoreAwareCommand;
import org.renameme.cli.Terminal;
import org.renameme.cli.UserException;
import org.renameme.common.PidFile;
import org.renameme.common.SuppressForbidden;
import org.renameme.common.inject.CreationException;
import org.renameme.common.logging.DeprecationLogger;
import org.renameme.common.logging.LogConfigurator;
import org.renameme.common.logging.Loggers;
import org.renameme.common.network.IfConfig;
import org.renameme.common.settings.KeyStoreWrapper;
import org.renameme.common.settings.SecureSettings;
import org.renameme.common.settings.SecureString;
...
import org.renameme.monitor.os.OsProbe;
import org.renameme.monitor.process.ProcessProbe;
import org.renameme.node.InternalSettingsPreparer;
...
final class Bootstrap {
                ...
                public boolean handle(int code) {
                    if (CTRL_CLOSE_EVENT == code) {
                        ...
                        try {
                            ...
                            throw new RenamemeException("failed to stop node", e);
                        }
                        return true;
                    }
                    return false;
            ...
            Runtime.getRuntime().addShutdownHook(new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        throw new RenamemeException("failed to stop node", ex);
                    } catch (InterruptedException e) {
    ...
    static void init(
        ...
        try {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new RenamemeUncaughtExceptionHandler());
