 ...
 */
class Renameme extends EnvironmentAwareCommand {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Renameme renameme = new Renameme();
        int status = main(args, renameme, Terminal.DEFAULT);
    ...
    static int main(final String[] args, final Renameme renameme, final Terminal terminal) throws Exception {
        return renameme.main(args, terminal);
    }
