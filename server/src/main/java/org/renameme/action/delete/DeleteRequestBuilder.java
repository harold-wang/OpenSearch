...
package org.renameme.action.delete;
...
public class DeleteRequestBuilder extends ReplicationRequestBuilder<DeleteRequest, DeleteResponse, DeleteRequestBuilder>
    ...
    public DeleteRequestBuilder(RenamemeClient client, DeleteAction action) {
        super(client, action, new DeleteRequest());
    }

    public DeleteRequestBuilder(RenamemeClient client, DeleteAction action, @Nullable String index) {
