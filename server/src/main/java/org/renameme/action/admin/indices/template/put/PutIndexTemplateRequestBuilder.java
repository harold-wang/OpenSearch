...
public class PutIndexTemplateRequestBuilder
    ...
    public PutIndexTemplateRequestBuilder(RenamemeClient client, PutIndexTemplateAction action) {
        super(client, action, new PutIndexTemplateRequest());
    }

    public PutIndexTemplateRequestBuilder(RenamemeClient client, PutIndexTemplateAction action, String name) {
