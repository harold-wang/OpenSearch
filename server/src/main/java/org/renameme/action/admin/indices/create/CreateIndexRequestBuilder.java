...
public class CreateIndexRequestBuilder
    ...
    public CreateIndexRequestBuilder(RenamemeClient client, CreateIndexAction action) {
        super(client, action, new CreateIndexRequest());
    }

    public CreateIndexRequestBuilder(RenamemeClient client, CreateIndexAction action, String index) {
