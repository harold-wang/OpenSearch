...
import org.renameme.action.support.broadcast.BroadcastOperationRequestBuilder;
...
public class ValidateQueryRequestBuilder
    ...
    public ValidateQueryRequestBuilder(RenamemeClient client, ValidateQueryAction action) {
