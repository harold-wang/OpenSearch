...
public class RestoreSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<RestoreSnapshotRequest,
     ...
     */
    public RestoreSnapshotRequestBuilder(RenamemeClient client, RestoreSnapshotAction action) {
     ...
     */
    public RestoreSnapshotRequestBuilder(RenamemeClient client, RestoreSnapshotAction action, String repository, String name) {
