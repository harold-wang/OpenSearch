...
public class PutRepositoryRequestBuilder
     ...
     */
    public PutRepositoryRequestBuilder(RenamemeClient client, PutRepositoryAction action) {
     ...
     */
    public PutRepositoryRequestBuilder(RenamemeClient client, PutRepositoryAction action, String name) {
