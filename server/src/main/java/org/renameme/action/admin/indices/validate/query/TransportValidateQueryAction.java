...
package org.renameme.action.admin.indices.validate.query;
...
import org.renameme.action.support.broadcast.TransportBroadcastAction;
...
public class TransportValidateQueryAction extends TransportBroadcastAction<
    ...
    protected void doExecute(Task task, ValidateQueryRequest request, ActionListener<ValidateQueryResponse> listener) {
        ...
        ActionListener<org.renameme.index.query.QueryBuilder> rewriteListener = ActionListener.wrap(rewrittenQuery -> {
