...
import static org.renameme.common.xcontent.ObjectParser.fromList;
    ...
    public static class AliasActions implements AliasesRequest, Writeable, ToXContentObject {
        ...
        public AliasActions filter(Map<String, Object> filter) {
            ...
            try {
                ...
                throw new RenamemeGenerationException("Failed to generate [" + filter + "]", e);
            }
        }
        ...
        public AliasActions filter(QueryBuilder filter) {
            ...
            try {
                ...
                throw new RenamemeGenerationException("Failed to build json for alias request", e);
            }
        }
