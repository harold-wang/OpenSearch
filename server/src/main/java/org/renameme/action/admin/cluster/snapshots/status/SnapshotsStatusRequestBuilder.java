...
public class SnapshotsStatusRequestBuilder extends MasterNodeOperationRequestBuilder<SnapshotsStatusRequest,
     ...
     */
    public SnapshotsStatusRequestBuilder(RenamemeClient client, SnapshotsStatusAction action) {
     ...
     */
    public SnapshotsStatusRequestBuilder(RenamemeClient client, SnapshotsStatusAction action, String repository) {
