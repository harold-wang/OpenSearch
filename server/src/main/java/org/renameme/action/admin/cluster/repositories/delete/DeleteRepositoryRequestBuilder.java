...
package org.renameme.action.admin.cluster.repositories.delete;
...
public class DeleteRepositoryRequestBuilder
     ...
     */
    public DeleteRepositoryRequestBuilder(RenamemeClient client, DeleteRepositoryAction action) {
     ...
     */
    public DeleteRepositoryRequestBuilder(RenamemeClient client, DeleteRepositoryAction action, String name) {
