...
package org.renameme.action.admin.indices.exists.indices;
...
public class IndicesExistsRequestBuilder
    ...
    public IndicesExistsRequestBuilder(RenamemeClient client, IndicesExistsAction action, String... indices) {
