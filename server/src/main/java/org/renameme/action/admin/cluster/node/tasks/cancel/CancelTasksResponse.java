...
package org.renameme.action.admin.cluster.node.tasks.cancel;
...
public class CancelTasksResponse extends ListTasksResponse {
    ...
    public CancelTasksResponse(List<TaskInfo> tasks, List<TaskOperationFailure> taskFailures, List<? extends RenamemeException>
        nodeFailures) {
