 ...
 * under the License.
 */
package org.renameme.action.admin.cluster.repositories.cleanup;
...
public class CleanupRepositoryRequestBuilder extends MasterNodeOperationRequestBuilder<CleanupRepositoryRequest,
    ...
    public CleanupRepositoryRequestBuilder(RenamemeClient client, ActionType<CleanupRepositoryResponse> action,
                                           String repository) {
