...
public class VerifyRepositoryRequestBuilder
     ...
     */
    public VerifyRepositoryRequestBuilder(RenamemeClient client, VerifyRepositoryAction action) {
     ...
     */
    public VerifyRepositoryRequestBuilder(RenamemeClient client, VerifyRepositoryAction action, String name) {
