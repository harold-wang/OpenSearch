...
package org.renameme.action.admin.indices.readonly;
...
public class AddIndexBlockRequestBuilder
    ...
    public AddIndexBlockRequestBuilder(RenamemeClient client, AddIndexBlockAction action, APIBlock block, String... indices) {
