...
package org.renameme.action.admin.cluster.snapshots.get;

import org.renameme.action.support.master.MasterNodeOperationRequestBuilder;
...
public class GetSnapshotsRequestBuilder extends MasterNodeOperationRequestBuilder<GetSnapshotsRequest,
     ...
     */
    public GetSnapshotsRequestBuilder(RenamemeClient client, GetSnapshotsAction action) {
     ...
     */
    public GetSnapshotsRequestBuilder(RenamemeClient client, GetSnapshotsAction action, String repository) {
