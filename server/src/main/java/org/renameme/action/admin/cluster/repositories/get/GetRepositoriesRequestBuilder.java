...
public class GetRepositoriesRequestBuilder
     ...
     */
    public GetRepositoriesRequestBuilder(RenamemeClient client, GetRepositoriesAction action) {
     ...
     * Creates new get repository request builder
     */
    public GetRepositoriesRequestBuilder(RenamemeClient client, GetRepositoriesAction action, String... repositories) {
