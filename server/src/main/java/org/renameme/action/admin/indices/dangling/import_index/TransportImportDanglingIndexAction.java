...
package org.renameme.action.admin.indices.dangling.import_index;
...
import org.renameme.action.admin.indices.dangling.find.FindDanglingIndexRequest;
import org.renameme.action.admin.indices.dangling.find.FindDanglingIndexResponse;
import org.renameme.action.admin.indices.dangling.find.NodeFindDanglingIndexResponse;
            ...
            new ActionListener<FindDanglingIndexResponse>() {
                ...
                public void onResponse(FindDanglingIndexResponse response) {
                    if (response.hasFailures()) {
                        ...
                        RenamemeException e = new RenamemeException("Failed to query nodes [" + nodeIds + "]");
