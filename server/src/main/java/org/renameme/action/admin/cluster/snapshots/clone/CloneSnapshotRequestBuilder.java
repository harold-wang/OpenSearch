...
package org.renameme.action.admin.cluster.snapshots.clone;
...
public class CloneSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<CloneSnapshotRequest, AcknowledgedResponse,
    ...
    protected CloneSnapshotRequestBuilder(RenamemeClient client, ActionType<AcknowledgedResponse> action,
                                          CloneSnapshotRequest request) {
        super(client, action, request);
    }

    public CloneSnapshotRequestBuilder(RenamemeClient client, ActionType<AcknowledgedResponse> action,
