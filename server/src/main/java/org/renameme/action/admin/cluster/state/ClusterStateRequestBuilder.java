...
import org.renameme.action.support.master.MasterNodeReadOperationRequestBuilder;
...
public class ClusterStateRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterStateRequest,
    ...
    public ClusterStateRequestBuilder(RenamemeClient client, ClusterStateAction action) {
    ...
    /**
     * Should the cluster state result include the {@link org.renameme.cluster.metadata.Metadata}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.renameme.cluster.node.DiscoveryNodes}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.renameme.cluster.ClusterState.Custom}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.renameme.cluster.routing.RoutingTable}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * When {@link #setMetadata(boolean)} is set, which indices to return the {@link org.renameme.cluster.metadata.IndexMetadata}
