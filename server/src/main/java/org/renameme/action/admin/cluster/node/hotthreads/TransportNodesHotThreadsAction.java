...
package org.renameme.action.admin.cluster.node.hotthreads;
...
import org.renameme.monitor.jvm.HotThreads;
...
public class TransportNodesHotThreadsAction extends TransportNodesAction<NodesHotThreadsRequest,
    ...
    protected NodeHotThreads nodeOperation(NodeRequest request) {
        ...
        try {
            ...
            throw new RenamemeException("failed to detect hot threads", e);
        }
    }
