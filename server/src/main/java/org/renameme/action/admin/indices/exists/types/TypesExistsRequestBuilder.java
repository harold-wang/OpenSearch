 ...
 * under the License.
 */
package org.renameme.action.admin.indices.exists.types;
...
public class TypesExistsRequestBuilder
     ...
     */
    public TypesExistsRequestBuilder(RenamemeClient client, TypesExistsAction action, String... indices) {
        super(client, action, new TypesExistsRequest(indices, Strings.EMPTY_ARRAY));
    }

    TypesExistsRequestBuilder(RenamemeClient client, TypesExistsAction action) {
