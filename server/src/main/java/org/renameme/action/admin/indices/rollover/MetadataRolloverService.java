...
import static org.renameme.cluster.metadata.IndexAbstraction.Type.ALIAS;
import static org.renameme.cluster.metadata.IndexAbstraction.Type.DATA_STREAM;
import static org.renameme.cluster.metadata.MetadataCreateDataStreamService.lookupTemplateForDataStream;
import static org.renameme.cluster.metadata.MetadataIndexTemplateService.findV1Templates;
import static org.renameme.cluster.metadata.MetadataIndexTemplateService.findV2Template;
...
public class MetadataRolloverService {
    ...
    private static final List<IndexAbstraction.Type> VALID_ROLLOVER_TARGETS = org.renameme.common.collect.List.of(ALIAS, DATA_STREAM);
