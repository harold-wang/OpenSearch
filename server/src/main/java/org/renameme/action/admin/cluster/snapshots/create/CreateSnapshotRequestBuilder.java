...
public class CreateSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<CreateSnapshotRequest,
     ...
     */
    public CreateSnapshotRequestBuilder(RenamemeClient client, CreateSnapshotAction action) {
     ...
     */
    public CreateSnapshotRequestBuilder(RenamemeClient client, CreateSnapshotAction action, String repository, String snapshot) {
