 ...
 * under the License.
 */
package org.renameme.action.admin.indices.template.delete;
...
public class DeleteIndexTemplateRequestBuilder
    ...
    public DeleteIndexTemplateRequestBuilder(RenamemeClient client, DeleteIndexTemplateAction action) {
        super(client, action, new DeleteIndexTemplateRequest());
    }

    public DeleteIndexTemplateRequestBuilder(RenamemeClient client, DeleteIndexTemplateAction action, String name) {
