...
import org.renameme.action.support.single.shard.SingleShardOperationRequestBuilder;
...
public class AnalyzeRequestBuilder
    ...
    public AnalyzeRequestBuilder(RenamemeClient client, AnalyzeAction action) {
        super(client, action, new AnalyzeAction.Request());
    }

    public AnalyzeRequestBuilder(RenamemeClient client, AnalyzeAction action, String index, String... text) {
