...
package org.renameme.action.admin.cluster.snapshots.delete;
...
public class DeleteSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<DeleteSnapshotRequest,
     ...
     */
    public DeleteSnapshotRequestBuilder(RenamemeClient client, DeleteSnapshotAction action) {
     ...
     */
    public DeleteSnapshotRequestBuilder(RenamemeClient client, DeleteSnapshotAction action, String repository, String... snapshots) {
