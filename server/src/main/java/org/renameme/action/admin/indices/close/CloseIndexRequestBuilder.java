...
public class CloseIndexRequestBuilder
    ...
    public CloseIndexRequestBuilder(RenamemeClient client, CloseIndexAction action) {
        super(client, action, new CloseIndexRequest());
    }

    public CloseIndexRequestBuilder(RenamemeClient client, CloseIndexAction action, String... indices) {
