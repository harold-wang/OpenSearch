...
package org.renameme.action.index;

import org.renameme.action.DocWriteRequest;
import org.renameme.action.support.WriteRequestBuilder;
import org.renameme.action.support.replication.ReplicationRequestBuilder;
...
public class IndexRequestBuilder extends ReplicationRequestBuilder<IndexRequest, IndexResponse, IndexRequestBuilder>
    ...
    public IndexRequestBuilder(RenamemeClient client, IndexAction action) {
        super(client, action, new IndexRequest());
    }

    public IndexRequestBuilder(RenamemeClient client, IndexAction action, @Nullable String index) {
     ...
     * <p>
     * Note, its preferable to either set it using {@link #setSource(org.renameme.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to {@code true} to force this index to use {@link org.renameme.action.index.IndexRequest.OpType#CREATE}.
     */
