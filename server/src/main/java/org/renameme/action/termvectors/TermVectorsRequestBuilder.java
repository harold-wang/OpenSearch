...
public class TermVectorsRequestBuilder extends ActionRequestBuilder<TermVectorsRequest, TermVectorsResponse> {
    ...
    public TermVectorsRequestBuilder(RenamemeClient client, TermVectorsAction action) {
     ...
     */
    public TermVectorsRequestBuilder(RenamemeClient client, TermVectorsAction action, String index, String type, String id) {
