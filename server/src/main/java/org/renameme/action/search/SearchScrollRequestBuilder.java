...
public class SearchScrollRequestBuilder extends ActionRequestBuilder<SearchScrollRequest, SearchResponse> {
    ...
    public SearchScrollRequestBuilder(RenamemeClient client, SearchScrollAction action) {
        super(client, action, new SearchScrollRequest());
    }

    public SearchScrollRequestBuilder(RenamemeClient client, SearchScrollAction action, String scrollId) {
