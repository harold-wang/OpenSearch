...
public class PutPipelineRequestBuilder extends ActionRequestBuilder<PutPipelineRequest, AcknowledgedResponse> {
    ...
    public PutPipelineRequestBuilder(RenamemeClient client, PutPipelineAction action) {
        super(client, action, new PutPipelineRequest());
    }

    public PutPipelineRequestBuilder(RenamemeClient client, PutPipelineAction action, String id, BytesReference source,
