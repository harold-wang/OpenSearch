...
import org.renameme.ingest.ConfigurationUtils;
...
public class SimulateProcessorResult implements Writeable, ToXContentObject {
    ...
    private static final ConstructingObjectParser<RenamemeException, Void> IGNORED_ERROR_PARSER =
        new ConstructingObjectParser<>(
            "ignored_error_parser",
            true,
            a -> (RenamemeException)a[0]
        );
    static {
        IGNORED_ERROR_PARSER.declareObject(
            constructorArg(),
            (p, c) -> RenamemeException.fromXContent(p),
    ...
    public static final ConstructingObjectParser<SimulateProcessorResult, Void> PARSER =
        new ConstructingObjectParser<>(
            ...
            a -> {
                ...
                if (a[5] != null) {
                    failure = (RenamemeException)a[5];
                } else if (a[6] != null) {
                    failure = (RenamemeException)a[6];
                }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (failure != null && ingestDocument != null) {
            ...
            RenamemeException.generateFailureXContent(builder, params, failure, true);
            builder.endObject();
