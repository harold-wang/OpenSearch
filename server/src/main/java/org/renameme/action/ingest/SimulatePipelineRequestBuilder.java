...
public class SimulatePipelineRequestBuilder extends ActionRequestBuilder<SimulatePipelineRequest, SimulatePipelineResponse> {
     ...
     */
    public SimulatePipelineRequestBuilder(RenamemeClient client, SimulatePipelineAction action) {
     ...
     * Create a new builder for {@link SimulatePipelineRequest}s
     */
    public SimulatePipelineRequestBuilder(RenamemeClient client, SimulatePipelineAction action, BytesReference source,
