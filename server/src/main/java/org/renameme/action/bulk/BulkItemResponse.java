...
import org.renameme.action.DocWriteRequest.OpType;
...
import org.renameme.common.xcontent.StatusToXContentObject;
...
import static org.renameme.common.xcontent.XContentParserUtils.throwUnknownField;
...
public class BulkItemResponse implements Writeable, StatusToXContentObject {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (failure == null) {
            ...
            RenamemeException.generateThrowableXContent(builder, params, failure.getCause());
            builder.endObject();
        }
        builder.endObject();
        builder.endObject();
    ...
    public static BulkItemResponse fromXContent(XContentParser parser, int id) throws IOException {
        ...
        RenamemeException exception = null;
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            if (ERROR.equals(currentFieldName)) {
                if (token == XContentParser.Token.START_OBJECT) {
                    exception = RenamemeException.fromXContent(parser);
                }
    ...
    public static class Failure implements Writeable, ToXContentFragment {
        ...
        static {
            ...
            PARSER.declareObject(constructorArg(), (p, c) -> RenamemeException.fromXContent(p), new ParseField(CAUSE_FIELD));
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            ...
            RenamemeException.generateThrowableXContent(builder, params, cause);
            builder.endObject();
