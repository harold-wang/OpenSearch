...
package org.renameme.index.cache.bitset;
...
import org.renameme.common.cache.Cache;
import org.renameme.common.cache.CacheBuilder;
import org.renameme.common.cache.RemovalListener;
...
import org.renameme.index.IndexWarmer;
import org.renameme.index.IndexWarmer.TerminationHandle;
 ...
 * {@link org.renameme.index.cache.query.QueryCache} should be used instead.
 */
public final class BitsetFilterCache extends AbstractIndexComponent
    ...
    final class BitSetProducerWarmer implements IndexWarmer.Listener {
        ...
        @Override
        public IndexWarmer.TerminationHandle warmReader(final IndexShard indexShard, final RenamemeDirectoryReader reader) {
