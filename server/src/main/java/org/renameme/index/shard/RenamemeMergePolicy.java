 ...
 */
public final class RenamemeMergePolicy extends FilterMergePolicy {

    private static final Logger logger = LogManager.getLogger(RenamemeMergePolicy.class);
    ...
    public RenamemeMergePolicy(MergePolicy delegate) {
        super(delegate);
    }
