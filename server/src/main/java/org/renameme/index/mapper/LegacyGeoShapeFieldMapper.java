...
import org.renameme.common.geo.GeometryParser;
...
import org.renameme.index.query.LegacyGeoShapeQueryProcessor;
 ...
 * {@link org.renameme.index.query.GeoShapeQueryBuilder}, consequently
    ...
    public static class DeprecatedParameters {
        ...
        public void setPointsOnly(boolean pointsOnly) {
            if (this.strategy == SpatialStrategy.TERM && pointsOnly == false) {
                throw new RenamemeParseException("points_only cannot be set to false for term strategy");
            }
        ...
        private static void checkPrefixTreeSupport(String fieldName) {
            if (ShapesAvailability.JTS_AVAILABLE == false || ShapesAvailability.SPATIAL4J_AVAILABLE == false) {
                throw new RenamemeParseException("Field parameter [{}] is not supported for [{}] field type",
