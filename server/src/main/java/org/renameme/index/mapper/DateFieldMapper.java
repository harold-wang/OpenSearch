...
import org.renameme.common.joda.Joda;
...
import org.renameme.common.util.LocaleUtils;
import org.renameme.index.fielddata.IndexFieldData;
import org.renameme.index.fielddata.IndexNumericFieldData.NumericType;
import org.renameme.index.fielddata.plain.SortedNumericIndexFieldData;
import org.renameme.index.query.DateRangeIncludingNowQuery;
...
import static org.renameme.common.time.DateUtils.toLong;
...
public final class DateFieldMapper extends ParametrizedFieldMapper {
    ...
    protected void parseCreateField(ParseContext context) throws IOException {
        ...
        if (dateAsString == null) {
            ...
            } catch (IllegalArgumentException | RenamemeParseException | DateTimeException | ArithmeticException e) {
                if (ignoreMalformed) {
