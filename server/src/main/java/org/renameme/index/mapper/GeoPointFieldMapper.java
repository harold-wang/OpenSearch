...
import org.renameme.index.fielddata.plain.AbstractLatLonPointIndexFieldData;
import org.renameme.index.mapper.GeoPointFieldMapper.ParsedGeoPoint;
import org.renameme.index.query.QueryShardContext;
import org.renameme.index.query.VectorGeoPointShapeQueryProcessor;
    ...
    protected static class ParsedGeoPoint extends GeoPoint implements AbstractPointGeometryFieldMapper.ParsedPoint {
        ...
        public void normalize(String name) {
            if (isNormalizable(lat()) && isNormalizable(lon())) {
                ...
                throw new RenamemeParseException("cannot normalize the point - not a number");
            }
        }
