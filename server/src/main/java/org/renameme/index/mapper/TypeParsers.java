...
import static org.renameme.common.xcontent.support.XContentMapValues.isArray;
import static org.renameme.common.xcontent.support.XContentMapValues.nodeFloatValue;
import static org.renameme.common.xcontent.support.XContentMapValues.nodeStringValue;
...
public class TypeParsers {
    ...
    private static IndexOptions nodeIndexOptionValue(final Object propNode) {
        ...
        if (INDEX_OPTIONS_OFFSETS.equalsIgnoreCase(value)) {
            ...
            throw new RenamemeParseException("failed to parse index option [{}]", value);
        }
    }
