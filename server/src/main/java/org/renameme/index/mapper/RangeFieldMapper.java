...
import org.renameme.index.fielddata.plain.BinaryIndexFieldData;
...
import static org.renameme.index.query.RangeQueryBuilder.GTE_FIELD;
import static org.renameme.index.query.RangeQueryBuilder.GT_FIELD;
import static org.renameme.index.query.RangeQueryBuilder.LTE_FIELD;
import static org.renameme.index.query.RangeQueryBuilder.LT_FIELD;
    ...
    static class BinaryRangesDocValuesField extends CustomDocValuesField {
        ...
        public BytesRef binaryValue() {
            try {
                ...
                throw new RenamemeException("failed to encode ranges", e);
            }
        }
    }
}
