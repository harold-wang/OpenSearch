...
import org.renameme.common.geo.GeometryFormat;
...
import static org.renameme.index.mapper.TypeParsers.parseField;
            ...
            if (parser.currentToken() == XContentParser.Token.START_ARRAY) {
                ...
                if (token == XContentParser.Token.VALUE_NUMBER) {
                    ...
                    if (token == XContentParser.Token.VALUE_NUMBER) {
                        ...
                        throw new RenamemeParseException("field type does not accept > 3 dimensions");
                    }
