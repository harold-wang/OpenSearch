...
public class UpdateByQueryRequestBuilder extends
    ...
    public UpdateByQueryRequestBuilder(RenamemeClient client, ActionType<BulkByScrollResponse> action) {
        this(client, action, new SearchRequestBuilder(client, SearchAction.INSTANCE));
    }

    private UpdateByQueryRequestBuilder(RenamemeClient client,
