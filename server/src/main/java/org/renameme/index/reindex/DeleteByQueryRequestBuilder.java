...
public class DeleteByQueryRequestBuilder extends
    ...
    public DeleteByQueryRequestBuilder(RenamemeClient client, ActionType<BulkByScrollResponse> action) {
        this(client, action, new SearchRequestBuilder(client, SearchAction.INSTANCE));
    }

    private DeleteByQueryRequestBuilder(RenamemeClient client,
