...
public abstract class Engine implements Closeable {
    ...
    public SearcherSupplier acquireSearcherSupplier(Function<Searcher, Searcher> wrapper, SearcherScope scope) throws EngineException {
        ...
        try {
            ...
            RenamemeDirectoryReader acquire = referenceManager.acquire();
    ...
    protected abstract ReferenceManager<RenamemeDirectoryReader> getReferenceManager(SearcherScope scope);
    ...
    public interface Warmer {
         ...
         */
        void warm(RenamemeDirectoryReader reader);
    }
