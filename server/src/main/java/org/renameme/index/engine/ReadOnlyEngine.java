...
public class ReadOnlyEngine extends Engine {
    ...
    private final RenamemeReaderManager readerManager;
    ...
    public ReadOnlyEngine(EngineConfig config, SeqNoStats seqNoStats, TranslogStats translogStats, boolean obtainLock,
        ...
        try {
            ...
            store.incRef();
            RenamemeDirectoryReader reader = null;
            ...
            try {
                ...
                readerManager = new RenamemeReaderManager(reader, refreshListener);
    ...
    protected final RenamemeDirectoryReader wrapReader(DirectoryReader reader,
        ...
        return RenamemeDirectoryReader.wrap(reader, engineConfig.getShardId());
    }
    ...
    @Override
    protected ReferenceManager<RenamemeDirectoryReader> getReferenceManager(SearcherScope scope) {
    ...
    protected void processReader(RenamemeDirectoryReader reader) {
