...
import org.renameme.index.search.MultiMatchQuery;
import org.renameme.index.search.QueryParserHelper;
...
public class MultiMatchQueryBuilder extends AbstractQueryBuilder<MultiMatchQueryBuilder> {
    ...
    public enum Type implements Writeable {
        ...
        public static Type parse(String value, DeprecationHandler deprecationHandler) {
            ...
            if (type == null) {
                throw new RenamemeParseException("failed to parse [{}] query type [{}]. unknown type.", NAME, value);
            }
            return type;
        }
