...
public final class IndexWarmer {
    ...
    void warm(RenamemeDirectoryReader reader, IndexShard shard, IndexSettings settings) {
    ...
    public interface Listener {
        ...
        TerminationHandle warmReader(IndexShard indexShard, RenamemeDirectoryReader reader);
    }
    ...
    private static class FieldDataWarmer implements IndexWarmer.Listener {
        ...
        @Override
        public TerminationHandle warmReader(final IndexShard indexShard, final RenamemeDirectoryReader reader) {
