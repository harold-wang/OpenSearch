...
public class SizeValue implements Writeable, Comparable<SizeValue> {
    ...
    public static SizeValue parseSizeValue(String sValue) throws RenamemeParseException {
        return parseSizeValue(sValue, null);
    }

    public static SizeValue parseSizeValue(String sValue, SizeValue defaultValue) throws RenamemeParseException {
        if (sValue == null) {
            return defaultValue;
        }
        long singles;
        try {
            ...
            throw new RenamemeParseException("failed to parse [{}]", e, sValue);
        }
