...
public class ByteSizeValue implements Writeable, Comparable<ByteSizeValue>, ToXContentFragment {
     ...
     * {@link ByteSizeValue} object constructed in, for example, settings in {@link org.renameme.common.network.NetworkService}.
     */
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, String settingName) throws RenamemeParseException {
        ...
        try {
            try {
                ...
                try {
                    ...
                    throw new RenamemeParseException("failed to parse [{}]", e, initialInput);
                }
            }
        } catch (IllegalArgumentException e) {
            throw new RenamemeParseException("failed to parse setting [{}] with value [{}] as a size in bytes", e, settingName,
                    initialInput);
        }
    }
