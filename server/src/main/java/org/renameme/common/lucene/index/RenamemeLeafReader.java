 ...
 */
public final class RenamemeLeafReader extends SequentialStoredFieldsLeafReader {
     ...
     */
    public RenamemeLeafReader(LeafReader in, ShardId shardId) {
        super(in);
    ...
    public static RenamemeLeafReader getrenamemeLeafReader(LeafReader reader) {
        if (reader instanceof FilterLeafReader) {
            if (reader instanceof RenamemeLeafReader) {
                return (RenamemeLeafReader) reader;
            } else {
                ...
                return getrenamemeLeafReader(((FilterLeafReader) reader).getDelegate());
            }
        }
        return null;
    }
