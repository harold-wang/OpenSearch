...
import org.renameme.common.LocalTimeOffset.Gap;
import org.renameme.common.LocalTimeOffset.Overlap;
...
public abstract class Rounding implements Writeable {
    ...
    public enum DateTimeUnit {
        ...
        public static DateTimeUnit resolve(byte id) {
            switch (id) {
                ...
                default: throw new RenamemeException("Unknown date time unit id [" + id + "]");
            }
        }
    }
    ...
    public static Rounding read(StreamInput in) throws IOException {
        ...
        switch (id) {
            ...
            default:
                throw new RenamemeException("unknown rounding id [" + id + "]");
        }
    }
