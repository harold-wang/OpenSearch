 ...
 */
public final class NotSerializableExceptionWrapper extends RenamemeException {

    private final String name;
    private final RestStatus status;

    public NotSerializableExceptionWrapper(Throwable other) {
        super(RenamemeException.getExceptionName(other) + ": " + other.getMessage(), other.getCause());
        this.name = RenamemeException.getExceptionName(other);
        ...
        if (other instanceof RenamemeException) {
            RenamemeException ex = (RenamemeException) other;
