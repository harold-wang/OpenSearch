...
package org.renameme.common.logging;
 ...
 * for deprecation logger. For instance <code>DeprecationLogger.getLogger("org.renameme.test.SomeClass")</code> will
 * result in a deprecation logger with name <code>org.renameme.deprecation.test.SomeClass</code>. This allows to use a
...
public class DeprecationLogger {
     ...
     * prefixes the logger name with "deprecation", if it starts with "org.renameme.",
     * it replaces "org.renameme" with "org.renameme.deprecation" to maintain
     * the "org.renameme" namespace.
     */
    ...
    private static Logger getDeprecatedLoggerForName(String name) {
        if (name.startsWith("org.renameme")) {
            name = name.replace("org.renameme.", "org.renameme.deprecation.");
        } else {
