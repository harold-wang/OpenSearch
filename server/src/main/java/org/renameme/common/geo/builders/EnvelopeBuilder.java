...
public class EnvelopeBuilder extends ShapeBuilder<Rectangle, org.renameme.geometry.Rectangle, EnvelopeBuilder> {
    ...
    @Override
    public org.renameme.geometry.Rectangle buildGeometry() {
        return new org.renameme.geometry.Rectangle(topLeft.x, bottomRight.x, topLeft.y, bottomRight.y);
    }
