...
import org.renameme.common.unit.DistanceUnit.Distance;
import org.renameme.common.xcontent.XContentBuilder;

import java.io.IOException;
import java.util.Objects;

public class CircleBuilder extends ShapeBuilder<Circle, org.renameme.geometry.Circle, CircleBuilder> {
    ...
    @Override
    public org.renameme.geometry.Circle buildGeometry() {
       return new org.renameme.geometry.Circle(center.x, center.y, unit.toMeters(radius));
    }
