...
public class PointBuilder extends ShapeBuilder<Point, org.renameme.geometry.Point, PointBuilder> {
    ...
    @Override
    public org.renameme.geometry.Point buildGeometry() {
        return new org.renameme.geometry.Point(coordinates.get(0).x, coordinates.get(0).y);
    }
