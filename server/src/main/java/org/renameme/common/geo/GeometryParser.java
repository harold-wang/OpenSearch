...
public final class GeometryParser {
    ...
    public GeometryFormat<Geometry> geometryFormat(XContentParser parser) {
        if (parser.currentToken() == XContentParser.Token.START_OBJECT) {
            ...
            throw new RenamemeParseException("shape must be an object consisting of type and coordinates");
        }
    }
     ...
     */
    public  Geometry parseGeometry(Object value) throws RenamemeParseException {
        ...
        try (XContentParser parser = new MapXContentParser(NamedXContentRegistry.EMPTY, LoggingDeprecationHandler.INSTANCE,
            ...
            throw new RenamemeParseException("error parsing geometry ", ex);
        }
    }
