...
import static org.renameme.RenamemeException.REST_EXCEPTION_SKIP_STACK_TRACE;
import static org.renameme.RenamemeException.REST_EXCEPTION_SKIP_STACK_TRACE_DEFAULT;
...
public class BytesRestResponse extends RestResponse {
    ...
    public BytesRestResponse(RestChannel channel, RestStatus status, Exception e) throws IOException {
        ...
        if (e instanceof RenamemeException) {
            copyHeaders(((RenamemeException) e));
        }
    }
    ...
    private void build(XContentBuilder builder, ToXContent.Params params, RestStatus status,
        ...
        builder.startObject();
        RenamemeException.generateFailureXContent(builder, params, e, detailedErrorsEnabled);
    ...
    public static RenamemeStatusException errorFromXContent(XContentParser parser) throws IOException {
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            if (STATUS.equals(currentFieldName)) {
                ...
                exception = RenamemeException.failureFromXContent(parser);
            }
        }
        ...
        RenamemeStatusException result = new RenamemeStatusException(exception.getMessage(), status, exception.getCause());
