...
import static org.renameme.common.unit.ByteSizeValue.parseBytesSizeValue;
...
public class RestRequest implements ToXContent.Params {
    ...
    public final BytesReference requiredContent() {
        if (hasContent() == false) {
            throw new RenamemeParseException("request body is required");
    ...
    /**
     * A parser for the contents of this request if there is a body, otherwise throws an {@link RenamemeParseException}. Use
     ...
     * otherwise throws an {@link RenamemeParseException}. Use {@link #withContentOrSourceParamParserOrNull(CheckedConsumer)} instead
    ...
    public final Tuple<XContentType, BytesReference> contentOrSourceParam() {
        if (hasContentOrSourceParam() == false) {
            throw new RenamemeParseException("request body or source parameter is required");
        } else if (hasContent()) {
