...
import org.renameme.RenamemeCorruptionException;
...
import org.renameme.common.blobstore.fs.FsBlobStore;
...
import org.renameme.index.translog.BufferedChecksumStreamOutput;
import org.renameme.repositories.blobstore.ChecksumBlobStoreFormat;
...
public class BlobStoreFormatTests extends ESTestCase {
    ...
    private static class BlobObj implements ToXContentFragment {
        ...
        public static BlobObj fromXContent(XContentParser parser) throws IOException {
                ...
                while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                    ...
                    if (token.isValue()) {
                        if ("text" .equals(currentFieldName)) {
                            ...
                            throw new RenamemeParseException("unexpected field [{}]", currentFieldName);
                        }
                    } else {
                        throw new RenamemeParseException("unexpected token [{}]", token);
                    }
            ...
            if (text == null) {
                throw new RenamemeParseException("missing mandatory parameter text");
            }
    ...
    public void testBlobCorruption() throws IOException {
        ...
        } catch (RenamemeCorruptionException ex) {
