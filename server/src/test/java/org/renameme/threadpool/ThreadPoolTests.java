...
import static org.renameme.threadpool.ThreadPool.ESTIMATED_TIME_INTERVAL_SETTING;
import static org.renameme.threadpool.ThreadPool.assertCurrentMethodIsNotCalledRecursively;
...
public class ThreadPoolTests extends ESTestCase {
    ...
    public void testAssertCurrentMethodIsNotCalledRecursively() {
        ...
        assertThat(expectThrows(AssertionError.class, () -> factorial(between(2, 10))).getMessage(),
            equalTo("org.renameme.threadpool.ThreadPoolTests#factorial is called recursively"));
        TestThreadPool threadPool = new TestThreadPool("test");
        ...
        assertThat(expectThrows(AssertionError.class,
            ...
            equalTo("org.renameme.threadpool.ThreadPoolTests#factorialForked is called recursively"));
        terminate(threadPool);
    }
