    ...
    public void testRestRecoveryAction() {
        ...
        for (int i = 0; i < successfulShards; i++) {
            ...
            final List<Object> expectedValues = Arrays.asList(
                    "index",
                    i,
                    XContentRenamemeExtension.DEFAULT_DATE_PRINTER.print(state.getTimer().startTime()),
                    state.getTimer().startTime(),
                    XContentRenamemeExtension.DEFAULT_DATE_PRINTER.print(state.getTimer().stopTime()),
