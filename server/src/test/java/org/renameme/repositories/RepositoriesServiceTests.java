...
public class RepositoriesServiceTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Map<String, Repository.Factory> typesRegistry =
            org.renameme.common.collect.Map.of(TestRepository.TYPE, TestRepository::new,
    ...
    private static class MeteredRepositoryTypeA extends MeteredBlobStoreRepository {
        ...
        private static final RepositoryStats STATS = new RepositoryStats(org.renameme.common.collect.Map.of("GET", 10L));
        ...
        private MeteredRepositoryTypeA(RepositoryMetadata metadata, ClusterService clusterService) {
            super(metadata,
                ...
                org.renameme.common.collect.Map.of("bucket", "bucket-a"));
        }
    ...
    private static class MeteredRepositoryTypeB extends MeteredBlobStoreRepository {
        ...
        private static final RepositoryStats STATS = new RepositoryStats(org.renameme.common.collect.Map.of("LIST", 20L));
        ...
        private MeteredRepositoryTypeB(RepositoryMetadata metadata, ClusterService clusterService) {
            super(metadata,
                ...
                clusterService,
                mock(RecoverySettings.class),
                org.renameme.common.collect.Map.of("bucket", "bucket-b"));
        }
