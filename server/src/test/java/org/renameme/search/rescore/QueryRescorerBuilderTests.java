...
package org.renameme.search.rescore;
...
import org.renameme.common.xcontent.NamedObjectNotFoundException;
...
import org.renameme.search.rescore.QueryRescorer.QueryRescoreContext;
...
public class QueryRescorerBuilderTests extends ESTestCase {
     ...
     */
    public void testBuildRescoreSearchContext() throws RenamemeParseException, IOException {
    ...
    public void testRewritingKeepsSettings() throws IOException {
        ...
        org.renameme.search.rescore.QueryRescorerBuilder rescoreBuilder = new
            org.renameme.search.rescore.QueryRescorerBuilder(rewriteQb);
    ...
    public static QueryRescorerBuilder randomRescoreBuilder() {
        ...
        org.renameme.search.rescore.QueryRescorerBuilder rescorer = new
                org.renameme.search.rescore.QueryRescorerBuilder(queryBuilder);
        if (randomBoolean()) {
