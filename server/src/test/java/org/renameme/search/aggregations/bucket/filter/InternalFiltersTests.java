...
package org.renameme.search.aggregations.bucket.filter;
...
import org.renameme.search.aggregations.ParsedMultiBucketAggregation;
import org.renameme.search.aggregations.bucket.filter.InternalFilters.InternalBucket;
...
public class InternalFiltersTests extends InternalMultiBucketAggregationTestCase<InternalFilters> {
    ...
    public void testReducePipelinesReducesBucketPipelines() {
        ...
        PipelineTree tree = new PipelineTree(
            org.renameme.common.collect.Map.of(inner.getName(), new PipelineTree(emptyMap(), singletonList(mockPipeline))),
            emptyList());
