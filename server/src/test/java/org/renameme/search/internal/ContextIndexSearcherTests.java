...
import static org.renameme.search.internal.ContextIndexSearcher.intersectScorerAndBitSet;
import static org.renameme.search.internal.ExitableDirectoryReader.ExitableLeafReader;
import static org.renameme.search.internal.ExitableDirectoryReader.ExitablePointValues;
import static org.renameme.search.internal.ExitableDirectoryReader.ExitableTerms;
...
public class ContextIndexSearcherTests extends ESTestCase {
    ...
    public void doTestContextIndexSearcher(boolean sparse, boolean deletions) throws IOException {
        ...
        DirectoryReader reader = RenamemeDirectoryReader.wrap(DirectoryReader.open(w),
