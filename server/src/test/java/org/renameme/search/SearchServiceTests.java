...
import org.renameme.indices.settings.InternalOrPrivateSettingsPlugin;
...
public class SearchServiceTests extends ESSingleNodeTestCase {
            ...
            indexModule.addSearchOperationListener(new SearchOperationListener() {
                ...
                public void onFetchPhase(SearchContext context, long tookInNanos) {
                    if ("throttled_threadpool_index".equals(context.indexShard().shardId().getIndex().getName())) {
                        assertThat(Thread.currentThread().getName(), startsWith("renameme[node_s_0][search_throttled]"));
                    } else {
                        assertThat(Thread.currentThread().getName(), startsWith("renameme[node_s_0][search]"));
                    }
                }
    ...
    public void testMaxOpenScrollContexts() throws Exception {
        ...
        RenamemeException ex = expectThrows(RenamemeException.class,
    ...
    public void testOpenScrollContextsConcurrently() throws Exception {
        ...
        for (int i = 0; i < threads.length; i++) {
            ...
            threads[i].setName("renameme[node_s_0][search]");
            threads[i].start();
        }
