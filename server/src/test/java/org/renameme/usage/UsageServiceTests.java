...
import static org.renameme.search.aggregations.support.AggregationUsageService.OTHER_SUBTYPE;
...
public class UsageServiceTests extends ESTestCase {
    ...
    /**
     * Test that we can not add a null reference to a {@link org.renameme.rest.RestHandler} to the {@link UsageService}.
     */
    ...
    /**
     * Test that we can not add an instance of a {@link org.renameme.rest.RestHandler} with no name to the {@link UsageService}.
     */
    public void testAHandlerWithNoName() {
        ...
        assertThat(
            e.getMessage(),
            equalTo("handler of type [org.renameme.usage.UsageServiceTests$MockRestHandler] does not have a name"));
    }

    /**
     * Test that we can add the same instance of a {@link org.renameme.rest.RestHandler} to the {@link UsageService} multiple times.
     */
    ...
    /**
     * Test that we can not add different instances of {@link org.renameme.rest.RestHandler} with the same name to the
     * {@link UsageService}.
     */
    public void testHandlersWithConflictingNamesButDifferentInstances() {
        ...
        final String expected = String.format(
            ...
            "org.renameme.usage.UsageServiceTests$MockRestHandler",
            name
        );
