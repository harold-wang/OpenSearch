...
import org.renameme.cluster.routing.RoutingNodes;
...
import org.renameme.snapshots.SnapshotShardSizeInfo;
...
import static org.renameme.cluster.routing.ShardRoutingState.INITIALIZING;
import static org.renameme.cluster.routing.ShardRoutingState.STARTED;
import static org.renameme.cluster.routing.ShardRoutingState.UNASSIGNED;
import static org.renameme.test.VersionUtils.randomVersion;
...
public class NodeVersionAllocationDeciderTests extends ESAllocationTestCase {
    ...
    public void testRebalanceDoesNotAllocatePrimaryAndReplicasOnDifferentVersionNodes() {
        ...
        RoutingTable routingTable = RoutingTable.builder()
            ...
            .build();
        ClusterState state = ClusterState.builder(org.renameme.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
