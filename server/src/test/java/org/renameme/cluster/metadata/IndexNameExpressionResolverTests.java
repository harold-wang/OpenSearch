...
import org.renameme.cluster.metadata.IndexMetadata.State;
...
import static org.renameme.cluster.DataStreamTestHelper.createBackingIndex;
import static org.renameme.cluster.DataStreamTestHelper.createTimestampField;
import static org.renameme.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
import static org.renameme.cluster.metadata.IndexNameExpressionResolver.SYSTEM_INDEX_ACCESS_CONTROL_HEADER_KEY;
...
public class IndexNameExpressionResolverTests extends ESTestCase {
    ...
    public void testIndicesAliasesRequestTargetDataStreams() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(backingIndex.getIndex()), 1));
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
    ...
    public void testDataStreams() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(index2, false)
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(index1.getIndex(), index2.getIndex()), 2));
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
    ...
    public void testDataStreamsWithWildcardExpression() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(new DataStream(dataStream1, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(index1.getIndex(), index2.getIndex())))
            .put(new DataStream(dataStream2, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(index3.getIndex(), index4.getIndex())));
