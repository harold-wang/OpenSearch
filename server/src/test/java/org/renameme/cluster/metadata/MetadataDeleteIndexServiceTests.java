...
public class MetadataDeleteIndexServiceTests extends ESTestCase {
    ...
    public void testDeleteSnapshotting() {
        ...
        SnapshotsInProgress snaps = SnapshotsInProgress.of(
            org.renameme.common.collect.List.of(new SnapshotsInProgress.Entry(snapshot, true, false,
    ...
    public void testDeleteBackingIndexForDataStream() {
        ...
        ClusterState before = DataStreamTestHelper.getClusterStateWithDataStreams(
            org.renameme.common.collect.List.of(new Tuple<>(dataStreamName, numBackingIndices)),
        ...
        ClusterState after = service.deleteIndices(before, org.renameme.common.collect.Set.of(indexToDelete));
    ...
    public void testDeleteCurrentWriteIndexForDataStream() {
        ...
        Exception e = expectThrows(IllegalArgumentException.class,
            () -> service.deleteIndices(before, org.renameme.common.collect.Set.of(indexToDelete)));
