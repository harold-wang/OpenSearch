...
import static org.renameme.cluster.DataStreamTestHelper.createFirstBackingIndex;
import static org.renameme.cluster.DataStreamTestHelper.createTimestampField;
import static org.renameme.cluster.metadata.Metadata.Builder.validateDataStreams;
...
public class MetadataTests extends ESTestCase {
    ...
    public void testBuilderRejectsDataStreamThatConflictsWithIndex() {
        ...
        Metadata.Builder b = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(idx.getIndex())));
    ...
    public void testBuilderRejectsDataStreamWithConflictingBackingIndices() {
        ...
        Metadata.Builder b = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.renameme.common.collect.List.of(validIdx.getIndex())));
    ...
    public void testValidateDataStreamsThrowsExceptionOnConflict() {
        ...
        DataStreamMetadata dataStreamMetadata = new DataStreamMetadata(org.renameme.common.collect.Map.of(dataStreamName, dataStream));
