...
import static org.renameme.cluster.InternalClusterInfoService.INTERNAL_CLUSTER_INFO_UPDATE_INTERVAL_SETTING;
        ...
        protected <Request extends ActionRequest, Response extends ActionResponse> void doExecute(ActionType<Response> action,
            ...
            if (request instanceof NodesStatsRequest || request instanceof IndicesStatsRequest) {
                ...
                listener.onFailure(new ClusterBlockException(
                        org.renameme.common.collect.Set.of(NoMasterBlockService.NO_MASTER_BLOCK_ALL)));
            } else {
