...
import org.renameme.cluster.coordination.Coordinator.Mode;
...
import org.renameme.discovery.zen.PublishClusterStateStats;
...
import static org.renameme.cluster.coordination.AbstractCoordinatorTestCase.Cluster.EXTREME_DELAY_VARIABILITY;
...
import static org.renameme.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_ALL;
import static org.renameme.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_METADATA_WRITES;
import static org.renameme.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_SETTING;
import static org.renameme.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_WRITES;
...
import static org.renameme.monitor.StatusInfo.Status.UNHEALTHY;
import static org.renameme.test.NodeRoles.nonMasterNode;
...
public class CoordinatorTests extends AbstractCoordinatorTestCase {
    ...
    private static class BrokenCustom extends AbstractDiffable<ClusterState.Custom> implements ClusterState.Custom {
        ...
        public void writeTo(StreamOutput out) throws IOException {
            throw new RenamemeException(EXCEPTION_MESSAGE);
        }
    ...
    public void testClusterRecoversAfterExceptionDuringSerialization() {
        try (Cluster cluster = new Cluster(randomIntBetween(1, 5))) {
            ...
            leader1.submitUpdateTask("broken-task",
                ...
                (source, e) -> {
                    assertThat(e.getCause(), instanceOf(RenamemeException.class));
