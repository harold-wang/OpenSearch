...
import static org.renameme.cluster.coordination.LeaderChecker.LEADER_CHECK_ACTION_NAME;
                ...
                deterministicTaskQueue.scheduleAt(deterministicTaskQueue.getCurrentTimeMillis() + responseDelay, new Runnable() {
                    ...
                    public void run() {
                        if (successResponse) {
                            ...
                            handleRemoteError(requestId, new RenamemeException("simulated error"));
                        }
                    }
