...
public class RenamemeNodeCommandTests extends ESTestCase {
    ...
    private void runLoadStateTest(boolean hasMissingCustoms, boolean preserveUnknownCustoms) throws IOException {
        ...
        try (XContentParser parser = createParser(hasMissingCustoms ? RenamemeNodeCommand.namedXContentRegistry : xContentRegistry(),
        ...
        if (hasMissingCustoms) {
            ...
            assertThat(loadedMetadata.custom(IndexGraveyard.TYPE), instanceOf(RenamemeNodeCommand.UnknownMetadataCustom.class));
