...
import static org.renameme.http.AbstractHttpServerTransport.resolvePublishPort;
...
public class AbstractHttpServerTransportTests extends ESTestCase {
    ...
    @TestLogging(
        value = "org.renameme.http.HttpTracer:trace",
    ...
    public void testTracerLog() throws Exception {
        ...
        try (AbstractHttpServerTransport transport =
            ...
            final String traceLoggerName = "org.renameme.http.HttpTracer";
            try {
                appender.start();
