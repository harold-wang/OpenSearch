...
public class IncrementalClusterStateWriterTests extends ESAllocationTestCase {
    ...
    private ClusterState clusterStateWithUnassignedIndex(IndexMetadata indexMetadata, boolean masterEligible) {
        ...
        return ClusterState.builder(org.renameme.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
    ...
    @TestLogging(value = "org.renameme.gateway:WARN", reason = "to ensure that we log gateway events on WARN level")
