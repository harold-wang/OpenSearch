...
import static org.renameme.test.NodeRoles.nonRemoteClusterClientNode;
import static org.renameme.test.NodeRoles.remoteClusterClientNode;
import static org.renameme.transport.RemoteClusterService.ENABLE_REMOTE_CLUSTERS;
import static org.renameme.transport.RemoteClusterService.REMOTE_CLUSTER_SKIP_UNAVAILABLE;
import static org.renameme.transport.RemoteClusterService.REMOTE_INITIAL_CONNECTION_TIMEOUT_SETTING;
import static org.renameme.transport.RemoteClusterService.REMOTE_NODE_ATTRIBUTE;
import static org.renameme.transport.RemoteClusterService.SEARCH_ENABLE_REMOTE_CLUSTERS;
import static org.renameme.transport.RemoteClusterService.SEARCH_REMOTE_CLUSTER_SKIP_UNAVAILABLE;
import static org.renameme.transport.RemoteClusterService.SEARCH_REMOTE_INITIAL_CONNECTION_TIMEOUT_SETTING;
import static org.renameme.transport.RemoteClusterService.SEARCH_REMOTE_NODE_ATTRIBUTE;
import static org.renameme.transport.SniffConnectionStrategy.REMOTE_CLUSTERS_PROXY;
import static org.renameme.transport.SniffConnectionStrategy.REMOTE_CLUSTER_SEEDS;
import static org.renameme.transport.SniffConnectionStrategy.REMOTE_CONNECTIONS_PER_CLUSTER;
import static org.renameme.transport.SniffConnectionStrategy.SEARCH_REMOTE_CLUSTERS_PROXY;
import static org.renameme.transport.SniffConnectionStrategy.SEARCH_REMOTE_CLUSTERS_SEEDS;
import static org.renameme.transport.SniffConnectionStrategy.SEARCH_REMOTE_CONNECTIONS_PER_CLUSTER;
