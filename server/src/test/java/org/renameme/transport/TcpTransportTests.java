...
public class TcpTransportTests extends ESTestCase {
    ...
    @TestLogging(reason = "testing logging", value = "org.renameme.transport.TcpTransport:DEBUG")
    public void testExceptionHandling() throws IllegalAccessException {
        testExceptionHandling(false, new RenamemeException("simulated"), true,
            new MockLogAppender.UnseenEventExpectation("message", "org.renameme.transport.TcpTransport", Level.ERROR, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.renameme.transport.TcpTransport", Level.WARN, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.renameme.transport.TcpTransport", Level.INFO, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.renameme.transport.TcpTransport", Level.DEBUG, "*"));
        testExceptionHandling(new RenamemeException("simulated"),
            new MockLogAppender.SeenEventExpectation("message", "org.renameme.transport.TcpTransport",
        ...
        testExceptionHandling(new RenamemeException("Connection reset"),
            new MockLogAppender.SeenEventExpectation("message", "org.renameme.transport.TcpTransport",
                Level.DEBUG, "close connection exception caught on transport layer [*], disconnecting from relevant node"));
