...
import static org.renameme.transport.RemoteClusterConnectionTests.startTransport;
...
public class RemoteClusterClientTests extends ESTestCase {
    ...
    @TestLogging(
        value = "org.renameme.transport.SniffConnectionStrategy:TRACE,org.renameme.transport.ClusterConnectionManager:TRACE",
