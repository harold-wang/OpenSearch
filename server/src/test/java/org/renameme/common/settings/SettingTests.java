...
import org.renameme.common.settings.AbstractScopedSettings.SettingUpdater;
...
public class SettingTests extends ESTestCase {
    ...
    public void testNonSecureSettingInKeystore() {
        ...
        assertThat(e.getMessage(), containsString("must be stored inside renameme.yml"));
    }

    @TestLogging(value="org.renameme.common.settings.IndexScopedSettings:INFO",
    ...
    public void testLogSettingUpdate() throws Exception {
        ...
        mockLogAppender.addExpectation(new MockLogAppender.SeenEventExpectation(
            "message",
            "org.renameme.common.settings.IndexScopedSettings",
            Level.INFO,
