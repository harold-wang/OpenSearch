...
package org.renameme.common.lucene;
...
public class ShardCoreKeyMapTests extends ESTestCase {
    ...
    public void testAddingAClosedReader() throws Exception {
        ...
        try (Directory dir = newDirectory();
            ...
            try (DirectoryReader dirReader = RenamemeDirectoryReader.wrap(writer.getReader(), new ShardId("index1", "_na_", 1))) {
    ...
    public void testBasics() throws IOException {
        ...
        RenamemeDirectoryReader reader1 = RenamemeDirectoryReader.wrap(w1.getReader(), shardId1);
        RenamemeDirectoryReader reader2 = RenamemeDirectoryReader.wrap(w2.getReader(), shardId2);
        RenamemeDirectoryReader reader3 = RenamemeDirectoryReader.wrap(w3.getReader(), shardId3);
        ...
        w1.addDocument(new Document());
        RenamemeDirectoryReader newReader1 = RenamemeDirectoryReader.wrap(w1.getReader(), shardId1);
        reader1.close();
        reader1 = newReader1;
        ...
        w2.addDocument(new Document());
        w2.forceMerge(1);
        RenamemeDirectoryReader newReader2 = RenamemeDirectoryReader.wrap(w2.getReader(), shardId2);
        reader2.close();
        reader2 = newReader2;
