 ...
 * under the License.
 */
package org.renameme.common.lucene.uid;
...
import static org.renameme.common.lucene.uid.VersionsAndSeqNoResolver.loadDocIdAndVersion;
...
public class VersionsTests extends ESTestCase {
    ...
    public void testVersions() throws Exception {
        ...
        DirectoryReader directoryReader = RenamemeDirectoryReader.wrap(DirectoryReader.open(writer), new ShardId("foo", "_na_", 1));
    ...
    public void testCacheFilterReader() throws Exception {
        ...
        assertEquals(size+1, VersionsAndSeqNoResolver.lookupStates.size());
        // now wrap the reader
        DirectoryReader wrapped = RenamemeDirectoryReader.wrap(reader, new ShardId("bogus", "_na_", 5));
