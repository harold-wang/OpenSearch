...
import org.renameme.common.geo.parsers.ShapeParser;
...
import org.renameme.index.mapper.GeoShapeIndexer;
import org.renameme.index.mapper.LegacyGeoShapeFieldMapper;
import org.renameme.index.mapper.Mapper;
import org.renameme.test.VersionUtils;
import org.renameme.test.hamcrest.RenamemeGeoAssertions;
...
import static org.renameme.common.geo.builders.ShapeBuilder.SPATIAL_CONTEXT;
...
public class GeoJsonShapeParserTests extends BaseGeoParsingTestCase {
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(new org.renameme.geometry.Point(100d, 0d), pointGeoJson, false);
    }
    ...
    public void testParseLineString() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(lineGeoJson)) {
            ...
            RenamemeGeoAssertions.assertLineString(shape, true);
        }

        try (XContentParser parser = createParser(lineGeoJson)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertLineString(parse(parser), false);
        }
    }
    ...
    public void testParseMultiDimensionShapes() throws IOException {
        ...
        parser.nextToken();
        RenamemeGeoAssertions.assertValidException(parser, RenamemeParseException.class);
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertGeometryEquals(expected, multilinesGeoJson, true);
        assertGeometryEquals(new org.renameme.geometry.Rectangle(-50, 50, 30, -30),
            multilinesGeoJson, false);
    ...
    public void testParsePolygon() throws IOException, ParseException {
        ...
        org.renameme.geometry.Polygon p = new org.renameme.geometry.Polygon(
            new org.renameme.geometry.LinearRing(
    ...
    public void testParse3DPolygon() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(polygonGeoJson)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertEquals(jtsGeom(expected), ShapeParser.parse(parser, mapperBuilder).buildS4J());
        }

        org.renameme.geometry.Polygon p = new org.renameme.geometry.Polygon(new org.renameme.geometry.LinearRing(
    ...
    public void testParseInvalidMultiPolygon() throws IOException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, multiPolygonGeoJson)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertValidException(parser, InvalidShapeException.class);
            assertNull(parser.nextToken());
        }
    }
    ...
    public void testParseOGCPolygonWithoutHoles() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            Shape shape = ShapeParser.parse(parser).buildS4J();
            RenamemeGeoAssertions.assertPolygon(shape, true);
        }

        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertPolygon(parse(parser), false);
        }
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            Shape shape = ShapeParser.parse(parser).buildS4J();
            RenamemeGeoAssertions.assertMultiPolygon(shape, true);
        }

        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertMultiPolygon(parse(parser), false);
        }
    ...
    public void testParseInvalidPolygon() throws IOException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, invalidPoly)) {
            parser.nextToken();
            RenamemeGeoAssertions.assertValidException(parser, IllegalArgumentException.class);
            assertNull(parser.nextToken());
        }
    ...
    public void testParsePolygonWithHole() throws IOException, ParseException {
        ...
        org.renameme.geometry.LinearRing hole =
            new org.renameme.geometry.LinearRing(
                new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});
        org.renameme.geometry.Polygon p =
            new org.renameme.geometry.Polygon(new org.renameme.geometry.LinearRing(
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(new MultiPoint(Arrays.asList(
            new org.renameme.geometry.Point(100, 0),
            new org.renameme.geometry.Point(101, 1))), multiPointGeoJson, false);
    }
    ...
    public void testParseMultiPolygon() throws IOException, ParseException {
        ...
        org.renameme.geometry.LinearRing hole = new org.renameme.geometry.LinearRing(
            new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});

        org.renameme.geometry.MultiPolygon polygons = new org.renameme.geometry.MultiPolygon(Arrays.asList(
            new org.renameme.geometry.Polygon(new org.renameme.geometry.LinearRing(
        ...
        org.renameme.geometry.LinearRing luceneHole =
            new org.renameme.geometry.LinearRing(
                new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});

        org.renameme.geometry.Polygon lucenePolygons = (new org.renameme.geometry.Polygon(
            new org.renameme.geometry.LinearRing(
    ...
    public void testParseGeometryCollection() throws IOException, ParseException {
        ...
        GeometryCollection<Geometry> geometryExpected = new GeometryCollection<> (Arrays.asList(
            new Line(new double[] {100d, 101d}, new double[] {0d, 1d}),
            new org.renameme.geometry.Point(102d, 2d),
            new org.renameme.geometry.MultiPolygon(Arrays.asList(
                new org.renameme.geometry.Polygon(new org.renameme.geometry.LinearRing(
    ...
    public void testThatParserExtractsCorrectTypeAndCoordinatesFromArbitraryJson() throws IOException, ParseException {
        XContentBuilder pointGeoJson = XContentFactory.jsonBuilder()
            ...
            org.renameme.geometry.Point expectedPt = new org.renameme.geometry.Point(100, 0);
