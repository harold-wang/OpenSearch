...
import org.renameme.common.geo.parsers.GeoWKTParser;
...
import org.renameme.index.mapper.GeoShapeFieldMapper;
...
public class GeoWKTShapeParserTests extends BaseGeoParsingTestCase {
    ...
    private void assertMalformed(ShapeBuilder<?, ?, ?> builder) throws IOException {
        ...
        assertValidException(xContentBuilder, RenamemeParseException.class);
    }
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertExpected(new org.renameme.geometry.Point(p.lon(), p.lat()), new PointBuilder().coordinate(c), false);
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        List<org.renameme.geometry.Point> points = new ArrayList<>(numPoints);
        for (int i = 0; i < numPoints; ++i) {
            Coordinate c = coordinates.get(i);
            points.add(new org.renameme.geometry.Point(c.x, c.y));
        }
    ...
    public void testParseMixedDimensionPolyWithHole() throws IOException, ParseException {
        ...
        RenamemeParseException e = expectThrows(RenamemeParseException.class,
    ...
    public void testParseOpenPolygon() throws IOException {
        ...
        RenamemeParseException exception = expectThrows(RenamemeParseException.class,
    ...
    public void testMalformedWKT() throws IOException {
        ...
        assertValidException(builder, RenamemeParseException.class);
    }
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertExpected(expected, builder, true);
        assertExpected(new org.renameme.geometry.Rectangle(r.minLon, r.maxLon, r.maxLat, r.minLat), builder, false);
        assertMalformed(builder);
    }
