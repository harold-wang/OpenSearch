...
import org.renameme.test.AbstractWireSerializingTestCase;
...
public class ByteSizeValueTests extends AbstractWireSerializingTestCase<ByteSizeValue> {
    ...
    public void testFailOnMissingUnits() {
        Exception e = expectThrows(RenamemeParseException.class, () -> ByteSizeValue.parseBytesSizeValue("23", "test"));
        assertThat(e.getMessage(), containsString("failed to parse setting [test]"));
    }

    public void testFailOnUnknownUnits() {
        Exception e = expectThrows(RenamemeParseException.class, () -> ByteSizeValue.parseBytesSizeValue("23jw", "test"));
        assertThat(e.getMessage(), containsString("failed to parse setting [test]"));
    }

    public void testFailOnEmptyParsing() {
        Exception e = expectThrows(RenamemeParseException.class,
    ...
    public void testNoDotsAllowed() {
        Exception e = expectThrows(RenamemeParseException.class, () -> ByteSizeValue.parseBytesSizeValue("42b.", null, "test"));
        assertThat(e.getMessage(), containsString("failed to parse setting [test]"));
    }
    ...
    public void testParseInvalidNumber() throws IOException {
        ...
        exception = expectThrows(RenamemeParseException.class, () -> ByteSizeValue.parseBytesSizeValue("notANumberMB", "test"));
