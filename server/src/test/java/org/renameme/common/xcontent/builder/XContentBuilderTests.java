...
package org.renameme.common.xcontent.builder;
...
public class XContentBuilderTests extends ESTestCase {
    ...
    public void testDateTypesConversion() throws Exception {
        Date date = new Date();
        String expectedDate = XContentRenamemeExtension.DEFAULT_DATE_PRINTER.print(date.getTime());
        Calendar calendar = new GregorianCalendar(TimeZone.getTimeZone("UTC"), Locale.ROOT);
        String expectedCalendar = XContentRenamemeExtension.DEFAULT_DATE_PRINTER.print(calendar.getTimeInMillis());
        XContentBuilder builder = XContentFactory.contentBuilder(XContentType.JSON);
