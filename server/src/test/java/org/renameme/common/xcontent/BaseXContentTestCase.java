...
public abstract class BaseXContentTestCase extends ESTestCase {
    ...
    public void testReadableInstant() throws Exception {
        ...
        expected = "{'t5':'" + XContentRenamemeExtension.DEFAULT_DATE_PRINTER.print(t5) + "'}";
    ...
    public void testObjects() throws Exception {
        ...
        final DateTimeFormatter formatter = XContentRenamemeExtension.DEFAULT_DATE_PRINTER;
        final Date d1 = new DateTime(2016, 1, 1, 0, 0, DateTimeZone.UTC).toDate();
    ...
    public void testUnknownObject() throws Exception {
        ...
        objects.put("{'obj':'class org.renameme.common.xcontent.BaseXContentTestCase'}", BaseXContentTestCase.class);
