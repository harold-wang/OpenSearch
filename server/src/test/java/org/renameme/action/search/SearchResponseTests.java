...
import org.renameme.search.SearchHitsTests;
import org.renameme.search.SearchModule;
import org.renameme.search.aggregations.AggregationsTests;
...
import org.renameme.search.suggest.SuggestTests;
...
public class SearchResponseTests extends ESTestCase {
     ...
     * the failures in the parsed SearchResponse are wrapped in an extra RenamemeException on the client side.
