...
import static org.renameme.action.admin.cluster.configuration.TransportAddVotingConfigExclusionsAction.MAXIMUM_VOTING_CONFIG_EXCLUSIONS_SETTING;
import static org.renameme.cluster.ClusterState.builder;
...
public class TransportAddVotingConfigExclusionsActionTests extends ESTestCase {
    ...
    public void testTimesOut() throws InterruptedException {
        ...
        assertTrue(countDownLatch.await(30, TimeUnit.SECONDS));
        final Throwable rootCause = exceptionHolder.get().getRootCause();
        assertThat(rootCause,instanceOf(RenamemeTimeoutException.class));
