...
package org.renameme.action.admin.indices.resolve;

import org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedAlias;
import org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream;
import org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex;
import org.renameme.action.admin.indices.resolve.ResolveIndexAction.Response;
...
import org.renameme.test.AbstractSerializingTestCase;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.BACKING_INDICES_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.TIMESTAMP_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ALIASES_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ATTRIBUTES_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.DATA_STREAM_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndexAbstraction.NAME_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.Response.DATA_STREAMS_FIELD;
import static org.renameme.action.admin.indices.resolve.ResolveIndexAction.Response.INDICES_FIELD;
...
public class ResolveIndexResponseTests extends AbstractSerializingTestCase<Response> {
    ...
    private static ResolvedIndex createTestResolvedIndexInstance() {
        ...
        String[] attributes = randomSubsetOf(
            org.renameme.common.collect.List.of("open", "hidden", "frozen")).toArray(Strings.EMPTY_ARRAY);
