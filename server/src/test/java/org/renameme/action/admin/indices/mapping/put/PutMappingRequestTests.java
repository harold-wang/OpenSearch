...
import org.renameme.action.admin.indices.datastream.DeleteDataStreamRequestTests;
...
import org.renameme.index.RandomCreateIndexGenerator;
...
import static org.renameme.common.collect.Tuple.tuple;
...
public class PutMappingRequestTests extends ESTestCase {
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        List<Tuple<String, Integer>> dsMetadata = org.renameme.common.collect.List.of(
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.renameme.common.collect.List.of("index1", "index2", "index3"));
        cs = addAliases(cs, org.renameme.common.collect.List.of(
            tuple("alias1", org.renameme.common.collect.List.of(tuple("index1", false), tuple("index2", true))),
            tuple("alias2", org.renameme.common.collect.List.of(tuple("index2", false), tuple("index3", true)))
        ));
    ...
    public void testResolveIndicesWithoutWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        expectedIndices.addAll(org.renameme.common.collect.List.of("index1", "index2", "index3"));
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndNoSingleWriteIndex() {
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.renameme.common.collect.List.of("index1", "index2", "index3"));
        final ClusterState cs2 = addAliases(cs, org.renameme.common.collect.List.of(
            tuple("alias1", org.renameme.common.collect.List.of(tuple("index1", false), tuple("index2", true))),
            tuple("alias2", org.renameme.common.collect.List.of(tuple("index2", false), tuple("index3", true)))
        ));
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndAliasWithoutWriteIndex() {
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.renameme.common.collect.List.of("index1", "index2", "index3"));
        final ClusterState cs2 = addAliases(cs, org.renameme.common.collect.List.of(
            tuple("alias1", org.renameme.common.collect.List.of(tuple("index1", false), tuple("index2", false))),
            tuple("alias2", org.renameme.common.collect.List.of(tuple("index2", false), tuple("index3", false)))
        ));
