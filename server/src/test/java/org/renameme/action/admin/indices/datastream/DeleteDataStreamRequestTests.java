 ...
 * under the License.
 */
package org.renameme.action.admin.indices.datastream;

import org.renameme.Version;
import org.renameme.action.ActionRequestValidationException;
import org.renameme.action.admin.indices.datastream.DeleteDataStreamAction.Request;
...
public class DeleteDataStreamRequestTests extends AbstractWireSerializingTestCase<Request> {
    ...
    public void testDeleteDataStream() {
        ...
        final List<String> otherIndices = randomSubsetOf(org.renameme.common.collect.List.of("foo", "bar", "baz"));
        ClusterState cs = getClusterStateWithDataStreams(
            org.renameme.common.collect.List.of(new Tuple<>(dataStreamName, 2)), otherIndices);
    ...
    public void testDeleteMultipleDataStreams() {
        ...
        ClusterState cs = getClusterStateWithDataStreams(org.renameme.common.collect.List.of(
