...
import org.renameme.action.admin.indices.datastream.GetDataStreamAction.Request;
...
import static org.renameme.action.admin.indices.datastream.DeleteDataStreamRequestTests.getClusterStateWithDataStreams;
...
public class GetDataStreamsRequestTests extends AbstractWireSerializingTestCase<Request> {
    ...
    public void testGetDataStream() {
        ...
        ClusterState cs = getClusterStateWithDataStreams(
            org.renameme.common.collect.List.of(new Tuple<>(dataStreamName, 1)), org.renameme.common.collect.List.of());
    ...
    public void testGetDataStreamsWithWildcards() {
        ...
        ClusterState cs = getClusterStateWithDataStreams(
            org.renameme.common.collect.List.of(new Tuple<>(dataStreamNames[0], 1), new Tuple<>(dataStreamNames[1], 1)),
