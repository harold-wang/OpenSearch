...
import org.renameme.action.admin.indices.create.CreateIndexRequestTests;
...
public class RolloverRequestTests extends ESTestCase {
    ...
    public void testToAndFromXContent() throws IOException {
        ...
        RenamemeAssertions.assertToXContentEquivalent(originalBytes, finalBytes, xContentType);
    }
