...
import org.renameme.ingest.CompoundProcessor;
import org.renameme.ingest.IngestDocument;
import org.renameme.ingest.IngestService;
import org.renameme.ingest.Pipeline;
import org.renameme.ingest.Processor;
import org.renameme.ingest.TestProcessor;
...
import static org.renameme.action.ingest.SimulatePipelineRequest.Fields;
import static org.renameme.action.ingest.SimulatePipelineRequest.SIMULATED_PIPELINE_ID;
import static org.renameme.ingest.IngestDocument.Metadata.ID;
import static org.renameme.ingest.IngestDocument.Metadata.INDEX;
import static org.renameme.ingest.IngestDocument.Metadata.ROUTING;
import static org.renameme.ingest.IngestDocument.Metadata.TYPE;
import static org.renameme.ingest.IngestDocument.Metadata.VERSION;
import static org.renameme.ingest.IngestDocument.Metadata.VERSION_TYPE;
import static org.renameme.ingest.IngestDocument.Metadata.IF_SEQ_NO;
import static org.renameme.ingest.IngestDocument.Metadata.IF_PRIMARY_TERM;
...
public class SimulatePipelineRequestParsingTests extends ESTestCase {
    ...
    public void testNotValidDocs() {
        ...
        requestContent.put(Fields.DOCS, docs);
        requestContent.put(Fields.PIPELINE, pipelineConfig);
        Exception e3 = expectThrows(RenamemeParseException.class,
            () -> SimulatePipelineRequest.parse(requestContent, false, ingestService));
