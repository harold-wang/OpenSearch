...
import org.renameme.action.delete.DeleteResponseTests;
import org.renameme.action.index.IndexResponseTests;
import org.renameme.action.update.UpdateResponseTests;
...
import static org.renameme.RenamemeExceptionTests.randomExceptions;
import static org.renameme.action.bulk.BulkItemResponseTests.assertBulkItemResponse;
import static org.renameme.action.bulk.BulkResponse.NO_INGEST_TOOK;
    ...
    public void testToAndFromXContent() throws IOException {
        ...
        for (int i = 0; i < nbBulkItems; i++) {
            ...
            if (frequently()) {
                ...
                Tuple<Throwable, RenamemeException> failures = randomExceptions();
