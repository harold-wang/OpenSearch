...
import org.renameme.common.cache.RemovalNotification;
...
import org.renameme.indices.IndicesRequestCache.Key;
...
import org.renameme.test.MockHttpTransport;
...
public class IndicesServiceCloseTests extends ESTestCase {
    ...
    public void testCloseWhileOngoingRequest() throws Exception {
        ...
        RenamemeAssertions.assertAllSuccessful(node.client().admin().indices().prepareRefresh("test").get());
