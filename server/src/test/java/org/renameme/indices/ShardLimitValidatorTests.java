...
import org.renameme.cluster.shards.ShardCounts;
...
import static org.renameme.cluster.metadata.MetadataIndexStateServiceTests.addClosedIndex;
import static org.renameme.cluster.metadata.MetadataIndexStateServiceTests.addOpenedIndex;
import static org.renameme.cluster.shards.ShardCounts.forDataNodeCount;
import static org.renameme.indices.ShardLimitValidator.SETTING_CLUSTER_MAX_SHARDS_PER_NODE;
