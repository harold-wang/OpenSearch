...
public class PluginInfoTests extends ESTestCase {
    ...
    public void testReadFromProperties() throws Exception {
        ...
        PluginTestUtil.writePluginProperties(pluginDir,
            ...
            "name", "my_plugin",
            "version", "1.0",
            "renameme.version", Version.CURRENT.toString(),
    ...
    public void testReadFromPropertiesrenamemeVersionMissing() throws Exception {
        Path pluginDir = createTempDir().resolve("fake-plugin");
        PluginTestUtil.writePluginProperties(pluginDir,
            "description", "fake desc",
            "name", "my_plugin",
            "version", "1.0");
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> PluginInfo.readFromProperties(pluginDir));
        assertThat(e.getMessage(), containsString("[renameme.version] is missing"));
    }
    ...
    public void testReadFromPropertiesBogusrenamemeVersion() throws Exception {
        Path pluginDir = createTempDir().resolve("fake-plugin");
        PluginTestUtil.writePluginProperties(pluginDir,
            "description", "fake desc",
            "version", "1.0",
            "name", "my_plugin",
            "renameme.version", "bogus");
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> PluginInfo.readFromProperties(pluginDir));
