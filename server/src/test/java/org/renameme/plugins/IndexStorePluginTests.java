        ...
        if (JavaVersion.current().compareTo(JavaVersion.parse("9")) >= 0) {
            assertThat(e, hasToString(matches(
                    "java.lang.IllegalStateException: Duplicate key store \\(attempted merging values " +
                            "org.renameme.index.store.FsDirectoryFactory@[\\w\\d]+ " +
                            "and org.renameme.index.store.FsDirectoryFactory@[\\w\\d]+\\)")));
        } else {
            assertThat(e, hasToString(matches(
                    "java.lang.IllegalStateException: Duplicate key org.renameme.index.store.FsDirectoryFactory@[\\w\\d]+")));
        }
    }
        ...
        if (JavaVersion.current().compareTo(JavaVersion.parse("9")) >= 0) {
            ...
            assertThat(e, hasToString(matches(
                "java.lang.IllegalStateException: Duplicate key " +
                    "org.renameme.plugins.IndexStorePluginTests\\$RecoveryFactory@[\\w\\d]+")));
        }
    }
}
