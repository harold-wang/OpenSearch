...
public class PluginsServiceTests extends ESTestCase {
    ...
    public void testStartupWithRemovingMarker() throws IOException {
        ...
        final String expected = String.format(
                Locale.ROOT,
                "found file [%s] from a failed attempt to remove the plugin [fake]; execute [renameme-plugin remove fake]",
                removing);
        assertThat(e, hasToString(containsString(expected)));
    }
    ...
    public void testExistingMandatoryClasspathPlugin() {
        final Settings settings =
                Settings.builder()
                        ...
                        .put("plugin.mandatory", "org.renameme.plugins.PluginsServiceTests$FakePlugin")
                        .build();
