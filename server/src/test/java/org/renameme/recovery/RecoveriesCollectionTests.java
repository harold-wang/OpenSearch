...
import org.renameme.indices.recovery.RecoveriesCollection;
...
public class RecoveriesCollectionTests extends ESIndexLevelReplicationTestCase {
    ...
    public void testResetRecovery() throws Exception {
        try (ReplicationGroup shards = createGroup(0)) {
            ...
            expectThrows(RenamemeException.class, () -> recoveryTarget.store());
            expectThrows(RenamemeException.class, () -> recoveryTarget.indexShard());
