...
public class RenamemeUncaughtExceptionHandlerTests extends ESTestCase {
    ...
    public void testUncaughtError() throws InterruptedException {
        ...
        thread.setUncaughtExceptionHandler(new RenamemeUncaughtExceptionHandler() {
    ...
    private void assertFatal(Throwable cause) {
        assertTrue(RenamemeUncaughtExceptionHandler.isFatalUncaught(cause));
    }

    private void assertNonFatal(Throwable cause) {
        assertFalse(RenamemeUncaughtExceptionHandler.isFatalUncaught(cause));
    }
