...
import org.renameme.bootstrap.ESRenamemeCliTestCase;
...
public class RenamemeCliTests extends ESRenamemeCliTestCase {
    ...
    public void testrenamemeSettings() throws Exception {
        runTest(
                ExitCodes.OK,
                true,
                (output, error) -> {},
    ...
    public void testrenamemeSettingCanNotBeEmpty() throws Exception {
        runTest(
                ExitCodes.USAGE,
                false,
    ...
    public void testrenamemeSettingCanNotBeDuplicated() throws Exception {
        runTest(
                ExitCodes.USAGE,
                false,
