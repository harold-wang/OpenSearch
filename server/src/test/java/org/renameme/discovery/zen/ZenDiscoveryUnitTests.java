...
import org.renameme.cluster.coordination.ValidateJoinRequest;
...
import org.renameme.discovery.zen.PublishClusterStateActionTests.AssertingAckListener;
import org.renameme.discovery.zen.ZenDiscovery.ZenNodeRemovalClusterStateTaskExecutor;
...
import static org.renameme.cluster.routing.RoutingTableTests.updateActiveAllocations;
import static org.renameme.cluster.service.MasterServiceTests.discoveryState;
import static org.renameme.discovery.zen.ElectMasterService.DISCOVERY_ZEN_MINIMUM_MASTER_NODES_SETTING;
import static org.renameme.discovery.zen.ZenDiscovery.shouldIgnoreOrRejectNewClusterState;
