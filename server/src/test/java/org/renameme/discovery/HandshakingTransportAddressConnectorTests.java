...
import org.renameme.transport.TransportService.HandshakeResponse;
...
import static org.renameme.discovery.HandshakingTransportAddressConnector.PROBE_HANDSHAKE_TIMEOUT_SETTING;
...
public class HandshakingTransportAddressConnectorTests extends ESTestCase {
    ...
    @TestLogging(reason="ensure logging happens", value="org.renameme.discovery.HandshakingTransportAddressConnector:INFO")
    public void testLogsFullConnectionFailureAfterSuccessfulHandshake() throws Exception {
        ...
        fullConnectionFailure = new ConnectTransportException(remoteNode, "simulated", new RenamemeException("root cause"));
