...
import org.renameme.discovery.PeerFinder.TransportAddressConnector;
...
import org.renameme.test.transport.StubbableConnectionManager;
import org.renameme.threadpool.ThreadPool.Names;
import org.renameme.transport.ClusterConnectionManager;
import org.renameme.transport.ConnectionManager;
...
import static org.renameme.discovery.PeerFinder.REQUEST_PEERS_ACTION_NAME;
                    ...
                    for (final Map.Entry<TransportAddress, DiscoveryNode> addressAndNode : reachableNodes.entrySet()) {
                        if (addressAndNode.getKey().equals(transportAddress)) {
                            ...
                            if (discoveryNode.isMasterNode()) {
                                ...
                                listener.onFailure(new RenamemeException("non-master node " + discoveryNode));
                                return;
                            }
                        }
                    }
