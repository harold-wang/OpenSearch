...
public class CompletionStatsCacheTests extends ESTestCase {
    ...
    public void testExceptionsAreNotCached() {
        ...
        final CompletionStatsCache completionStatsCache = new CompletionStatsCache(() -> {
            throw new RenamemeException("simulated " + openCount.incrementAndGet());
        });

        assertThat(expectThrows(RenamemeException.class, completionStatsCache::get).getMessage(), equalTo("simulated 1"));
        assertThat(expectThrows(RenamemeException.class, completionStatsCache::get).getMessage(), equalTo("simulated 2"));
    }
