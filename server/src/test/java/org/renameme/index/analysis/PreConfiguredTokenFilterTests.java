...
public class PreConfiguredTokenFilterTests extends ESTestCase {
    ...
    public void testCachingWithrenamemeVersion() throws IOException {
        PreConfiguredTokenFilter pctf =
            PreConfiguredTokenFilter.renamemeVersion("renameme_version", randomBoolean(),
        ...
        Settings settings1 = Settings.builder().put(IndexMetadata.SETTING_VERSION_CREATED, version1)
                .build();
        TokenFilterFactory tff_v1_1 =
                pctf.get(indexSettings, TestEnvironment.newEnvironment(emptyNodeSettings), "renameme_version", settings1);
        TokenFilterFactory tff_v1_2 =
                pctf.get(indexSettings, TestEnvironment.newEnvironment(emptyNodeSettings), "renameme_version", settings1);
        assertSame(tff_v1_1, tff_v1_2);
        ...
        TokenFilterFactory tff_v2 =
                pctf.get(indexSettings, TestEnvironment.newEnvironment(emptyNodeSettings), "renameme_version", settings2);
