...
import org.renameme.common.logging.MockAppender;
...
import org.renameme.index.IndexingSlowLog.IndexingSlowLogMessage;
...
public class IndexingSlowLogTests extends ESTestCase {
    ...
    public void testLevelSetting() {
        ...
        try {
            ...
            assertThat(ex.getCause(), instanceOf(IllegalArgumentException.class));
            final IllegalArgumentException cause = (IllegalArgumentException) ex.getCause();
            assertThat(cause, hasToString(containsString("No enum constant org.renameme.index.SlowLogLevel.NOT A LEVEL")));
        }
        assertEquals(SlowLogLevel.TRACE, log.getLevel());
