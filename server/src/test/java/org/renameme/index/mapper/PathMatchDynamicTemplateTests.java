...
public class PathMatchDynamicTemplateTests extends ESSingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/org/renameme/index/mapper/dynamictemplate/pathmatch/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath("/org/renameme/index/mapper/dynamictemplate/pathmatch/test-data.json");
