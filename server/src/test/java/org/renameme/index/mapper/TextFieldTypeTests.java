...
import org.renameme.common.lucene.BytesRefs;
import org.renameme.common.lucene.Lucene;
import org.renameme.common.lucene.search.AutomatonQueries;
import org.renameme.common.unit.Fuzziness;
import org.renameme.index.mapper.TextFieldMapper.TextFieldType;
...
public class TextFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        assertEquals(org.renameme.common.collect.List.of("value"), fetchSourceValue(phraseFieldType, "value"));
        assertEquals(org.renameme.common.collect.List.of("42"), fetchSourceValue(phraseFieldType, 42L));
        assertEquals(org.renameme.common.collect.List.of("true"), fetchSourceValue(phraseFieldType, true));
    }
}
