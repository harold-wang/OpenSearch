...
public class GenericStoreDynamicTemplateTests extends ESSingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/org/renameme/index/mapper/dynamictemplate/genericstore/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath("/org/renameme/index/mapper/dynamictemplate/genericstore/test-data.json");
