...
import static org.renameme.test.StreamsUtils.copyToBytesFromClasspath;
...
public class MultiFieldTests extends ESSingleNodeTestCase {
    ...
    public void testMultiFieldMultiFields() throws Exception {
        String mapping = copyToStringFromClasspath("/org/renameme/index/mapper/multifield/test-multi-fields.json");
    ...
    private void testMultiField(String mapping) throws Exception {
        ...
        BytesReference json = new BytesArray(copyToBytesFromClasspath("/org/renameme/index/mapper/multifield/test-data.json"));
