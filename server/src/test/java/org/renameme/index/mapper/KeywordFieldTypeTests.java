...
import org.renameme.index.analysis.LowercaseNormalizer;
...
public class KeywordFieldTypeTests extends FieldTypeTestCase {
    ...
    private static IndexAnalyzers createIndexAnalyzers() {
        return new IndexAnalyzers(
            org.renameme.common.collect.Map.of("default", new NamedAnalyzer("default", AnalyzerScope.INDEX, new StandardAnalyzer())),
            org.renameme.common.collect.Map.ofEntries(
                org.renameme.common.collect.Map.entry("lowercase",
                    new NamedAnalyzer("lowercase", AnalyzerScope.INDEX, new LowercaseNormalizer())),
                org.renameme.common.collect.Map.entry("other_lowercase",
