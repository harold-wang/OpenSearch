...
import org.renameme.index.mapper.NumberFieldTypeTests.OutOfRangeSpec;
import org.renameme.index.termvectors.TermVectorsService;
...
public class NumberFieldMapperTests extends AbstractNumericFieldMapperTestCase {
    ...
    protected Set<String> types() {
        return org.renameme.common.collect.Set.of("byte", "short", "integer", "long", "float", "double", "half_float");
    }

    @Override
    protected Set<String> wholeTypes() {
        return org.renameme.common.collect.Set.of("byte", "short", "integer", "long");
    }
