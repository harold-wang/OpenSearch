...
import org.renameme.test.geo.RandomShapeGenerator.ShapeType;
...
public class GeoPolygonQueryBuilderTests extends AbstractQueryTestCase<GeoPolygonQueryBuilder> {
    ...
    public void testParsingAndToQueryParsingExceptions() throws IOException {
        String[] brokenFiles = new String[]{
                "/org/renameme/index/query/geo_polygon_exception_1.json",
                "/org/renameme/index/query/geo_polygon_exception_2.json",
                "/org/renameme/index/query/geo_polygon_exception_3.json",
                "/org/renameme/index/query/geo_polygon_exception_4.json",
                "/org/renameme/index/query/geo_polygon_exception_5.json"
        };
