...
import org.renameme.common.lucene.search.function.FieldValueFactorFunction;
import org.renameme.common.lucene.search.function.FunctionScoreQuery;
import org.renameme.common.lucene.search.function.FunctionScoreQuery.FilterScoreFunction;
import org.renameme.common.lucene.search.function.FunctionScoreQuery.ScoreMode;
import org.renameme.common.lucene.search.function.LeafScoreFunction;
import org.renameme.common.lucene.search.function.RandomScoreFunction;
import org.renameme.common.lucene.search.function.ScoreFunction;
import org.renameme.common.lucene.search.function.WeightFactorFunction;
import org.renameme.common.util.BigArrays;
import org.renameme.index.fielddata.IndexFieldData;
import org.renameme.index.fielddata.IndexFieldData.XFieldComparatorSource.Nested;
import org.renameme.index.fielddata.IndexNumericFieldData;
import org.renameme.index.fielddata.LeafFieldData;
...
import org.renameme.search.sort.BucketedSort;
...
public class FunctionScoreTests extends ESTestCase {
    ...
    public void testWithInvalidScores() {
        ...
        RenamemeException exc = expectThrows(RenamemeException.class, () -> localSearcher.search(query1, 1));
        ...
        exc = expectThrows(RenamemeException.class, () -> localSearcher.search(query2, 1));
