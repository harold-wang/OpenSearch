...
public class IndexReaderWrapperTests extends ESTestCase {
    ...
    public void testReaderCloseListenerIsCalled() throws IOException {
        ...
        DirectoryReader open = RenamemeDirectoryReader.wrap(DirectoryReader.open(writer), new ShardId("foo", "_na_", 1));
        ...
        RenamemeDirectoryReader.addReaderCloseListener(wrap.getDirectoryReader(), key -> {
