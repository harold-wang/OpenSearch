...
import static org.renameme.common.util.concurrent.EsExecutors.NODE_PROCESSORS_SETTING;
import static org.renameme.index.IndexSettingsTests.newIndexMeta;
import static org.renameme.index.MergeSchedulerConfig.MAX_MERGE_COUNT_SETTING;
import static org.renameme.index.MergeSchedulerConfig.MAX_THREAD_COUNT_SETTING;
...
public class MergeSchedulerSettingsTests extends ESTestCase {
    ...
    public void testUpdateAutoThrottleSettings() throws Exception {
        ...
        mockAppender.start();
        final Logger settingsLogger = LogManager.getLogger("org.renameme.common.settings.IndexScopedSettings");
