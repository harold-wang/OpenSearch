...
public class BitSetFilterCacheTests extends ESTestCase {
    ...
    public void testInvalidateEntries() throws Exception {
        ...
        reader = RenamemeDirectoryReader.wrap(reader, new ShardId("test", "_na_", 0));
    ...
    public void testListener() throws IOException {
        ...
        final IndexReader reader = RenamemeDirectoryReader.wrap(writerReader, new ShardId("test", "_na_", 0));
    ...
    public void testRejectOtherIndex() throws IOException {
        ...
        DirectoryReader reader = DirectoryReader.open(writer);
        writer.close();
        reader = RenamemeDirectoryReader.wrap(reader, new ShardId("test2", "_na_", 0));
