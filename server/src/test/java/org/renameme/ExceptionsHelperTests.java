...
import static org.renameme.ExceptionsHelper.maybeError;
...
public class ExceptionsHelperTests extends ESTestCase {
    ...
    public void testGroupByNullTarget() {
        ...
        for (ShardOperationFailedException shardOperationFailedException : groupBy) {
            ...
            assertThat(shardOperationFailedException.getCause(), instanceOf(RenamemeException.class));
            RenamemeException RenamemeException = (RenamemeException) shardOperationFailedException.getCause();
            assertThat(RenamemeException.getMessage(), equalTo(expectedErrors[i]));
            assertThat(RenamemeException.getIndex().getName(), equalTo(expectedIndices[i++]));
        }
    }
