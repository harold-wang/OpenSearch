...
import org.renameme.common.lucene.search.SpanBooleanQueryRewriteWithMaxClause;
import org.renameme.common.regex.Regex;
import org.renameme.common.settings.Settings;
import org.renameme.common.time.DateFormatter;
...
import org.renameme.index.analysis.NormalizingCharFilterFactory;
...
import org.renameme.index.query.Operator;
...
import org.renameme.index.query.functionscore.ScoreFunctionBuilders;
import org.renameme.index.search.MatchQuery;
import org.renameme.indices.IndicesService;
import org.renameme.indices.TermsLookup;
...
import org.renameme.test.junit.annotations.TestIssueLogging;
...
import static org.renameme.action.support.WriteRequest.RefreshPolicy.IMMEDIATE;
import static org.renameme.cluster.metadata.IndexMetadata.SETTING_NUMBER_OF_SHARDS;
import static org.renameme.common.xcontent.XContentFactory.jsonBuilder;
...
import static org.renameme.index.query.QueryBuilders.matchPhrasePrefixQuery;
import static org.renameme.index.query.QueryBuilders.matchPhraseQuery;
...
import static org.renameme.index.query.QueryBuilders.termsLookupQuery;
...
import static org.renameme.test.hamcrest.RenamemeAssertions.assertFailures;
import static org.renameme.test.hamcrest.RenamemeAssertions.assertFirstHit;
...
import static org.renameme.test.hamcrest.RenamemeAssertions.assertSearchHits;
import static org.renameme.test.hamcrest.RenamemeAssertions.assertSearchResponse;
import static org.renameme.test.hamcrest.RenamemeAssertions.assertSecondHit;
import static org.renameme.test.hamcrest.RenamemeAssertions.assertThirdHit;
import static org.renameme.test.hamcrest.RenamemeAssertions.hasId;
import static org.renameme.test.hamcrest.RenamemeAssertions.hasScore;
