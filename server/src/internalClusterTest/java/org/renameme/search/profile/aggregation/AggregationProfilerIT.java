...
package org.renameme.search.profile.aggregation;
...
import org.renameme.search.aggregations.bucket.sampler.DiversifiedOrdinalsSamplerAggregator;
import org.renameme.search.aggregations.bucket.terms.GlobalOrdinalsStringTermsAggregator;
...
import static org.renameme.search.aggregations.AggregationBuilders.diversifiedSampler;
...
public class AggregationProfilerIT extends ESIntegTestCase {
    ...
    private static final Set<String> BREAKDOWN_KEYS = org.renameme.common.collect.Set.of(
        INITIALIZE,
    ...
    protected void setupSuiteScopeCluster() throws Exception {
        assertAcked(client().admin().indices().prepareCreate("idx")
                .setSettings(org.renameme.common.collect.Map.of("number_of_shards", 1, "number_of_replicas", 0))
    ...
    public void testSimpleProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(debug.keySet(), equalTo(org.renameme.common.collect.Set.of(TOTAL_BUCKETS)));
    ...
    public void testMultiLevelProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(histoDebugInfo.keySet(), equalTo(org.renameme.common.collect.Set.of(TOTAL_BUCKETS)));
            ...
            assertThat(avgAggResult.getDebugInfo(), equalTo(org.renameme.common.collect.Map.of()));
    ...
    public void testDiversifiedAggProfile() {
        ...
        for (ProfileShardResult profileShardResult : profileResults.values()) {
            ...
            assertThat(diversifyAggResult.getDebugInfo(), equalTo(
                org.renameme.common.collect.Map.of(DEFERRED, org.renameme.common.collect.List.of("max"))));
            ...
            assertThat(maxAggResult.getDebugInfo(), equalTo(org.renameme.common.collect.Map.of()));
