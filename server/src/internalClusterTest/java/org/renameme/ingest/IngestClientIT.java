...
import org.renameme.action.ingest.SimulateDocumentBaseResult;
...
import static org.renameme.test.NodeRoles.nonIngestNode;
    ...
    public void testBulkWithIngestFailures() throws Exception {
        ...
        for (int i = 0; i < bulkRequest.requests().size(); i++) {
            ...
            if (i % 2 == 0) {
                ...
                RenamemeException compoundProcessorException = (RenamemeException) failure.getCause();
