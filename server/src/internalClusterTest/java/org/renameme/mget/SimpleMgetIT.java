...
public class SimpleMgetIT extends ESIntegTestCase {
    ...
    public void testThatMgetShouldWorkWithOneIndexMissing() throws IOException {
        ...
        assertThat(((RenamemeException) mgetResponse.getResponses()[1].getFailure().getFailure()).getIndex().getName(),
            is("nonExistingIndex"));
        ...
        assertThat(((RenamemeException) mgetResponse.getResponses()[0].getFailure().getFailure()).getIndex().getName(),
            is("nonExistingIndex"));
    }
