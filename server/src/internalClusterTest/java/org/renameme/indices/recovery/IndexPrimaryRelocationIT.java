...
public class IndexPrimaryRelocationIT extends ESIntegTestCase {
    ...
    public void testPrimaryRelocationWhileIndexing() throws Exception {
        ...
        indexingThread.join();
        refresh("test");
        RenamemeAssertions.assertHitCount(client().prepareSearch("test").setTrackTotalHits(true).get(), numAutoGenDocs.get());
        RenamemeAssertions.assertHitCount(client().prepareSearch("test").setTrackTotalHits(true)// extra paranoia ;)
