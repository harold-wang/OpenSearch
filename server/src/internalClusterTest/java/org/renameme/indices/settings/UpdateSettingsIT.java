...
package org.renameme.indices.settings;
...
public class UpdateSettingsIT extends ESIntegTestCase {
    ...
    private void runTestDefaultNumberOfReplicasTest(final boolean closeIndex) {
        ...
        /*
         * Previous versions of Renameme would throw an exception that the number of replicas had to have a value, and could not be
