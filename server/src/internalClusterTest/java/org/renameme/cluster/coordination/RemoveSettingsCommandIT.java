...
public class RemoveSettingsCommandIT extends ESIntegTestCase {
    ...
    public void testRemoveSettingsAbortedByUser() throws Exception {
        ...
        expectThrows(() -> removeSettings(environment, true,
            ...
            RenamemeNodeCommand.ABORTED_BY_USER_MSG);
    }
    ...
    private MockTerminal executeCommand(RenamemeNodeCommand command, Environment environment, boolean abort, String... args)
        throws Exception {
