...
import org.renameme.cluster.metadata.Manifest;
...
import org.renameme.test.InternalTestCluster.RestartCallback;
...
import static org.renameme.cluster.coordination.Coordinator.ZEN1_BWC_TERM;
import static org.renameme.cluster.coordination.FollowersChecker.FOLLOWER_CHECK_ACTION_NAME;
import static org.renameme.cluster.coordination.JoinHelper.START_JOIN_ACTION_NAME;
import static org.renameme.cluster.coordination.PublicationTransportHandler.PUBLISH_STATE_ACTION_NAME;
...
import static org.renameme.cluster.routing.allocation.decider.FilterAllocationDecider.CLUSTER_ROUTING_EXCLUDE_GROUP_SETTING;
...
import static org.renameme.test.InternalTestCluster.REMOVED_MINIMUM_MASTER_NODES;
