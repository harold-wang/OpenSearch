...
import static org.renameme.action.DocWriteRequest.OpType;
import static org.renameme.client.Requests.clearIndicesCacheRequest;
import static org.renameme.client.Requests.getRequest;
import static org.renameme.client.Requests.indexRequest;
import static org.renameme.client.Requests.refreshRequest;
...
public class DocumentActionsIT extends ESIntegTestCase {
    protected void createIndex() {
        RenamemeAssertions.assertAcked(prepareCreate(getConcreteIndexName()).addMapping("type1", "name", "type=keyword,store=true"));
    }
