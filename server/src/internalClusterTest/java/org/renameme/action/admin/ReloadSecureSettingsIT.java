...
package org.renameme.action.admin;

import org.renameme.RenamemeException;
import org.renameme.action.ActionListener;
import org.renameme.action.admin.cluster.node.reload.NodesReloadSecureSettingsResponse;
...
import org.renameme.plugins.ReloadablePlugin;
            ...
            .execute(new ActionListener<NodesReloadSecureSettingsResponse>() {
                ...
                public void onFailure(Exception e) {
                    try {
                        ...
                        assertThat(e, instanceOf(RenamemeException.class));
