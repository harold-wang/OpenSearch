...
import org.renameme.index.analysis.FieldNameAnalyzer;
...
public class PercolateQueryBuilder extends AbstractQueryBuilder<PercolateQueryBuilder> {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        if (context.allowExpensiveQueries() == false) {
            throw new RenamemeException("[percolate] queries cannot be executed when '" +
    ...
    static IndexSearcher createMultiDocumentSearcher(Analyzer analyzer, Collection<ParsedDocument> docs) {
        ...
        try (IndexWriter indexWriter = new IndexWriter(directory, new IndexWriterConfig(analyzer))) {
            ...
            throw new RenamemeException("Failed to create index for percolator with nested document ", e);
        }
    }
