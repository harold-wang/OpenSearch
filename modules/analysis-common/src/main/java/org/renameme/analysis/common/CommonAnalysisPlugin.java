...
import org.renameme.index.analysis.PreBuiltAnalyzerProviderFactory;
...
import org.renameme.indices.analysis.PreBuiltCacheFactory.CachingStrategy;
...
import static org.renameme.plugins.AnalysisPlugin.requiresAnalysisSettings;
...
public class CommonAnalysisPlugin extends Plugin implements AnalysisPlugin, ScriptPlugin {
    ...
    public Map<String, AnalysisProvider<TokenizerFactory>> getTokenizers() {
        ...
        tokenizers.put("nGram", (IndexSettings indexSettings, Environment environment, String name, Settings settings) -> {
            if (indexSettings.getIndexVersionCreated().onOrAfter(org.renameme.Version.V_7_6_0)) {
    ...
    public List<PreBuiltAnalyzerProviderFactory> getPreBuiltAnalyzerProviderFactories() {
        ...
        // TODO remove in 8.0
        analyzers.add(new PreBuiltAnalyzerProviderFactory("standard_html_strip", CachingStrategy.RENAMEME,
            () -> new StandardHtmlStripAnalyzer(CharArraySet.EMPTY_SET)));
        analyzers.add(new PreBuiltAnalyzerProviderFactory("pattern", CachingStrategy.RENAMEME,
    ...
    public List<PreConfiguredCharFilter> getPreConfiguredCharFilters() {
        ...
        filters.add(PreConfiguredCharFilter.renamemeVersion("htmlStrip", false, (reader, version) -> {
            if (version.onOrAfter(org.renameme.Version.V_6_3_0)) {
    ...
    public List<PreConfiguredTokenFilter> getPreConfiguredTokenFilters() {
        ...
        filters.add(PreConfiguredTokenFilter.renamemeVersion("delimited_payload_filter", false, (input, version) -> {
        ...
        filters.add(PreConfiguredTokenFilter.renamemeVersion("edgeNGram", false, false, (reader, version) -> {
            if (version.onOrAfter(org.renameme.Version.V_7_0_0)) {
                throw new IllegalArgumentException(
        ...
        filters.add(PreConfiguredTokenFilter.renamemeVersion("nGram", false, false, (reader, version) -> {
            if (version.onOrAfter(org.renameme.Version.V_7_0_0)) {
        ...
        filters.add(PreConfiguredTokenFilter.renamemeVersion("word_delimiter_graph", false, false, (input, version) -> {
    ...
    public List<PreConfiguredTokenizer> getPreConfiguredTokenizers() {
        ...
        tokenizers.add(PreConfiguredTokenizer.renamemeVersion("edge_ngram", (version) -> {
        ...
        tokenizers.add(PreConfiguredTokenizer.renamemeVersion("nGram", (version) -> {
            if (version.onOrAfter(org.renameme.Version.V_7_6_0)) {
                deprecationLogger.deprecate("nGram_tokenizer_deprecation",
                        "The [nGram] tokenizer name is deprecated and will be removed in a future version. "
                                + "Please change the tokenizer name to [ngram] instead.");
            }
        ...
        tokenizers.add(PreConfiguredTokenizer.renamemeVersion("edgeNGram", (version) -> {
            if (version.onOrAfter(org.renameme.Version.V_7_6_0)) {
                deprecationLogger.deprecate("edgeNGram_tokenizer_deprecation",
                        "The [edgeNGram] tokenizer name is deprecated and will be removed in a future version. "
                                + "Please change the tokenizer name to [edge_ngram] instead.");
