...
/**
 * Builds requests for remote version of Renameme. Note that unlike most of the
 * rest of Renameme this file needs to be compatible with very old versions of
...
final class RemoteRequestBuilders {
    ...
    static Request initialSearch(SearchRequest searchRequest, BytesReference query, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder();
            ...
            throw new RenamemeException("unexpected error building entity", e);
        }
        return request;
    }
    ...
    static Request scroll(String scroll, TimeValue keepAlive, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder()) {
            ...
            throw new RenamemeException("failed to build scroll entity", e);
        }
        return request;
    }
    ...
    static Request clearScroll(String scroll, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder()) {
            ...
            throw new RenamemeException("failed to build clear scroll entity", e);
        }
        return request;
    }
}
