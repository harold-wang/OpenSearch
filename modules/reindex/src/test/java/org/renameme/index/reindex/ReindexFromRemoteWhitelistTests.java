...
import static org.renameme.index.reindex.ReindexValidator.buildRemoteWhitelist;
import static org.renameme.index.reindex.ReindexValidator.checkRemoteWhitelist;
...
public class ReindexFromRemoteWhitelistTests extends ESTestCase {
    ...
    private void assertMatchesTooMuch(List<String> whitelist) {
        ...
        assertEquals("Refusing to start because whitelist " + whitelist + " accepts all addresses. "
                + "This would allow users to reindex-from-remote any URL they like effectively having Renameme make HTTP GETs "
