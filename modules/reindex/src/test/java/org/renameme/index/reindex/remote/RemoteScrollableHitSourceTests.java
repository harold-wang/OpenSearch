...
import org.renameme.client.HeapBufferedAsyncResponseConsumer;
...
import org.renameme.index.reindex.ScrollableHitSource.Response;
...
public class RemoteScrollableHitSourceTests extends ESTestCase {
    ...
    public void testParseRejection() throws Exception {
        ...
        Consumer<Response> checkResponse = r -> {
            ...
            assertEquals("rejected execution of org.renameme.transport.TransportService$5@52d06af2 on "
                    + "EsThreadPoolExecutor[search, queue capacity = 1000, org.renameme.common.util.concurrent."
    ...
    public void testWrapExceptionToPreserveStatus() throws IOException {
        ...
        RenamemeStatusException wrapped = RemoteScrollableHitSource.wrapExceptionToPreserveStatus(status.getStatus(), null, cause);
    ...
    public void testInvalidJsonThinksRemoteIsNotES() throws IOException {
        ...
        assertEquals("Error parsing the response, remote is likely not an Renameme instance",
