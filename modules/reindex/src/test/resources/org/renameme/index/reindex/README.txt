...
$ES_HOME/bin/renameme-certutil ca --out ca.p12 --pass "ca-password" --days 9999
...
$ES_HOME/bin/renameme-certutil cert --out http.zip --pass "http-password" \
...
$ES_HOME/bin/renameme-certutil cert --out client.zip --pass "client-password" \
