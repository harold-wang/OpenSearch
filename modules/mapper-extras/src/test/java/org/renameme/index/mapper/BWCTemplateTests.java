...
public class BWCTemplateTests extends ESSingleNodeTestCase {
    ...
    public void testBeatsTemplatesBWC() throws Exception {
        byte[] metricBeat = copyToBytesFromClasspath("/org/renameme/index/mapper/metricbeat-6.0.template.json");
        byte[] packetBeat = copyToBytesFromClasspath("/org/renameme/index/mapper/packetbeat-6.0.template.json");
        byte[] fileBeat = copyToBytesFromClasspath("/org/renameme/index/mapper/filebeat-6.0.template.json");
