...
import org.renameme.index.mapper.SearchAsYouTypeFieldMapper;
import org.renameme.index.mapper.SearchAsYouTypeFieldMapper.Defaults;
import org.renameme.index.mapper.SearchAsYouTypeFieldMapper.PrefixFieldType;
import org.renameme.index.mapper.SearchAsYouTypeFieldMapper.SearchAsYouTypeFieldType;
import org.renameme.index.mapper.SearchAsYouTypeFieldMapper.ShingleFieldType;
...
public class SearchAsYouTypeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testPrefixQuery() {
        ...
        RenamemeException ee = expectThrows(RenamemeException.class,
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        assertEquals(org.renameme.common.collect.List.of("value"), fetchSourceValue(fieldType, "value"));
        assertEquals(org.renameme.common.collect.List.of("42"), fetchSourceValue(fieldType, 42L));
        assertEquals(org.renameme.common.collect.List.of("true"), fetchSourceValue(fieldType, true));
        ...
        assertEquals(org.renameme.common.collect.List.of("value"), fetchSourceValue(prefixFieldType, "value"));
        assertEquals(org.renameme.common.collect.List.of("42"), fetchSourceValue(prefixFieldType, 42L));
        assertEquals(org.renameme.common.collect.List.of("true"), fetchSourceValue(prefixFieldType, true));
        ...
        assertEquals(org.renameme.common.collect.List.of("value"), fetchSourceValue(shingleFieldType, "value"));
        assertEquals(org.renameme.common.collect.List.of("42"), fetchSourceValue(shingleFieldType, 42L));
        assertEquals(org.renameme.common.collect.List.of("true"), fetchSourceValue(shingleFieldType, true));
    }
}
