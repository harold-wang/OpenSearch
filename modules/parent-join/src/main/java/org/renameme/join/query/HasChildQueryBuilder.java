...
import org.renameme.index.fielddata.plain.SortedSetOrdinalsIndexFieldData;
...
import org.renameme.join.mapper.ParentIdFieldMapper;
import org.renameme.join.mapper.ParentJoinFieldMapper;
...
public class HasChildQueryBuilder extends AbstractQueryBuilder<HasChildQueryBuilder> {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        if (context.allowExpensiveQueries() == false) {
            throw new RenamemeException("[joining] queries cannot be executed when '" +
