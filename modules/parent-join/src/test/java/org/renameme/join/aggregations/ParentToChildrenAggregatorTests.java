...
import org.renameme.join.aggregations.InternalChildren;
import org.renameme.join.aggregations.JoinAggregationInspectionHelper;
import org.renameme.join.mapper.MetaJoinFieldMapper;
...
public class ParentToChildrenAggregatorTests extends AggregatorTestCase {
    ...
    public void testParentChildAsSubAgg() throws IOException {
        try (Directory directory = newDirectory()) {
            ...
            try (
                IndexReader indexReader = RenamemeDirectoryReader.wrap(
