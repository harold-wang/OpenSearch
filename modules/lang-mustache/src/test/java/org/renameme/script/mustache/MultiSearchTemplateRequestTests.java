...
import org.renameme.script.mustache.RestMultiSearchTemplateAction;
...
public class MultiSearchTemplateRequestTests extends ESTestCase {
    ...
    public void testParseRequest() throws Exception {
        byte[] data = StreamsUtils.copyToBytesFromClasspath("/org/renameme/script/mustache/simple-msearch-template.json");
