...
import org.renameme.http.BindHttpException;
...
import org.renameme.http.NullDispatcher;
...
import static org.renameme.http.HttpTransportSettings.SETTING_CORS_ALLOW_ORIGIN;
import static org.renameme.http.HttpTransportSettings.SETTING_CORS_ENABLED;
import static org.renameme.rest.RestStatus.BAD_REQUEST;
    ...
    public void testBadRequest() throws InterruptedException {
        ...
        final HttpServerTransport.Dispatcher dispatcher = new HttpServerTransport.Dispatcher() {
            ...
            public void dispatchBadRequest(final RestChannel channel, final ThreadContext threadContext, final Throwable cause) {
                ...
                try {
                    final RenamemeException e = new RenamemeException("you sent a bad request and you should feel bad");
