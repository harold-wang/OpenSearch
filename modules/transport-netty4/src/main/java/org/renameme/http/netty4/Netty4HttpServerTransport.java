...
package org.renameme.http.netty4;
...
import org.renameme.http.AbstractHttpServerTransport;
import org.renameme.http.HttpChannel;
import org.renameme.http.HttpHandlingSettings;
import org.renameme.http.HttpReadTimeoutException;
import org.renameme.http.HttpServerChannel;
import org.renameme.threadpool.ThreadPool;
import org.renameme.transport.NettyAllocator;
import org.renameme.transport.NettyByteBufSizer;
import org.renameme.transport.SharedGroupFactory;
import org.renameme.transport.netty4.Netty4Utils;

import java.net.InetSocketAddress;
import java.net.SocketOption;
import java.util.concurrent.TimeUnit;

import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_MAX_CHUNK_SIZE;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_MAX_CONTENT_LENGTH;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_MAX_HEADER_SIZE;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_MAX_INITIAL_LINE_LENGTH;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_READ_TIMEOUT;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_KEEP_ALIVE;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_KEEP_COUNT;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_KEEP_IDLE;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_KEEP_INTERVAL;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_NO_DELAY;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_RECEIVE_BUFFER_SIZE;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_REUSE_ADDRESS;
import static org.renameme.http.HttpTransportSettings.SETTING_HTTP_TCP_SEND_BUFFER_SIZE;
import static org.renameme.http.HttpTransportSettings.SETTING_PIPELINING_MAX_EVENTS;
...
public class Netty4HttpServerTransport extends AbstractHttpServerTransport {
    ...
    public static Setting<Integer> SETTING_HTTP_NETTY_MAX_COMPOSITE_BUFFER_COMPONENTS =
        new Setting<>(SETTING_KEY_HTTP_NETTY_MAX_COMPOSITE_BUFFER_COMPONENTS, (s) -> {
             ...
             * We assume here that Renameme receives HTTP requests via an Ethernet connection which has a MTU of 1500 bytes.
             *
