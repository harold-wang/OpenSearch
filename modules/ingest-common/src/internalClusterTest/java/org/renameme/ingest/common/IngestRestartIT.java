...
import org.renameme.ingest.common.IngestCommonPlugin;
...
import static org.renameme.action.admin.cluster.node.stats.NodesStatsRequest.Metric.INGEST;
    ...
    public void testScriptDisabled() throws Exception {
        ...
        assertThat(exception.getMessage(),
            equalTo("pipeline with id [" + pipelineIdWithScript + "] could not be loaded, caused by " +
                "[RenamemeParseException[Error updating pipeline with id [" + pipelineIdWithScript + "]]; " +
                "nested: RenamemeException[java.lang.IllegalArgumentException: cannot execute [inline] scripts]; " +
                "nested: IllegalArgumentException[cannot execute [inline] scripts];; " +
                "RenamemeException[java.lang.IllegalArgumentException: cannot execute [inline] scripts]; " +
