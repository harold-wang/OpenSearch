...
import org.renameme.ingest.IngestDocument.Metadata;
...
import org.renameme.ingest.ValueSource;
...
public class AppendProcessorTests extends ESTestCase {
    ...
    public void testAppendingUniqueValueToScalar() throws Exception {
        ...
        assertThat(list, equalTo(org.renameme.common.collect.List.of(originalValue, newValue)));
    }
