...
import org.renameme.painless.lookup.PainlessLookupBuilder;
...
public final class PainlessScriptEngine implements ScriptEngine {
    ...
    private <T> Type generateStatefulFactory(
        ...
        writer.visit(WriterConstants.CLASS_VERSION, classAccess, className, null, WriterConstants.OBJECT_TYPE.getInternalName(), classInterfaces);
    ...
    ScriptScope compile(Compiler compiler, Compiler.Loader loader, String scriptName, String source, Map<String, String> params) {
