...
import org.renameme.painless.AnalyzerCaster;
...
import org.renameme.painless.spi.annotation.NonDeterministicAnnotation;
import org.renameme.painless.symbol.Decorations;
import org.renameme.painless.symbol.Decorations.AllEscape;
import org.renameme.painless.symbol.Decorations.AnyBreak;
import org.renameme.painless.symbol.Decorations.AnyContinue;
import org.renameme.painless.symbol.Decorations.BeginLoop;
import org.renameme.painless.symbol.Decorations.BinaryType;
import org.renameme.painless.symbol.Decorations.CapturesDecoration;
import org.renameme.painless.symbol.Decorations.ComparisonType;
import org.renameme.painless.symbol.Decorations.CompoundType;
import org.renameme.painless.symbol.Decorations.ContinuousLoop;
import org.renameme.painless.symbol.Decorations.DefOptimized;
import org.renameme.painless.symbol.Decorations.DowncastPainlessCast;
import org.renameme.painless.symbol.Decorations.EncodingDecoration;
import org.renameme.painless.symbol.Decorations.Explicit;
import org.renameme.painless.symbol.Decorations.ExpressionPainlessCast;
import org.renameme.painless.symbol.Decorations.GetterPainlessMethod;
import org.renameme.painless.symbol.Decorations.InLoop;
import org.renameme.painless.symbol.Decorations.InstanceType;
import org.renameme.painless.symbol.Decorations.Internal;
import org.renameme.painless.symbol.Decorations.IterablePainlessMethod;
import org.renameme.painless.symbol.Decorations.LastLoop;
import org.renameme.painless.symbol.Decorations.LastSource;
import org.renameme.painless.symbol.Decorations.ListShortcut;
import org.renameme.painless.symbol.Decorations.LoopEscape;
import org.renameme.painless.symbol.Decorations.MapShortcut;
import org.renameme.painless.symbol.Decorations.MethodEscape;
import org.renameme.painless.symbol.Decorations.MethodNameDecoration;
import org.renameme.painless.symbol.Decorations.Negate;
import org.renameme.painless.symbol.Decorations.ParameterNames;
import org.renameme.painless.symbol.Decorations.PartialCanonicalTypeName;
import org.renameme.painless.symbol.Decorations.Read;
import org.renameme.painless.symbol.Decorations.ReferenceDecoration;
import org.renameme.painless.symbol.Decorations.ReturnType;
import org.renameme.painless.symbol.Decorations.SemanticVariable;
import org.renameme.painless.symbol.Decorations.SetterPainlessMethod;
import org.renameme.painless.symbol.Decorations.ShiftType;
import org.renameme.painless.symbol.Decorations.Shortcut;
import org.renameme.painless.symbol.Decorations.StandardConstant;
import org.renameme.painless.symbol.Decorations.StandardLocalFunction;
import org.renameme.painless.symbol.Decorations.StandardPainlessClassBinding;
import org.renameme.painless.symbol.Decorations.StandardPainlessConstructor;
import org.renameme.painless.symbol.Decorations.StandardPainlessField;
import org.renameme.painless.symbol.Decorations.StandardPainlessInstanceBinding;
import org.renameme.painless.symbol.Decorations.StandardPainlessMethod;
import org.renameme.painless.symbol.Decorations.StaticType;
import org.renameme.painless.symbol.Decorations.TargetType;
import org.renameme.painless.symbol.Decorations.TypeParameters;
import org.renameme.painless.symbol.Decorations.UnaryType;
import org.renameme.painless.symbol.Decorations.UpcastPainlessCast;
import org.renameme.painless.symbol.Decorations.ValueType;
import org.renameme.painless.symbol.Decorations.Write;
import org.renameme.painless.symbol.FunctionTable;
import org.renameme.painless.symbol.FunctionTable.LocalFunction;
import org.renameme.painless.symbol.ScriptScope;
import org.renameme.painless.symbol.SemanticScope;
import org.renameme.painless.symbol.SemanticScope.FunctionScope;
import org.renameme.painless.symbol.SemanticScope.LambdaScope;
import org.renameme.painless.symbol.SemanticScope.Variable;
...
import static org.renameme.painless.lookup.PainlessLookupUtility.typeToCanonicalTypeName;
import static org.renameme.painless.symbol.SemanticScope.newFunctionScope;
    ...
    public void visitRegex(ERegex userRegexNode, SemanticScope semanticScope) {
        ...
        if (semanticScope.getScriptScope().getCompilerSettings().areRegexesEnabled() == CompilerSettings.RegexEnabled.FALSE) {
            throw userRegexNode.createError(new IllegalStateException("Regexes are disabled. Set [script.painless.regex.enabled] to [true] "
                    + "in renameme.yaml to allow them. Be careful though, regexes break out of Painless's protection against deep "
