...
package org.renameme.painless;

import org.renameme.painless.lookup.PainlessCast;
import org.renameme.painless.lookup.PainlessMethod;
import org.renameme.painless.lookup.def;
import org.renameme.script.JodaCompatibleZonedDateTime;
...
public final class MethodWriter extends GeneratorAdapter {
    ...
    private final Deque<List<Type>> stringConcatArgs =
        (WriterConstants.INDY_STRING_CONCAT_BOOTSTRAP_HANDLE == null) ?  null : new ArrayDeque<>();
    ...
    public void writeCast(PainlessCast cast) {
        ...
        // TODO: remove this when the transition from Joda to Java datetimes is completed
            ...
            invokeStatic(WriterConstants.UTILITY_TYPE, WriterConstants.JCZDT_TO_ZONEDDATETIME);
            ...
            if (cast.explicitCast) {
                if      (cast.targetType == boolean.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_BOOLEAN);
                else if (cast.targetType == byte.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_BYTE_EXPLICIT);
                else if (cast.targetType == short.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_SHORT_EXPLICIT);
                else if (cast.targetType == char.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_CHAR_EXPLICIT);
                else if (cast.targetType == int.class)       invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_INT_EXPLICIT);
                else if (cast.targetType == long.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_LONG_EXPLICIT);
                else if (cast.targetType == float.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_FLOAT_EXPLICIT);
                else if (cast.targetType == double.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_DOUBLE_EXPLICIT);
                else if (cast.targetType == Boolean.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_BOOLEAN);
                else if (cast.targetType == Byte.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_BYTE_EXPLICIT);
                else if (cast.targetType == Short.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_SHORT_EXPLICIT);
                else if (cast.targetType == Character.class) invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_CHARACTER_EXPLICIT);
                else if (cast.targetType == Integer.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_INTEGER_EXPLICIT);
                else if (cast.targetType == Long.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_LONG_EXPLICIT);
                else if (cast.targetType == Float.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_FLOAT_EXPLICIT);
                else if (cast.targetType == Double.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_DOUBLE_EXPLICIT);
                else if (cast.targetType == String.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_STRING_EXPLICIT);
                // TODO: remove this when the transition from Joda to Java datetimes is completed
                else if (cast.targetType == ZonedDateTime.class) invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_ZONEDDATETIME);
                else {
                    writeCast(cast.originalType, cast.targetType);
                }
            } else {
                if      (cast.targetType == boolean.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_BOOLEAN);
                else if (cast.targetType == byte.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_BYTE_IMPLICIT);
                else if (cast.targetType == short.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_SHORT_IMPLICIT);
                else if (cast.targetType == char.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_CHAR_IMPLICIT);
                else if (cast.targetType == int.class)       invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_INT_IMPLICIT);
                else if (cast.targetType == long.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_LONG_IMPLICIT);
                else if (cast.targetType == float.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_FLOAT_IMPLICIT);
                else if (cast.targetType == double.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_P_DOUBLE_IMPLICIT);
                else if (cast.targetType == Boolean.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_BOOLEAN);
                else if (cast.targetType == Byte.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_BYTE_IMPLICIT);
                else if (cast.targetType == Short.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_SHORT_IMPLICIT);
                else if (cast.targetType == Character.class) invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_CHARACTER_IMPLICIT);
                else if (cast.targetType == Integer.class)   invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_INTEGER_IMPLICIT);
                else if (cast.targetType == Long.class)      invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_LONG_IMPLICIT);
                else if (cast.targetType == Float.class)     invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_FLOAT_IMPLICIT);
                else if (cast.targetType == Double.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_B_DOUBLE_IMPLICIT);
                else if (cast.targetType == String.class)    invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_STRING_IMPLICIT);
                // TODO: remove this when the transition from Joda to Java datetimes is completed
                else if (cast.targetType == ZonedDateTime.class) invokeStatic(WriterConstants.DEF_UTIL_TYPE, WriterConstants.DEF_TO_ZONEDDATETIME);
                else {
                    writeCast(cast.originalType, cast.targetType);
    ...
    public void writeAppendStrings(Class<?> clazz) {
        if (WriterConstants.INDY_STRING_CONCAT_BOOTSTRAP_HANDLE != null) {
            ...
            if (stringConcatArgs.peek().size() >= WriterConstants.MAX_INDY_STRING_CONCAT_ARGS) {
                writeToStrings();
                writeNewStrings();
                // add the return value type as new first param for next concat:
                stringConcatArgs.peek().add(WriterConstants.STRING_TYPE);
            }
        } else {
            // Java 8: push a StringBuilder append
            if      (clazz == boolean.class) invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_BOOLEAN);
            else if (clazz == char.class)    invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_CHAR);
            else if (clazz == byte.class  ||
                     clazz == short.class ||
                     clazz == int.class)     invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_INT);
            else if (clazz == long.class)    invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_LONG);
            else if (clazz == float.class)   invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_FLOAT);
            else if (clazz == double.class)  invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_DOUBLE);
            else if (clazz == String.class)  invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_STRING);
            else                             invokeVirtual(WriterConstants.STRINGBUILDER_TYPE, WriterConstants.STRINGBUILDER_APPEND_OBJECT);
        }
    }
    ...
    public void writeToStrings() {
        if (WriterConstants.INDY_STRING_CONCAT_BOOTSTRAP_HANDLE != null) {
            ...
            final String desc = Type.getMethodDescriptor(WriterConstants.STRING_TYPE,
                    stringConcatArgs.pop().stream().toArray(Type[]::new));
            invokeDynamic("concat", desc, WriterConstants.INDY_STRING_CONCAT_BOOTSTRAP_HANDLE);
        } else {
    ...
    public void invokeDefCall(String name, Type methodType, int flavor, Object... params) {
        ...
        invokeDynamic(name, methodType.getDescriptor(), WriterConstants.DEF_BOOTSTRAP_HANDLE, args);
    }
    ...
    public void invokeLambdaCall(FunctionRef functionRef) {
        ...
        invokeDynamic(
                ...
                WriterConstants.LAMBDA_BOOTSTRAP_HANDLE,
                args
        );
    }
}
