...
import org.renameme.painless.spi.WhitelistLoader;
import org.renameme.painless.spi.WhitelistMethod;
import org.renameme.painless.spi.annotation.DeprecatedAnnotation;
import org.renameme.painless.spi.annotation.NoImportAnnotation;
import org.renameme.painless.spi.annotation.WhitelistAnnotationParser;
...
public class WhitelistLoaderTests extends ScriptTestCase {
    public void testUnknownAnnotations() {
        ...
        RuntimeException expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.renameme.painless.annotation.unknown");
        });
        assertEquals(
        ...
        expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.renameme.painless.annotation.unknown_with_options");
        });
        assertEquals(
    ...
    public void testAnnotations() {
        ...
        Whitelist whitelist = WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.renameme.painless.annotation");
