...
import org.renameme.painless.antlr.Walker;
...
import static org.renameme.painless.action.PainlessExecuteAction.PainlessTestScript;
...
public abstract class ScriptTestCase extends ESTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        whitelists.add(WhitelistLoader.loadFromResourceFiles(Whitelist.class, "org.renameme.painless.test"));
