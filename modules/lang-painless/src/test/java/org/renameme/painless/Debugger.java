...
import org.renameme.painless.action.PainlessExecuteAction.PainlessTestScript;
...
final class Debugger {
    ...
    static String toString(Class<?> iface, String source, CompilerSettings settings) {
        ...
        try {
            new org.renameme.painless.Compiler(iface, null, null, PainlessLookupBuilder.buildFromWhitelists(Whitelist.BASE_WHITELISTS))
