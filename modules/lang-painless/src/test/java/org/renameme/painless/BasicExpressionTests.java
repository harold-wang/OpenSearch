...
public class BasicExpressionTests extends ScriptTestCase {
    ...
    public void testNullSafeDeref() {
        ...
        //   Read shortcut
        assertMustBeNullable(    "org.renameme.painless.FeatureTestObject a = null; return a?.x");
        assertMustBeNullable(
                "org.renameme.painless.FeatureTestObject a = new org.renameme.painless.FeatureTestObject(); return a?.x");
        assertNull(         exec("def    a = null;  return a?.x"));
        assertEquals(0,     exec("def    a = new org.renameme.painless.FeatureTestObject(); return a?.x"));
