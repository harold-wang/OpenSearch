...
import org.renameme.painless.Compiler.Loader;
...
public class DocFieldsPhaseTests extends ScriptTestCase {
    ...
    ScriptScope compile(String script) {
        org.renameme.painless.Compiler compiler = new org.renameme.painless.Compiler(
        ...
        final org.renameme.painless.Compiler.Loader loader = AccessController.doPrivileged(new PrivilegedAction<Loader>() {
            @Override
            public org.renameme.painless.Compiler.Loader run() {
