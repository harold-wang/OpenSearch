...
import org.renameme.cli.LoggingAwareMultiCommand;
...
/**
 * A cli tool for adding, removing and listing plugins for renameme.
 */
public class PluginCli extends LoggingAwareMultiCommand {
    ...
    private PluginCli() {
        super("A tool for managing installed renameme plugins");
