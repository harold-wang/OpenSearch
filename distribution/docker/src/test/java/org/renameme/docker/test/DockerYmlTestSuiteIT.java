 ...
 * under the License.
 */
package org.renameme.docker.test;
...
import org.renameme.test.rest.yaml.ClientYamlTestCandidate;
import org.renameme.test.rest.yaml.ESClientYamlSuiteTestCase;
...
public class DockerYmlTestSuiteIT extends ESClientYamlSuiteTestCase {
    ...
    protected String getTestRestCluster() {
        ...
        return new StringBuilder()
            .append("localhost:")
            .append(getProperty("test.fixtures.renameme-" + distribution + "-1.tcp.9200"))
            .append(",")
            .append("localhost:")
            .append(getProperty("test.fixtures.renameme-" + distribution + "-2.tcp.9200"))
            .toString();
    }
