...
rem determine Renameme home; to do this, we strip from the path until we
...
%JAVA% -cp "%ES_CLASSPATH%" "org.renameme.tools.java_version_checker.JavaVersionChecker" || exit /b 1
